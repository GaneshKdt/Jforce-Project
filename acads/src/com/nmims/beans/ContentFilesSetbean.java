...
public class ContentFilesSetbean {
	private List<ContentBean> contentFiles;
	...
	public List<ContentBean> getContentFiles() {
		return contentFiles;
	}
	public void setContentFiles(List<ContentBean> contentFiles) {
