...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			DATE (DD-MMM-YYYY) | STARTTIME (HH:MM 24 Hour format) | ENDTIME (HH:MM 24 Hour format) | DAY | SUBJECT CODE | Session Name | Faculty ID | Meeting Key | Meeting Password | Host Url | Host Key | Host Password | Host Id  <br>
