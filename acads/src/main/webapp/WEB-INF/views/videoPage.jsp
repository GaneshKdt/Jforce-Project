...
<%
	VideoContentBean videoContent= (VideoContentBean)request.getAttribute("videoContent"); 
	ArrayList<VideoContentBean> relatedVideos= (ArrayList<VideoContentBean>)request.getAttribute("relatedVideos"); 
    	...
    	<%@ include file="common/header.jsp" %>
    	 ...
    	 <div class="sz-main-content-wrapper">
            ...
            <div class="sz-main-content menu-closed">
												...
												<div class="col-md-8 giveBorder" style="padding-bottom:10px;padding-top:12px;">
													...
													<div class="col-xs-2 giveBorder ">
														<div class=" form-group ">
																	...
																	<span><i class="fa fa-search" style="font-size:15px;"></i></span>
																	</button>															
														</div>
													</div>
													</div>
					...
					<button class="btn btn-primary" style="background-color:#404041;" onclick="searchSubTopics()" ><span><i class="fa fa-search" style="font-size:15px;"></i></span></button>
					</div>
											 		...
											 		<div id="autoScrollBtn" style="bottom:20px;position: absolute;display:none;text-align:center; padding:5px 5px;width:100%">
										 					...
										 					<span><i class="fa fa-arrow-up" style="font-size:15px;"></i> </span>
										 	...
										 	<div class="container-fluid"> 
													...
													<div class="col-md-12 giveBorder" style="text-align:center; background-color:#dfdfdb; padding:10px 10px; display:<%= hide %>">
										 				...
										 				<%
										 				if(videoContent !=null){
															for(VideoContentBean vcb : relatedVideos){
										 				%>
										 				<div class="col-md-4 giveBorder">
										 				...
										 				<div class="row giveBorder" style="margin: 1.5rem 0 1rem 0; padding:5px 5px; border-bottom: 1px dotted black">
										 					<div class="col-md-12 thumbnailDiv giveBorder ">
																<a class="" href="/acads/student/watchVideos?id=<%= vcb.getId() %>"  title="<%= vcb.getFileName() %>" style=""> 
											 				...
											 				<div class="col-md-12 giveBorder" >
																<h4 >
																	<a href="/acads/student/watchVideos?id=<%= vcb.getId() %>" title="<%= vcb.getFileName()%>">
											 							 <b> <%= vcb.getFileName() %> </b>
											 						</a>
											 					</h4>
