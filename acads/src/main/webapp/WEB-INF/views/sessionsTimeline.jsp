...
<%-- 																									Video By <a href="/studentportal/facultyProfile?facultyId=${video.facultyId}" target="_blank">${video.facultyName}.</a>  --%>
																									Video By ${video.facultyName}.
																									<br>
																								</c:if>
																								<div class="row">
																								<div class="col-xs-1">
																								<a href="/acads/student/watchVideos?id=${video.id}" title="Watch Video" class="">
																									<b>
																										<i style=" color:red;" class="fa fa-play-circle-o" aria-hidden="true"></i>
																									</b>
																								</a> 
																								</div>
