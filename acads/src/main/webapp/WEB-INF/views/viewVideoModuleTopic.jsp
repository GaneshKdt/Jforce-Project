...
<body>
    ...
    <i class="fa fa-mail-reply" ><span style="margin-left:5px;">Back</span></i></a>
                  ...
                  style="margin:0px;padding:0px;width:21px;bottom:30px;left:80%;"><i class="fa fa-external-link" style="font-size:18px;"></i></a>
