...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Upload Schedule Session For SAS </legend></div>
			
				<%@ include file="messages.jsp"%>
				<%@ include file="uploadCorporateScheduleSessionErrorMessages.jsp"%>
				
				<form:form modelAttribute="fileBean" method="post" 	enctype="multipart/form-data" action="uploadScheduleSessionForSAS">
			...
			<a href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_ACADS_STATIC_RESOURCES')" />resources_2015/templates/sasScheduleSessionTemplate.xlsx" target="_blank">Download a Sample Template</a>
			...
			<div class="row">
				<div class="col-md-6 column">
					<button id="submit" name="submit" class="btn btn-large btn-primary"
						formaction="uploadScheduleSessionForSAS">Upload</button>
				</div>
