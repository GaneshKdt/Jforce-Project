...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
    ...
    <%
    	...
    	ArrayList<VideoContentBean> videoContentForLeads = (ArrayList<VideoContentBean>) request.getAttribute("sessionForLeads");  
    %>
    
    <%try{ %>
		    	
		<%
		ArrayList<VideoContentBean> VideoContentsList = (ArrayList<VideoContentBean>) request.getAttribute("VideoContentsList");  
									 		...
									 		<% 
									 			if(viedoCon.checkLead(request, response)) {
									 		   		if(videoContentForLeads != null && videoContentForLeads.size() != 0){ %>
									 					...
									 					<% 
									 						for(VideoContentBean video : videoContentForLeads){
									 		...
									 		%>
									 			...
									 			<div class="row jumbotron" style="padding:10px 10px;">
													<div class="col-md-4 thumbnailDiv" style="min-height:200px !important;">
														<a href="/acads/student/<%=videoType %>?id=<%= video.getId() %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
													...
													<div class="col-md-8 row" style="">
														<div class="col-md-12" style="">
															<a style="float:left !important;" href="/acads/<%=videoType %>?id=<%= video.getId() %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
...
<%-- 																	<h5 >Session By : <a href="/studentportal/facultyProfile?facultyId=<%= video.getFacultyId() %>" target="_blank"><b><%= video.getFacultyName() %> </b></a></h5> --%>
																...
																<div class="col-md-12" style="">
																	<a class="btn btn-sm btn-primary" href="/acads/student/watchVideos?id=<%= idForAllTopics %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
																	View Details >>
																	</a>
																</div>
															</div> 
									 		...
									 		<% 
												if(contentSize > 0){
													for(VideoContentBean video : VideoContentsList){	
														String videoType ="watchVideos";														
														int idForAllTopics= (int)(long)video.getId();
														if(video.getParentVideoId()>0){
															videoType ="watchVideoTopic";
												...
												<div class="row jumbotron" style="padding:10px 10px;">
													<div class="col-md-4 thumbnailDiv" style="min-height:200px !important;">
														<a class="<%= disableLink %>" href="/acads/student/<%=videoType %>?id=<%= video.getId() %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
															<img src="<%= video.getThumbnailUrl()%>" alt="Video Thumbnail" class="img-responsive videoThumbnail">
															<i class="fa fa-play-circle-o playIconStyle" style="" aria-hidden="true"></i>
										 				</a>
													</div> 
													<div class="col-md-8 row" style="">
														<div class="col-md-12" style="">
															<a style="float:left !important;" class="<%= disableLink %>" href="/acads/<%=videoType %>?id=<%= video.getId() %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
																<h2><%= video.getFileName() %></h2>
															</a>
														</div>
														<div class="col-md-12" style="height:65px !important; overflow:hidden;">
...
<%-- 																	<h5 style="<%= videoLinkColor %>">Session By : <a href="/studentportal/facultyProfile?facultyId=<%= video.getFacultyId() %>" target="_blank"><b><%= video.getFacultyName() %> </b></a></h5> --%>
																...
																<div class="col-md-12" style="">
																	<a class="btn btn-sm btn-primary <%= disableLink %>" href="/acads/student/watchVideos?id=<%= idForAllTopics %>"  title="<%= video.getFileName() %>" style="float:right !important"> 
																	View Details >>
																	</a>
																</div>
															</div> 
