...
ArrayList<AnnouncementBean> announcementsInHeader = (ArrayList<AnnouncementBean>)session.getAttribute("announcements");
			...
			<%if(session.getAttribute("userId") != null){ %>
						<ul class="sz-header-menu">
							...
							<!--  Below link needs to be replaced by a separate page for admin to update profile: Pending work -->
								<!-- <li><a href="/studentportal/student/updateProfile"><span class="icon-my-profile"></span>My Profile</a></li> -->
							<%} %>
					            ...
					            <div class="modal-content">
					              ...
					              <div class="modal-body">
					                <ul class="announcement-list">
					                		...
					                		<%
					                		  int count = 0;
									          for(AnnouncementBean announcement : announcementsInHeader){
									        	  count++;
