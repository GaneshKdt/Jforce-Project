            ...
            <div class="container-fluid">
				...
				<div class="col-md-12">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="footer-info-wrapper">
                            <h4>Visit Us:</h4>
                            <p>V.L.Mehta Road, Vile Parle (W)<br>Mumbai, Maharashtra - 400056 </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
					...
					<div class="social-wrapper">
						<h4>Chat With US:</h4>
						<ul>
							<li><a id="liveagent_button_online_573O0000000Caax"
								href="javascript://Chat" style="display: none; float: right;"
								onclick="liveagent.startChat('573O0000000Caax')"><i
									class="fa fa-lg fa-comments"></i></a>
								<div id="liveagent_button_offline_573O0000000Caax"
...
window._laq.push(function(){liveagent.showWhenOnline('573O0000000Caax', document.getElementById('liveagent_button_online_573O0000000Caax'));
liveagent.showWhenOffline('573O0000000Caax', document.getElementById('liveagent_button_offline_573O0000000Caax'));
});
</script>
 
<script type='text/javascript'
	src='https://c.la1-c2-ukb.salesforceliveagent.com/content/g/js/41.0/deployment.js'></script>
<script type='text/javascript'>
liveagent.init('https://d.la1-c1cs-ukb.salesforceliveagent.com/chat', '57290000000H2JL', '00DO00000052z1B');
</script> -->