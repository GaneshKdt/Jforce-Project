	...
	<li class="has-sub-menu">
		...
		<ul class="sz-sub-menu subMenu">
			<% if(isCSAdmin || isCSProductsAdmin){ %>
				...
				<li><a href="/careerservices/addPackageFamily">View Package Families Details</a></li>
				<li><a href="/careerservices/addUpgradePath">View Upgrade Paths Details</a></li>
				<li><a href="/careerservices/allFeatures">View Features Details</a></li>
				<li><a href="/careerservices/addPackage">View Packages Details</a></li>
			<% } %>

			<% if(isCSAdmin || isCSSessionsAdmin){ %>
				<li><b style="color: white">Session set up</b></li>
				<li><a href="/careerservices/addScheduledSessionForm">Direct Session Creation</a></li>
				<li><a href="/careerservices/batchSessionSchedulingForm">Upload Session By Excel</a></li>
				<% if(!isExternallyAffiliatedForProducts){ %>
					<li><a href="/careerservices/autoScheduleForm">Generate Schedule/Zoom</a></li>
				<% } %>
				<li><a href="/careerservices/searchScheduledSessionForm">Search Generated Schedule</a></li>
			<% } %>

			<% if(isCSAdmin || isCSSessionsAdmin){ %>
				<li><b style="color: white">Misc. </b></li>
				<li><a href="/careerservices/addVideoContent">Add/View Video Content Details</a></li>
				<% if(!isExternallyAffiliatedForProducts){ %>
						<li><a href="/careerservices/addFeedbackQuestion">Add/View Feedback Questions</a></li>
					<% } %>
				<li><a href="/careerservices/addCSFaculty">Add/View Faculties assigned to CS</a></li>
			<% } %>

			<% if(isCSAdmin ){ %>
				<% if(!isExternallyAffiliatedForProducts){ %>
					<li><b style="color: white">Administrator Tools. </b></li>
					<li><a href="/careerservices/showAllStudentsAndPackages">Show All Students Info</a></li>
					<li><a href="/careerservices/showAllStudentFeedback">Show All Session Feedback</a></li>
					<li><a href="/careerservices/showAllSessionQueryStatus">Show All Session Query And Status</a></li>
				<% } %>
			<% } %>
		</ul>
	</li>
