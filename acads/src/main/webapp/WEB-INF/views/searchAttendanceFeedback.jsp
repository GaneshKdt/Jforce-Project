...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Report for Attendance & Feedback</legend></div>
		...
		<form:form  action="/exam/admin/examBookingPendingReport" method="post" modelAttribute="searchBean">
			<fieldset>
			<div class="col-md-6 column">
					...
					<button id="submit" name="submit" class="btn btn-large btn-primary"
						formaction="searchAttendanceFeedback">Generate</button>
		...
		<c:if test="${rowCount > 0}">
			<legend>&nbsp;Attendance Feedback Report<font size="2px"> (${rowCount} Records Found) &nbsp; <a href="downloadAttendanceFeedback">Download to Excel</a></font></legend>
		</c:if>
			...
			<div class="sz-main-content-inner">
				...
				<div class="sz-content-wrapper examsPage">
					...
					<div class="sz-content">
						...
						<h2 class="red text-capitalize">Report for Attendance &
							Feedback</h2>
						<div class="clearfix"></div>
						<div class="panel-content-wrapper" style="min-height: 450px;">
							<%@ include file="adminCommon/messages.jsp"%>
							<form:form action="/exam/admin/examBookingPendingReport" method="post"
								...
								<fieldset>
									<div class="col-md-6 column">
										...
										<div class="form-group">
											<form:select id="writtenMonth" path="month" required="required" class="form-control">
												<form:option value="">Select Academic Month</form:option>
												<form:option value="Jan">Jan</form:option>
												<form:option value="Jul">Jul</form:option>
										...
										<div class="form-group">
											<form:select id="hasModuleId" path="hasModuleId" required="required" class="form-control">
												<form:option value="">Select Student Type</form:option>
												<form:option value="">All Students</form:option>
												<form:option value="N">All Students(Except MBA-WX)</form:option>
												<form:option value="Y">MBA-WX Students</form:option>
											</form:select>
										</div>
										...
										<div class="form-group">
											<button id="submit" name="submit"
												class="btn btn-large btn-primary" formaction="searchAttendanceFeedback">Generate</button>
								...
								<c:if test="${rowCount > 0}">
									<legend>
										&nbsp;Attendance Feedback Report &nbsp;<font size="2px"> <a
											href="downloadAttendanceFeedback">Download to Excel</a></font>
