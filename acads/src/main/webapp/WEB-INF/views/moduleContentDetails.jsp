...
<%@page import="com.nmims.beans.ModuleContentBean"%>
<html class="no-js">
...
<body class="inside">
<%
	ArrayList<ModuleContentBean> moduleList = (ArrayList<ModuleContentBean>)request.getAttribute("moduleContentsList");
