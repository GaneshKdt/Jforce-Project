...
<%
	...
	StudentAcadsBean lead = (StudentAcadsBean)session.getAttribute("student");
	ArrayList<AnnouncementAcadsBean> announcementsInHeader = (ArrayList<AnnouncementAcadsBean>)session.getAttribute("announcements");
						...
						<ul class="sz-header-menu">
							...
							<%
								...
								if(session.getAttribute("student") != null){
									csActiveInHeader = ((StudentAcadsBean) session.getAttribute("student")).isPurchasedOtherPackages();
								}
							...
							<li><a href="/studentportal/student/myEmailCommunicationsForm"><span class="glyphicon glyphicon-envelope"></span>My Communications</a></li>
						    ...
						    <li><a href="/studentportal/logout"><span class="icon-logout"></span>Logout</a></li>
						</ul>
