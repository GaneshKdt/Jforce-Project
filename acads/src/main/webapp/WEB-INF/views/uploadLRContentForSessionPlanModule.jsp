...
<body class="inside">
	...
	<li><a href="/acads/admin/manageSessionPlanModuleById?id=${bean.id}&action=upload">Manage Session Plan Module</a></li>
									...
									<div class="container-fluid">
												...
												<c:forEach var="content" items="${contentList}" varStatus="status">
													<tr>
														...
														<td>
															<a href="/acads/editContent?id=${content.id }" title="Edit  Content" class="">
																<b>
														...
														<td>
															<a href="/acads/deleteContent?id=${content.id }" title="Delete Content" class="">
																<b>
