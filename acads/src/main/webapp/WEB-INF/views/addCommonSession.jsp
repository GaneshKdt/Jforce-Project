		...
		<form:form  action="addCommonSession" method="post" modelAttribute="session" >
			...
			<div class="col-md-6 column">
				...
				<!-- Form Name -->
					...
					<div class="form-group">
			        	<select id="programId" name="programList"  class="selectProgram multipleSelect form-control" multiple = "multiple">
					...
					<div class="form-group">
						<form:input id="facultyId" path="facultyId" type="text" placeholder="Faculty ID" class="form-control" value="${session.facultyId}"/>
					</div>
