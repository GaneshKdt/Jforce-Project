...
<%if(roles.indexOf("Portal Admin") != -1){ 	%>
	...
	<li>
           	<a href="#" title="Manage Users"><i class="fa fa-users fa-lg" aria-hidden="true"></i></a>
               <ul class="subMenu">
...
<%if(roles.indexOf("Portal Admin") != -1 || roles.indexOf("Student Support") != -1){ 	%>
	<li>
             	<a href="#" title="Announcements"><i class="fa fa-bullhorn fa-lg"></i></a>
                 <ul class="subMenu">
...
<%if(roles.indexOf("Admin") != -1 || roles.indexOf("SR Admin") != -1){ 	%>
	...
	<li>
                       ...
                       <ul class="subMenu">
                       	...
                       	<li><a href="/studentportal/refundSRForm">Refund Service Request Payment</a></li>	
                       	<%} %>
