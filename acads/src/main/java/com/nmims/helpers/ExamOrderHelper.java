...
public class ExamOrderHelper {
	...
	{
		double examOrder = timeTableDAO.getExamOrderFromAcadMonthAndYear(acadMonth, acadYear);
		return examOrder;
	}
	public static double  getExamOrderFromExamMonthAndYear(String examMonth,String examYear)
	{
		double examOrder = timeTableDAO.getExamOrderFromExamMonthAndYear(examMonth, examYear);
		return examOrder;
	}
}
