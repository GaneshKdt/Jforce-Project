...
public class TimeExecutionProfiler {
    ...
    public Object profile(ProceedingJoinPoint pjp) throws Throwable {
        ...
        logger.info("ServicesProfiler.profile(): Method execution time: " + elapsedTime + " milliseconds."  + pjp.getSignature().getName());
        System.out.println("ServicesProfiler.profile(): Method execution time: " + elapsedTime + " milliseconds."  + pjp.getSignature().getName());
