...
public class StudentAcadsBean implements Serializable{
	
	  //private static final long serialVersionUID = 6529685098267757690L;
	  
	/**
	 * Change Name from StudentBean to StudentAcadsBean for serializable issue
	 */
    ...
    private List<Integer> currentSemPSSId = new ArrayList<Integer>();
	...
	public String getExamMode() {
		 ...
		 * "Jan2019".equals(prgmStructApplicable)){ return "Online"; }else
		 * if("EPBM".equals(program) || "MPDV".equals(program)){ //For Executive
		 * Programs to be ONLINE return "Online"; }else{ return "Offline"; }
		 */
	...
	public String toString() {
		return "StudentBean [sapid=" + sapid + ", sem=" + sem + ", lastName=" + lastName + ", firstName=" + firstName
				...
				+ ", motherName=" + motherName + ", gender=" + gender + ", program=" + program + ", enrollmentMonth="
				+ enrollmentMonth + ", enrollmentYear=" + enrollmentYear + ", emailId=" + emailId + ", mobile=" + mobile
				+ ", altPhone=" + altPhone + ", dob=" + dob + ", regDate=" + regDate + ", isLateral=" + isLateral
				+ ", isReReg=" + isReReg + ", address=" + address + ", city=" + city + ", state=" + state + ", country="
				+ country + ", pin=" + pin + ", centerCode=" + centerCode + ", centerName=" + centerName
				...
				+ updatedByStudent + ", imageUrl=" + imageUrl + ", previousStudentId=" + previousStudentId
				+ ", waivedOffSubjects=" + waivedOffSubjects + ", programForHeader=" + programForHeader
				+ ", designation=" + designation + ", industry=" + industry + ", examMode=" + examMode + ", subject="
				+ subject + ", year=" + year + ", month=" + month + ", firebaseToken=" + firebaseToken + ", leadId="
				+ leadId + ", registrationNum=" + registrationNum + ", leadImageUrl=" + leadImageUrl + ", error="
				+ error + ", consumerProgramStructureId=" + consumerProgramStructureId + ", purchasedOtherPackages="
				+ purchasedOtherPackages + ", consumerType=" + consumerType + ", programCleared=" + programCleared
				+ "]";
	}
