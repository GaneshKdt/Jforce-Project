...
public class ExamOrderAcadsBean implements Serializable{
	
	/**
	 * Change Name from ExamOrderBean to ExamOrderAcadsBean for serializable issue
	 */
	
	//private static final long serialVersionUID = 7942186762778760874L;
