...
public class ExamBookingTransactionAcadsBean extends BaseAcadsBean implements Serializable{
	
	/**
	 * Change Name from ExamBookingTransactionBean to ExamBookingTransactionAcadsBean for serializable issue
	 */
