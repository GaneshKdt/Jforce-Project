...
@Service("readSyllabusForSyllabusIdStrategy")
public class ReadSyllabusForSyllabusIdStrategy implements ReadSyllabusStrategyInterface {
	...
	public SyllabusBean readSyllabusForSyllabusId(SyllabusBean bean) throws Exception {
		// TODO Auto-generated method stub
		return syllabusDao.getSyllabusForId(bean);
	}
