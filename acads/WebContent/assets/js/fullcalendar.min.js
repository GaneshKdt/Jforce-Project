...
function setPopupLeftAlignHandler(){
    var wrapperBlock = $(".fc-day-grid");
    var popupList = $(".fc-more-popover");

    var wrapperWidth = wrapperBlock.innerWidth();
    var wrapperHeight = wrapperBlock.innerHeight();
    var popupWidth = 225;
    var popupHeight = 360;
    var popupTop = popupList.position().top;
    var popupLeft = popupList.position().left;
    var actualTop = wrapperHeight - popupHeight;
    var actualLeft = wrapperWidth - popupWidth;
    if(popupTop >= actualTop){
        popupTop = actualTop;
    }
    if(popupLeft >= actualLeft){
        popupLeft = actualLeft;
    }
    $(".fc-more-popover").css({"left":popupLeft, "top":popupTop});
}