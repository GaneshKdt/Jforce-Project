			              		...
			              		<%
			              			if("PDF".equals(request.getParameter("type"))){ %>
										<div class="embed-responsive embed-responsive-16by9">	
											<iframe class="embed-responsive-item" src="<spring:eval expression="@propertyConfigurer.getProperty('CONTENT_BASE_PATH')" /><%=request.getParameter("previewPath") %>?id=<%=Math.random() %>#toolbar=0"></iframe>
										</div>
	           						<% } %>
