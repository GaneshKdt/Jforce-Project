		...
		<form:form action="" method="post" modelAttribute="content">
			<div class="form-group">
				...
				<div class="form-group">
						...
						<form:select id="StudentType" path="StudentType" type="StudentType" placeholder="Select Type " class="form-control filterBy" style="width: 450px;" required="required"  >
							<form:option value="${currentType}" selected="true" >${currentType}</form:option>
							<form:option value="PG">PG</form:option>
							<form:option value="MBAWX">MBAWX</form:option>
						</form:select>
     ...
     $(document).ready(function(){
  	   $('.filterBy').on('change', function () {
  		   ...
  		   var type = $('#StudentType').val(); 
  			window.location = '/acads/admin/viewApplicableSubjectsForFaculty?month='+month+'&year='+year+'&type='+type;
  	      });
     }); 
    </script>
</html>
