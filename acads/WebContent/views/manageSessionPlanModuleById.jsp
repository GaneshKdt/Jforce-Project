...
<body class="inside">
			...
			<div class="row">
				<div class="container-fluid">
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								<label >Edit data of Module Outcomes : </label>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="btn btn-info btn-block" 
         	href="/acads/admin/uploadVideoContentForSessionPlanModuleForm?sessionPlanModuleId=${bean.id}&batchId=${param.batchId}&sessionId=${param.sessionId}&action=upload">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="btn btn-info btn-block" 
         	href="/acads/admin/uploadLRContentForSessionPlanModule?id=${bean.id}&batchId=${param.batchId}&sessionId=${param.sessionId}">
