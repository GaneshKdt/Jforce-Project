...
<%
	 StudentBean studentInSideBar = (StudentBean) session .getAttribute("student_acads");

	/*StudentBean studentInSideBar = (StudentBean)application.getAttribute("student_acads");*/
...
<%@page import="com.nmims.beans.LeadAcadsBean"%>
...
StudentAcadsBean studentInSideBar = (StudentAcadsBean)session.getAttribute("student_acads");
String activeMenu = request.getParameter("activeMenu"); 
String dashboardMenuClass = "";
...
if(activeMenu != null){
	...
	}else if("Session Videos".equals(activeMenu)){
		sessionvideos="active";
	}
	...
	else if("quickLinkKeyEvent".equals(activeMenu))
	{
		quickLinksMenuClass = "active";
		quickLinkKeyEvent = "active";
	}
...
ArrayList<AnnouncementAcadsBean> announcementsInSideBar = (ArrayList<AnnouncementAcadsBean>)session.getAttribute("announcementsAcads");
...
<div class="sz-main-navigation">
        ...
        <ul class="sz-nav">
         <%if("No".equals(validityExpired)) {%>
          ...
          <li class="<%=academicCalendarMenuClass%>"> <a href="/acads/student/viewStudentTimeTable"><span class= "fa-regular fa-calendar-days"></span>
            <p>Academic Calendar</p>
            </a></li>
          <li class="<%=myCoursesMenuClass%>"> <a href="/studentportal/student/viewCourseHomePage"><span class="fa-solid fa-book-bookmark"></span>
            <p>My Courses</p>
            </a></li>
         ...
         <li class="<%=sessionvideos%>"> 
          ...
          <li class="<%=bookmarksMenuClass%>"><a
			href="/studentportal/student/bookmarks"> <span> <i
					class="fa-solid fa-bookmark" aria-hidden="true"></i>
			</span>
				<p>Bookmarks</p>
		  </a></li>
          ...
          <li class="has-sub-menu <%=examMenuClass%>"> 
			...
			<% if ("BBA".equals(studentInSideBar.getProgram()) || "B.Com".equals(studentInSideBar.getProgram())
					|| "BBA-BA".equals(studentInSideBar.getProgram()) || "CBA".equals(studentInSideBar.getProgram())
		...
		<%if(!("MPDV".equals(studentInSideBar.getProgram()) || "EPBM".equals(studentInSideBar.getProgram()))){%>
			...
			<%if((studentInSideBar.getProgram().startsWith("PG") || studentInSideBar.getProgram().startsWith("MBA") || studentInSideBar.getConsumerType().equalsIgnoreCase("Diageo"))){ %>
