...
<body>
	...
	<div class="sz-main-content-wrapper">
		<jsp:include page="/views/common/breadcrum.jsp">
			<jsp:param value="Home;Skillsets"
				name="breadcrumItems" />
		</jsp:include>
			...
			<div class="sz-main-content-inner">
				...
				<div class="sz-content-wrapper dashBoard">
					...
					<div class="sz-content padding-top">
						...
						<p style="font-size:20px" class="font-weight-bold mt-4">Welcome To Your Coursera Subscription</p>
					<p style="font-size:20px">You've unlocked your access to a number of specialisations across industries with Coursera. Upgrade your skills on the go from here.<br>Get unlimited access to 5,000+ world-class programs from top Universities and companies, and add to your specialisations. </p><br>
					<div class="clearfix"></div>
					...
					<div class="clearfix"></div>
						...
						<p style="font-size:20px">Stay up-to-date with latest developments across streams right from the student portal with Coursera</p>
						<div class="clearfix"></div><br><br>
						<div style="text-align:center;"><a href="/coursera/coursera_sso_student?sapid=${sapId }" class="btn btn-danger" target="_blank" style="width:300px; height:50px; padding:10px; text-transform: none;">Login Now</a></div>
					</div>
				</div>
			</div>
		</div>
