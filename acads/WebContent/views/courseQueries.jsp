        	...
        	<c:choose>
				...
				<c:otherwise>
					<jsp:include page="common/breadcrum.jsp">
						<jsp:param value="My Courses;Subjects;Session;Queries" name="breadcrumItems" />
					</jsp:include>			
				</c:otherwise>
			</c:choose>
											...
											<div class="panel-body outer">
												...
												<div class="tab-content" style="padding-top: 2rem;">
						        					<div id="tab1" class="tab-pane fade in active" >
												        ...
												        <c:if test="${empty myQueries}">
												        	<div class="nodata-toshow-div">
												        		<h4><i class="fa-solid fa-circle-exclamation"></i> no Unanswered Q&A to show</h4>
												        	</div>
												        </c:if>
							                            <br></br>   
										          		<!-- My Queries section -->
															...
															<table id="example1" class="table table-striped table-bordered" style="width:100%">
															        ...
															        <tbody>
															            ...
															            <tr>
															                ...
															                <c:if test="${queryAnswer.isAnswered == 'Y' }"><i class="fa-solid fa-square-check" style="color:green; margin-left: 5px;"></i></c:if>
																			<c:if test="${queryAnswer.isAnswered == 'N' }"><i class="fa-solid fa-hourglass-start" style="color:#d51540; margin-left: 5px;"></i></c:if>
											        ...
											        <div id="tab2" class="tab-pane fade">
												        ...
												        <div class="nodata-toshow-div"><h4><i class="fa-solid fa-circle-exclamation"></i> no answered Q&A to show</h4></div>
												        </c:if>
												        <br></br> 
