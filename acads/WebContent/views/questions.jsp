...
ArrayList<SessionDayTimeAcadsBean> myQuestions =  (ArrayList<SessionDayTimeAcadsBean>)session.getAttribute("myQuestions");
int noOfQuestions = myQuestions != null ? myQuestions.size() : 0;
String sessionSubject =(String)request.getAttribute("subject");
ArrayList<SessionDayTimeAcadsBean> answeredPublicQuestions =  (ArrayList<SessionDayTimeAcadsBean>)session.getAttribute("answeredPublicQuestions");
					...
					<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
										...
										<table class="table table-striped ">
											...
											<tbody>
												<%	int CountOfsession = 0;
													...
													for(SessionDayTimeAcadsBean question :myQuestions){
					  ...
					  <div class="panel panel-default">
					    ...
					    <div id="collapse3" class="panel-collapse collapse">
					      <div class="panel-body">
							<% for(SessionDayTimeAcadsBean ansQuestion :answeredPublicQuestions){ %>	
						  		<div class="well-sm">
						  			<p>
