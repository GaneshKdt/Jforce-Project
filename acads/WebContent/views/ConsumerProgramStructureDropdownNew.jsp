...
<!-- Common Jsp For ConsumerType, Program, ProgramStructure -->
	...
	$(document).ready(function() {
		...
		function getConsumerTypeData(value,documentReady){
		  ...
		  $.ajax({
		   ...
		   url : "/acads/getDataByConsumerType",   
		   ...
		   success : function(data) {
		    ...
		    for(let i=0; i < subjectsData.length; i++){
		    	if(g_subject == subjectsData[i].subjectName){
		      		options = options + '<option selected value="' + subjectsData[i].subjectName + '"> ' +  subjectsData[i].subjectName +   ' </option>'; 
		     	}else{
		      		options = options + '<option value="' + subjectsData[i].subjectName + '"> ' + subjectsData[i].subjectName +  ' </option>';
		     	}
		    }
...
// 		    console.log("==========> options\n" + options);
		 ...
		 function getProgramStructureId(value,documentReady){
		  ...
		  $.ajax({
		   type : "POST",
		   contentType : "application/json",
		   url : "/acads/getDataByProgramStructure",   
		   data : JSON.stringify(data),
		   success : function(data) {
