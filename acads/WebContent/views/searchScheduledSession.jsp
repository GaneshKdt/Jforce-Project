    ...
    <section class="content-container login">
		...
		<form:form  action="searchScheduledSession" method="post" modelAttribute="searchBean">
			...
			<div class="col-md-6 column">
				...
				<%-- Commented from new requirement of Card NO. 10202 Start --%>
				<%-- <div class="form-group">
				...
				<%-- Commented from new requirement of Card NO. 10202 End --%>
				
				<label for="fromDate">From Date</label><br>	
				<div class="form-group">
					<form:input id="date"  path="fromDate" type="date" placeholder="From Date" class="form-control" value="${searchBean.date}" />
				</div>
				<label for="toDate">Upto Date</label><br>
				<div class="form-group">
					<form:input id="date"  path="toDate" type="date" placeholder="To Date" class="form-control" value="${searchBean.date}" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<button id="cancel" name="cancel" class="btn btn-danger" formaction="searchScheduledSessionForm" formnovalidate="formnovalidate">Cancel</button>
				</div>
