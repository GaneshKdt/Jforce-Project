						...
						<div class="row" style="margin-top:60px;margin-left:300px;">
							...
							<div class="form-group">
								...
								<button id="cancel" name="cancel" class="btn btn-danger"
									formaction="/studentportal/home">Cancel</button>
							</div>
							...
							<thead>
								<tr>
									...
									<%if (roles.indexOf("Acads Admin") != -1) { %>
										<th>EC Approval Proof Download</th>
									<%} %>
									<th>Actions</th>
								</tr>
							</thead>
									...
									<tr>
										...
										<%if (roles.indexOf("Acads Admin") != -1) { %>
											<td style="text-align: center">
												<c:choose>
													<c:when test="${not empty bean.ecApprovalProofUrl}">
														<a href="<spring:eval expression="@propertyConfigurer.getProperty('EC_APPROVAL_PROOF_S3_URL')" />${bean.ecApprovalProofUrl}" download="EC_Approval_Proof.pdf">
