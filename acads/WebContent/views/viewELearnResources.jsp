...
<%
	...
	StudentAcadsBean sbean = (StudentAcadsBean)request.getSession().getAttribute("student_acads");
											...
											<c:otherwise>
												<tr style="display:table-row;">
													<td colspan="5" style="text-align: center;">
														<h4><i class="fa-solid fa-circle-exclamation"></i> No Books Available For You.</h4>
													</td>
												</tr>
											</c:otherwise>
										</c:choose>
