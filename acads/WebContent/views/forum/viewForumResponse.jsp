							...
							<div class="col-md-12">
								...
								<c:forEach items="${forumBean.threadReplies}" var="reply"
									...
									<div class="post-sub" id="demo">
										...
										<div class="pull-right">
											<a href="#"
												onClick="window.open('/acads/admin/facultyReplyForm?parentReplyId=${reply.id }', 'Post Reply', 'width=800px,height=450px');">Reply</a>
										...
										<div style="margin-left: 60px; margin-top: 7px;"
											...
											<c:forEach items="${reply.threadReplies}" var="level2Reply">
												...
												<div class="pull-right">
													<a href="#"
														onClick="window.open('/acads/admin/facultyReplyForm?parentReplyId=${level2Reply.parentReplyId }', 'Post Reply', 'width=800px,height=450px');">Reply</a>
													| <a
														href="/acads/admin/reportAbuse?id=${level2Reply.id}&isLevel2Reply=true"
														onClick="return confirm('Are you sure you want to report this reply as Abuse?')">Report
														Abuse</a> | <a href=""
														onClick="window.open('/acads/admin/editReplyForm?id=${level2Reply.id}', 'Edit Reply', 'width=800px,height=450px');">Edit</a>
