  ...
  <%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
    ...
    <header class="customHeader">
    	<div class="logoWrapper">
        	<img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_ACADS_STATIC_RESOURCES')" />resources_2015/images/logo.jpg" width="100%" alt="Logo"/>
   	    </div>
        ...
        <div class="rightHeadWrapper">
            ...
            <div class="userContainer">
                <div class="userImg">
                    ...
                    <%}else{ %>
                    	<img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_ACADS_STATIC_RESOURCES')" />resources_2015/images/userImg.jpg" alt="Student Photo"  class="img-responsive"/>
                    <%} %>
                </div>
