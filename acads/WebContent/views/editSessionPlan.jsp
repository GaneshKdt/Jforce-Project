...
<!-- Froala wysiwyg editor CSS Link START -->
<link
...
<link
	...
	rel="stylesheet">
<!-- Froala wysiwyg editor CSS Link END -->
...
<body class="inside">
	...
	<legend>Session Plan For Subject : ${formBean.subject} (${formBean.subjectCode})</legend>
    
    <c:if test="${sessionPlanModulesListSize > 0}">
	   	<div class="panel-body">	   		
			<h3>&nbsp;Session Plan List<font size="2px"> (${sessionPlanModulesListSize} Records Found) &nbsp; <a href="javascript:downloadExcel()" style="color:blue;">Download to Excel</a></font></h3>			
		</div>
	</c:if>
		    
	<c:if test="${sessionPlanModulesListSize <= 0}">
		<h4 style="color:red;">Error Downloading File!</h4>
	</c:if>
  ...
  <div class="panel panel-default">
	...
	<div class="well well-lg">
				<form:form modelAttribute="formBean" method="post">
					...
					<form:hidden path="consumerTypeId" value="${formBean.consumerTypeId }"/>
					<form:hidden path="programStructureId" value="${formBean.programStructureId }"/>
					<form:hidden path="programId" value="${formBean.programId }"/>
					<form:hidden path="subject" value="${formBean.subject }"/>
					<form:hidden path="year" value="${formBean.year }"/>
					<form:hidden path="month" value="${formBean.month }"/>
					...
					<!-- ///////////////////////////////////////////////////////////////// -->
						...
						<div class="col-md-4">
							...
							<form:select  data-id="programStructureDataId" id="programStructureId" path="programStructureId" class="selectProgramStructure" required="required" disabled="true">
								<c:choose>
						...
						<div class="col-md-4">
							...
							<form:select data-id="programDataId" id="programId" path="programId" class="selectProgram" disabled="true">
					...
					<div class="col-md-4">
							<div class="form-group">
							<label >Subject</label>
							<form:select  data-id="subjectId" id="subject" path="subject" class="selectSubject" disabled="true">
					...
					<div class="row">
						...
						<div class="form-group">
							...
							class="form-control" required="required"  itemValue="${formBean.year}" disabled="true">
						...
						<div class="form-group">
							...
							class="form-control" required="required" itemValue="${formBean.month}" disabled="true">
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="courseRationale" class="editor" title="${formBean.courseRationale}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="objectives" class="editor" title="${formBean.objectives}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="learningOutcomes" class="editor" title="${formBean.learningOutcomes}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="prerequisites" class="editor" title="${formBean.prerequisites}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="pedagogy" class="editor" title="${formBean.pedagogy}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="textbook" class="editor" title="${formBean.textbook}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="journals" class="editor" title="${formBean.journals}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<form:textarea path="links" class="editor" title="${formBean.links}" />
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								<label > Innovative Pedagogy Used</label>
							  	<form:textarea path="pedagogyUsed" class="editor" title="${formBean.pedagogyUsed}"/>
							</div>
						</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label > Case Study Name </label>
							  	<form:textarea path="casestudyName" class="editor" title="${formBean.casestudyName}"/>
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								<label > Pedagogical Tool </label>
							  	<form:textarea path="pedagogicalTool" class="editor" title="${formBean.pedagogicalTool}"/>
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								<label > Innovative Method For Teaching </label>
								<form:textarea path="teachingMethod" class="editor" title="${formBean.teachingMethod}"/>
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								<label > Case Study Source : </label>
								<form:textarea path="casestudySource" class="editor" title="${formBean.casestudySource}"/>
							</div>
						</div>
					...
					<div class="">
						<div class="col-md-12">
							<div class="form-group">
								...
								<!-- This hidden field to identify the type of case study, so that radio but will checked by default according to the type -->
								<input type="hidden" value="${formBean.casestudyType}" id="casestudyType" />
								<div class="radio">
								      <input type="radio" name="casestudyType" value="Harvard" id="harvard" style="padding:0px;height:14px;"><span style="font-size:15px;font-weight:bold;width:0px !important;">Harvard</span>							      
							  	</div>
							  	<div class="radio">
								      <input type="radio" name="casestudyType" value="Non-Harvard" id="nonHarvard" style="padding:0px;height:14px;"><span style="font-size:15px;font-weight:bold;width:0px !important;">Non-Harvard</span>
							  	</div>	
							</div>
						</div>
					</div>
			    ...
			    <div id="collapse3" class="panel-collapse collapse border border-primary" style="margin: 20px">
			      	<div class="panel-body">
			      		<form:form modelAttribute="module" method="post">
							...
							<form:hidden path="batchId" value="${ module.batchId }"/>
					...
					<div class="col-md-2 column form-group">
						Create Quick Session
							...
							<td style="width: 265px"><form:form modelAttribute="session"
									...
									method="post" action="/acads/admin/addScheduledSession">
									...
									<form:input type="hidden" value="1" path="sessionType" />
									...
									<div class='input-group date'
										...
										<c:choose>
											<c:when test="${moduleBean.sessionId != 0}">
												<a
													href="/acads/admin/admineditScheduledSession?id=${moduleBean.sessionId}&consumerProgramStructureId=${moduleBean.consumerProgramStructureId }"
											...
											<td><c:out value="${(moduleBean.facultyName==null || moduleBean.facultyName=='') ? 'NA' : moduleBean.facultyName}"/></td>
												<td><a
													href="/acads/admin/editScheduledSession?id=${moduleBean.sessionId}&consumerProgramStructureId=${moduleBean.consumerProgramStructureId }">
													...
													<span class="tooltipData">
														<em>Default Session Data</em>
															<p style="text-align: left" class="tooltipInnerData">
																...
																Faculty Id : ${moduleBean.timebondFacultyId} <br>
																Session Type : Webinar
															</p>
													</span> 
													<b>
														<i style="font-size: 20px; padding-left: 5px;"class="fa fa-save" aria-hidden="true"></i>
													</b>

												</span>
												<%-- <td><c:out value="${(moduleBean.facultyName==null || moduleBean.facultyName=='') ? 'NA' : moduleBean.facultyName}"/></td> --%>
												<td><c:out value="${moduleBean.facultyName}"/></td>
												<td><span style="color: #c72127;"
													onclick="addSessionwithDetails('${moduleBean.sessionplan_module_id}','${moduleBean.sessionplanYear }','${moduleBean.sessionplanMonth }','${moduleBean.corporateName }','${moduleBean.sessionplanSubject }','${moduleBean.sessionModuleNo }','${moduleBean.timebondFacultyId }','1')"
							            ...
							            <form:form modelAttribute="testBean"  method="post" >	
							            	...
							            	<c:if test="${moduleBean.testId eq null}">
									            ...
									            <form:input type="hidden" value="${moduleBean.date}"  path="date"/>
							            	    ...
							            	    class="btn btn-primary btn-sm" formaction="/exam/addTestForm">
							            	    <i style="font-size:20px;color:#c72127; " class="fa fa-plus-circle" aria-hidden="true"></i>
							            	    </button>            
         				 						      
											</c:if>
											<c:if test="${moduleBean.testId ne null}">
												<a href="/exam/editTest?id=${moduleBean.testId}" 
												    title="Edit Test"> 
												     <jsp:useBean id="currentDate" class="java.util.Date"/>
													<fmt:formatDate var="now" value="${currentDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
													
													<c:if test="${moduleBean.testEndDate > now  }">
													<i title="Edit Test" style="font-size:20px; padding-left:5px" class="fa fa-pencil" aria-hidden="true"></i>
													</c:if>
													<c:if test="${moduleBean.testEndDate < now  }">
													 <i title="Couldn't edit.Test Expired." style="font-size:20px; padding-left:5px;color:#808080ad;" onclick="return false;" class="fa fa-pencil" aria-hidden="true"></i>
													</c:if>
										...
										<td>
									<%-- 		<a href="/acads/admin/manageSessionPlanModuleById?id=${moduleBean.sessionplan_module_id}&sessionDate=${moduleBean.date}&sessionTime=${moduleBean.startTime}&facultyName=${moduleBean.facultyName}&batchName=${moduleBean.batchName}&action=upload" --%>
									
									
										<a href="/acads/admin/manageSessionPlanModuleById?id=${moduleBean.sessionplan_module_id}&sessionId=${moduleBean.sessionId}&batchId=${moduleBean.batchId}&action=upload"
											   title="Add Learning Resources " class="">
												<b>
													<i style="font-size:20px; padding-left:5px" class="fa fa-upload" aria-hidden="true"></i>
												</b>
											</a>
							            </td>
							            <td>
										...
										<td>
										<a href="/acads/admin/manageSessionPlanModuleById?id=${moduleBean.sessionplan_module_id}&sessionId=${moduleBean.sessionId}&batchId=${moduleBean.batchId}&action=edit"
											   title="Add Learning Resources " class="">
												<b>
...
const downloadExcel = () => {	
	try {
		window.location = "/acads/admin/downloadSessionsModulesPlanReport";
	} catch(err){
		alert(`Error: Cannot download Excel!`);
	}
}
</script>
...
<script>
function addSessionwithDetails(id,year,month,corporateName,subject,sessionName,facultyId,sessionType){
    ...
    window.location="/acads/admin/addScheduledSessionForm?id="+id+"&year="+year+"&month="+month+"&corporateName="+corporateName+"&subject="+subject+"&sessionName=Session "+sessionName+"&facultyId="+facultyId+"&dateTime="+dateTime+"&sessionType="+sessionType;
...
<!-- Radio Button Selection Automatically Depend upon Dynamic casestudyType -->
<script>
	var casestudyType = $('#casestudyType').val();
	if(casestudyType === "Harvard")
	{
		$("#harvard").attr('checked', 'checked');
	}
	else if(casestudyType === "Non-Harvard")
	{
		$("#nonHarvard").attr('checked', 'checked');
	}
	else
	{
		$("#nonHarvard").removeAttr('checked', 'checked');
		$("#harvard").removeAttr('checked', 'checked');
	}
</script>
