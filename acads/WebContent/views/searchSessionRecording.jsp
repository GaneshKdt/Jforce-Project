					...
					<div class="panel-body">
						<div class="col-md-6 column">
							<div class="form-group">
								<form:select path="year" type="text" placeholder="Acad Year" class="form-control" required="required"  itemValue="${specialisation.year}">
							...
							<div class="form-group">		
								<form:select path="month" type="text" placeholder="Acad Month" class="form-control" required="required" itemValue="${specialisation.month}">
							...
							<div class="form-group" >
							<form:select id="programType" path="programType"  class="form-control" required="required"> 
