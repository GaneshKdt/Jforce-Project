...
@Controller
public class MBAXHallTicketController extends BaseController {
	...
	@Autowired
	HtServiceLayerMBAX htServiceLayer;
...
//	@RequestMapping(value = "/m/previewHallTicket_MBAX", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
//	public ResponseEntity<MBAHallTicketBean> previewHallTicket_MBAX(@RequestBody StudentBean input) throws Exception {
...
//	}
//	
//	@RequestMapping(value = "/m/downloadHallTicket_MBAX", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
//	public ResponseEntity<MBAHallTicketBean> downloadHallTicket_MBAX(@RequestBody StudentBean input) {
//		HttpHeaders headers = new HttpHeaders();
//		headers.add("Content-Type", "application/json");
//
//		// error handling done in service
