...
@RestController
@RequestMapping("m")
public class MBAXTEERestController extends BaseController {
	
	private static final Logger logger = LoggerFactory.getLogger(MBAXTEERestController.class);
	...
	@RequestMapping(value = "/getMBAXAssessmentDetails", method = { RequestMethod.POST, RequestMethod.GET }, produces = "application/json; charset=UTF-8")
	...
	@PostMapping(path = "/getMBAXAssessmentsBySapid")
	public  ResponseEntity<MBAResponseBean> getFinishedTeeAssessmentsBySapid(@RequestBody StudentExamBean student) {
		MBAResponseBean response = new MBAResponseBean();
