...
@RestController
@RequestMapping("m")
public class MBAXHallTicketRestController {
	...
	@PostMapping(path = "/previewHallTicket_MBAX", produces = "application/json", consumes = "application/json")
	public ResponseEntity<MBAHallTicketBean> previewHallTicket_MBAX(@RequestBody StudentExamBean input) throws Exception {
	...
	@PostMapping(path = "/downloadHallTicket_MBAX", consumes = "application/json", produces = "application/json")
	public ResponseEntity<MBAHallTicketBean> downloadHallTicket_MBAX(@RequestBody StudentExamBean input) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json");
