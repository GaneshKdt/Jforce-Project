...
public class MBAXAuditTrailsDAO{
	...
	public void updateLostFocusCheckByTestId( Long testId) throws Exception{
		...
		String sql="UPDATE exam.upgrad_test  "
				+ "SET  "
	...
	public StudentsTestDetailsExamBean getStudentsTestDetailsBySapidAndTestId(String sapid, Long testId){
		...
		String sql = "SELECT  "
				...
				+ "FROM "
				+ "    exam.upgrad_test_student_testdetails std "
				+ "        LEFT JOIN "
				+ "    exam.upgrad_test_proctoring_details tpd ON std.testId = tpd.testId "
	...
	public boolean insertExtendedTestTime( final TestExamBean bean) {
		...
		final String sql = "INSERT INTO exam.upgrad_test_testextended_sapids "
	...
	public void saveSupportForOtherIssues(final TestExamBean bean) throws Exception{
		...
		String sql = "INSERT INTO exam.upgrad_test_proctoring_details"
	...
	private void updateCopyCaseRemark(LostFocusLogExamBean bean) throws Exception {
		...
		jdbcTemplate = new JdbcTemplate(dataSource);
		String sql="UPDATE exam.upgrad_test_students_answers " + 
				"SET  " + 
				"    `marks` = 0, " + 
				"    `isChecked` = 1, " + 
	...
	public ArrayList<LostFocusLogExamBean> getReasonForTestingRegex() {
		...
		String sql = "SELECT * FROM exam.upgrad_test_proctoring_details";
