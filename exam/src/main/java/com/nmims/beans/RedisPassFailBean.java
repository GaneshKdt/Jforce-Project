...
//spring security related changes rename RedisPassFailBean to RedisPassFailExamBean
public class RedisPassFailBean implements Serializable{
	...
	public String toString() {
		return "PassFailBean [sapid=" + sapid + ", subject=" + subject
				+ ", grno=" + grno + ", writtenYear=" + writtenYear
				+ ", writtenMonth=" + writtenMonth + ", assignmentYear="
				+ assignmentYear + ", assignmentMonth=" + assignmentMonth
				+ ", name=" + name + ", program=" + program + ", sem=" + sem
				+ ", writtenscore=" + writtenscore + ", assignmentscore="
				+ assignmentscore + ", total=" + total + ", failReason="
				+ failReason + ", remarks=" + remarks + ", isPass=" + isPass
				+ ", gracemarks=" + gracemarks + ", assignmentAttemptOrder="
				+ assignmentAttemptOrder + ", writtenAttemptOrder="
				+ writtenAttemptOrder + ", graceGiven=" + graceGiven
				+ ", assignmentSubmitted=" + assignmentSubmitted
				+ ", examMode=" + examMode + ", completionYear="
				+ completionYear + ", completionMonth=" + completionMonth
				+ ", serviceRequestIdList=" + serviceRequestIdList
				+ ", centerCode=" + centerCode + ", validityEndMonth="
				+ validityEndMonth + ", validityEndYear=" + validityEndYear
				+ ", serviceRequestId=" + serviceRequestId
				+ ", subjectCutoffCleared=" + subjectCutoffCleared
