...
public class ExamBookingTransactionBean extends BaseExamBean implements Serializable{
	...
	private String startJsonResponse;	
	private String finishedJsonResponse;	
	private String finish_node;	
	private String gradedJsonResponse;	
	private String resumeJsonResponse;
	
	//Added by Siddheshwar_K for seat release reason.
	...
	public String getStartJsonResponse() {
		return startJsonResponse;
	}
	public void setStartJsonResponse(String startJsonResponse) {
		this.startJsonResponse = startJsonResponse;
	}
	public String getFinishedJsonResponse() {
		return finishedJsonResponse;
	}
	public void setFinishedJsonResponse(String finishedJsonResponse) {
		this.finishedJsonResponse = finishedJsonResponse;
	}
	...
	public String getGradedJsonResponse() {
		return gradedJsonResponse;
	}
	public void setGradedJsonResponse(String gradedJsonResponse) {
		this.gradedJsonResponse = gradedJsonResponse;
	}
	public String getResumeJsonResponse() {
		return resumeJsonResponse;
	}
	public void setResumeJsonResponse(String resumeJsonResponse) {
		this.resumeJsonResponse = resumeJsonResponse;
	}
	...
	public String getExamJoinLink() {
		return examJoinLink;
	}
	public void setExamJoinLink(String examJoinLink) {
		this.examJoinLink = examJoinLink;
	}
	...
	public String toString() {
		return "ExamBookingTransactionBean [sifySubjectCode=" + sifySubjectCode + ", sapid=" + sapid + ", subject="
				...
				+ ", centerName=" + centerName + ", lc=" + lc + ", ic=" + ic + ", id=" + id + ", respTranStatus="
				+ respTranStatus + ", errorMessage=" + errorMessage + ", errorRecord=" + errorRecord
				+ ", offlineCenterId=" + offlineCenterId + ", onlineCenterId=" + onlineCenterId + ", password="
				+ password + ", writenscore=" + writenscore + ", releaseSubjects=" + releaseSubjects
				+ ", selectedCenters=" + selectedCenters + ", uniqueKey=" + uniqueKey + ", bookedCount=" + bookedCount
				+ ", filePath=" + filePath + ", action=" + action + ", changeOfCenter=" + changeOfCenter
				+ ", programStructApplicable=" + programStructApplicable + ", studentType=" + studentType + ", testId="
				+ testId + ", testAttempt=" + testAttempt + ", validityEndYear=" + validityEndYear
				+ ", validityEndMonth=" + validityEndMonth + ", isLateral=" + isLateral + ", day=" + day
				+ ", paymentOption=" + paymentOption + ", bankName=" + bankName + ", requestAmount=" + requestAmount
				+ ", requestTrackId=" + requestTrackId + ", timeboundId=" + timeboundId + ", examJoinLink="
				+ examJoinLink + ", testTaken=" + testTaken + ", imageUrl=" + imageUrl + ", customURLId=" + customURLId
				+ ", emailBody=" + emailBody + ", examStartDateTime=" + examStartDateTime + ", referenceId="
				+ referenceId + ", serviceRequestType=" + serviceRequestType + ", receiptNo=" + receiptNo + ", year="
				+ year + ", month=" + month + ", startJsonResponse=" + startJsonResponse + ", finishedJsonResponse="
				+ finishedJsonResponse + ", finish_node=" + finish_node + ", gradedJsonResponse=" + gradedJsonResponse
				+ ", resumeJsonResponse=" + resumeJsonResponse + ", releaseReasonsList=" + releaseReasonsList
