 ...
 *
 */
public class LiveSessionReportAdminBean implements Serializable {
	...
	public LiveSessionReportAdminBean() {
		super();
		// TODO Auto-generated constructor stub
	}

	public LiveSessionReportAdminBean(String acadYear, String acadMonth) {
		super();
		this.acadYear = acadYear;
		this.acadMonth = acadMonth;
	}

	public LiveSessionReportAdminBean(String acadYear, String acadMonth, String sapId, String studentName,
