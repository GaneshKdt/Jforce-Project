...
//spring security related changes rename UpgradTestQuestionBean to UpgradTestQuestionExamBean
public class UpgradTestQuestionExamBean implements Serializable {
	...
	private List<UpgradTestQuestionOptionExamBean> testQuestionOptions;
	private UpgradQuestionAnsweredDetailsBean testQuestionsAnsDetails;
	...
	public UpgradQuestionAnsweredDetailsBean getTestQuestionsAnsDetails() {
	...
	public void setTestQuestionsAnsDetails(UpgradQuestionAnsweredDetailsBean testQuestionsAnsDetails) {
	...
	public List<UpgradTestQuestionOptionExamBean> getTestQuestionOptions() {
		return testQuestionOptions;
	}



	public void setTestQuestionOptions(List<UpgradTestQuestionOptionExamBean> testQuestionOptions) {
