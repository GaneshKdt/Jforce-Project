...
public class ExamScheduleinfoBean implements Serializable  {
	...
	public String toString() {
		return "ExamScheduleinfoBean [sapid=" + sapid + ", firstname=" + firstname + ", lastname=" + lastname
				+ ", emailId=" + emailId + ", sem=" + sem + ", mobile=" + mobile + ", imageURL=" + imageURL + ", year="
				+ year + ", month=" + month + ", trackId=" + trackId + ", subject=" + subject + ", booked=" + booked
				...
				+ ", reporting_start_date_time=" + reporting_start_date_time + ", reporting_finish_date_time="
				+ reporting_finish_date_time + ", sifySubjectCode=" + sifySubjectCode + ", acessKey=" + acessKey
				+ ", joinURL=" + joinURL + ", joinKey=" + joinKey + ", scheduleId=" + scheduleId + ", assessmentId="
				+ assessmentId + ", maxScore=" + maxScore + ", scheduleName=" + scheduleName + ", testTaken="
				+ testTaken + ", createdBy=" + createdBy + ", createdDateTime=" + createdDateTime + ", error=" + error
				+ ", formattedDateStringForEmail=" + formattedDateStringForEmail + ", examCenterName=" + examCenterName
				+ ", googleMapUrl=" + googleMapUrl + ", centerId=" + centerId + ", timeboundId=" + timeboundId
