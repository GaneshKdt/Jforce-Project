...
public class StudentMarksBean implements Serializable{
	...
	private ArrayList<String> writtenScoreType;
	...
	public ArrayList<String> getWrittenScoreType() {
		return writtenScoreType;
	}
	public void setWrittenScoreType(ArrayList<String> writtenScoreType) {
		this.writtenScoreType = writtenScoreType;
	}
	...
	public void setIsLateral(String isLetaral) {
		this.isLateral = isLetaral;
	}
	...
	public String toString() {
		return "StudentMarksBean [id=" + id + ", year=" + year + ", month=" + month + ", syllabusYear=" + syllabusYear
				+ ", examorder=" + examorder + ", grno=" + grno + ", sapid=" + sapid + ", studentname=" + studentname
				+ ", program=" + program + ", sem=" + sem + ", subject=" + subject + ", writenscore=" + writenscore
				+ ", assignmentscore=" + assignmentscore + ", gracemarks=" + gracemarks + ", total=" + total
				+ ", attempt=" + attempt + ", source=" + source + ", location=" + location + ", centercode="
				+ centercode + ", remarks=" + remarks + ", errorMessage=" + errorMessage + ", errorRecord="
				+ errorRecord + ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", lastModifiedBy="
				+ lastModifiedBy + ", lastModifiedDate=" + lastModifiedDate + ", examMode=" + examMode
				+ ", offlineCenterId=" + offlineCenterId + ", onlineCenterId=" + onlineCenterId + ", centerId="
				+ centerId + ", firstName=" + firstName + ", lastName=" + lastName + ", examCenterName="
				+ examCenterName + ", city=" + city + ", subjetsCleared=" + subjetsCleared + ", reason=" + reason
				+ ", markedForRevaluation=" + markedForRevaluation + ", revaluationRemarks=" + revaluationRemarks
				+ ", revaluationScore=" + revaluationScore + ", markedForPhotocopy=" + markedForPhotocopy
				+ ", centerName=" + centerName + ", mcq=" + mcq + ", part4marks=" + part4marks + ", oldWrittenScore="
				+ oldWrittenScore + ", oldAssignmentScore=" + oldAssignmentScore + ", sapid1=" + sapid1
				+ ", sapid1FName=" + sapid1FName + ", sapid1LName=" + sapid1LName + ", program1=" + program1 + ", ic1="
				+ ic1 + ", sapid2=" + sapid2 + ", sapid2FName=" + sapid2FName + ", sapid2LName=" + sapid2LName
				+ ", program2=" + program2 + ", ic2=" + ic2 + ", matchPercent=" + matchPercent + ", consecutiveLines="
				+ consecutiveLines + ", file1Lines=" + file1Lines + ", file2Lines=" + file2Lines
				+ ", totalLinesMatched=" + totalLinesMatched + ", assignmentBeforeReval=" + assignmentBeforeReval
				+ ", writtenBeforeReval=" + writtenBeforeReval + ", revaulationResultDeclared="
				+ revaulationResultDeclared + ", password=" + password + ", examDate=" + examDate + ", examTime="
				+ examTime + ", booked=" + booked + ", emailId=" + emailId + ", mobile=" + mobile + ", altPhone="
				+ altPhone + ", programStructApplicable=" + programStructApplicable + ", enrollmentMonth="
				+ enrollmentMonth + ", enrollmentYear=" + enrollmentYear + ", writtenScoreType=" + writtenScoreType
				+ ", studentType=" + studentType + ", oldStatus=" + oldStatus + ", newStatus=" + newStatus
				+ ", newTotal=" + newTotal + ", totalMarks=" + totalMarks + ", sifySubjectCode=" + sifySubjectCode
				+ ", writtenBeforeRIANV=" + writtenBeforeRIANV + ", consumerType=" + consumerType
				+ ", prgmStructApplicable=" + prgmStructApplicable + ", consumerProgramStructureId="
				+ consumerProgramStructureId + ", writtenscore=" + writtenscore + ", testTaken=" + testTaken
				+ ", isLateral=" + isLateral + ", assignmentRemarks=" + assignmentRemarks + ", subjectType="
				+ subjectType + ", semester=" + semester + "]";
	}
