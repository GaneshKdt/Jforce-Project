...
public class AssignmentFileBean implements Serializable{
    ...
    private ArrayList<AssignmentFileBean> revalAssignments = new ArrayList<>();
    private ArrayList<AssignmentFileBean> unMarkCCList = new ArrayList<>();
    ...
    private String submissionAllow = "Y"; 
    private String evaluatedFaculty;
	private String acadYear;
	private String acadMonth;
	private int threshold2=0;
	private ArrayList<ResultDomain> copyResultList2;
	private String studentName ;
	private String faculty1Evaluated;
	private String faculty1Score;
	private String faculty1Remarks;
	private String faculty1Reason;
	private String OptedForReval;
	private String facultyName;
	private String currentSemSubject="N";
	private String submissionDate=null;
	private List<String> ids;
	private List<String> subjectList;
	private String plagiarismType;
	...
	public void setPlagiarismType(String plagiarismType) {
	...
	public String getFaculty1Evaluated() {
		return faculty1Evaluated;
	}

	public void setFaculty1Evaluated(String faculty1Evaluated) {
		this.faculty1Evaluated = faculty1Evaluated;
	}

	public String getFaculty1Score() {
		return faculty1Score;
	}

	public void setFaculty1Score(String faculty1Score) {
		this.faculty1Score = faculty1Score;
	}

	public String getFaculty1Remarks() {
		return faculty1Remarks;
	}

	public void setFaculty1Remarks(String faculty1Remarks) {
		this.faculty1Remarks = faculty1Remarks;
	}

	public String getFaculty1Reason() {
		return faculty1Reason;
	}

	public void setFaculty1Reason(String faculty1Reason) {
		this.faculty1Reason = faculty1Reason;
	}

	public String getOptedForReval() {
		return OptedForReval;
	}

	public void setOptedForReval(String optedForReval) {
		OptedForReval = optedForReval;
	}
	...
	public ArrayList<ResultDomain> getCopyResultList2() {
		return copyResultList2;
	}

	public void setCopyResultList2(ArrayList<ResultDomain> copyResultList2) {
		this.copyResultList2 = copyResultList2;
	}
	...
	public ArrayList<AssignmentFileBean> getRevalAssignments() {
		return revalAssignments;
	}
	public void setRevalAssignments(ArrayList<AssignmentFileBean> revalAssignments) {
	...
	public ArrayList<AssignmentFileBean> getUnMarkCCList() {
		return unMarkCCList;
	}

	public void setUnMarkCCList(ArrayList<AssignmentFileBean> unMarkCCList) {
	...
	public String toString() {
		return "AssignmentFileBean [id=" + id + ", consumerProgramStructureId=" + consumerProgramStructureId
				+ ", consumerTypeId=" + consumerTypeId + ", programId=" + programId + ", programStructureId="
				+ programStructureId + ", count=" + count + ", consumerType=" + consumerType + ", programStructure="
				+ programStructure + ", searchType=" + searchType + ", year=" + year + ", month=" + month
				+ ", fileData=" + fileData + ", subject=" + subject + ", sem=" + sem + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", instructions=" + instructions + ", filePath=" + filePath
				+ ", studentFilePath=" + studentFilePath + ", createdBy=" + createdBy + ", createdDate=" + createdDate
				+ ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedDate=" + lastModifiedDate + ", sapId=" + sapId
				+ ", previewPath=" + previewPath + ", questionFilePreviewPath=" + questionFilePreviewPath
				+ ", attempts=" + attempts + ", status=" + status + ", attemptsLeft=" + attemptsLeft + ", weightage="
				+ weightage + ", errorMessage=" + errorMessage + ", errorRecord=" + errorRecord + ", lastName="
				+ lastName + ", firstName=" + firstName + ", program=" + program + ", enrollmentMonth="
				+ enrollmentMonth + ", enrollmentYear=" + enrollmentYear + ", emailId=" + emailId + ", mobile=" + mobile
				+ ", altPhone=" + altPhone + ", centerCode=" + centerCode + ", centerName=" + centerName
				+ ", validityEndMonth=" + validityEndMonth + ", validityEndYear=" + validityEndYear
				+ ", prgmStructApplicable=" + prgmStructApplicable + ", lc=" + lc + ", facultyId=" + facultyId
				+ ", faculty1=" + faculty1 + ", faculty2=" + faculty2 + ", faculty3=" + faculty3
				+ ", facultyIdRevaluation=" + facultyIdRevaluation + ", faculty1Name=" + faculty1Name
				+ ", faculty2Name=" + faculty2Name + ", faculty3Name=" + faculty3Name + ", facultyRevaluationName="
				+ facultyRevaluationName + ", email=" + email + ", evaluated=" + evaluated + ", remarks=" + remarks
				+ ", score=" + score + ", evaluationCount=" + evaluationCount + ", revaluationScore=" + revaluationScore
				+ ", markedForRevaluation=" + markedForRevaluation + ", revaluated=" + revaluated
				+ ", revaluationRemarks=" + revaluationRemarks + ", revaluationCount=" + revaluationCount
				+ ", revaluationReason=" + revaluationReason + ", revaluationDate=" + revaluationDate
				+ ", revisitScore=" + revisitScore + ", revisitRemarks=" + revisitRemarks + ", revisited=" + revisited
				+ ", isPass=" + isPass + ", sfName=" + sfName + ", slName=" + slName + ", reason=" + reason
				+ ", faculties=" + faculties + ", numberOfAssignments=" + numberOfAssignments + ", indexes=" + indexes
				+ ", revalAssignments=" + revalAssignments + ", unMarkCCList=" + unMarkCCList + ", level=" + level
				+ ", q1Marks=" + q1Marks + ", q1Remarks=" + q1Remarks + ", q2Marks=" + q2Marks + ", q3Marks=" + q3Marks
				+ ", q4Marks=" + q4Marks + ", q5Marks=" + q5Marks + ", q6Marks=" + q6Marks + ", q7Marks=" + q7Marks
				+ ", q8Marks=" + q8Marks + ", q9Marks=" + q9Marks + ", q10Marks=" + q10Marks + ", q2Remarks="
				+ q2Remarks + ", q3Remarks=" + q3Remarks + ", q4Remarks=" + q4Remarks + ", q5Remarks=" + q5Remarks
				+ ", q6Remarks=" + q6Remarks + ", q7Remarks=" + q7Remarks + ", q8Remarks=" + q8Remarks + ", q9Remarks="
				+ q9Remarks + ", q10Remarks=" + q10Remarks + ", q1RevalMarks=" + q1RevalMarks + ", q1RevalRemarks="
				+ q1RevalRemarks + ", q2RevalMarks=" + q2RevalMarks + ", q3RevalMarks=" + q3RevalMarks
				+ ", q4RevalMarks=" + q4RevalMarks + ", q5RevalMarks=" + q5RevalMarks + ", q6RevalMarks=" + q6RevalMarks
				+ ", q7RevalMarks=" + q7RevalMarks + ", q8RevalMarks=" + q8RevalMarks + ", q9RevalMarks=" + q9RevalMarks
				+ ", q10RevalMarks=" + q10RevalMarks + ", q2RevalRemarks=" + q2RevalRemarks + ", q3RevalRemarks="
				+ q3RevalRemarks + ", q4RevalRemarks=" + q4RevalRemarks + ", q5RevalRemarks=" + q5RevalRemarks
				+ ", q6RevalRemarks=" + q6RevalRemarks + ", q7RevalRemarks=" + q7RevalRemarks + ", q8RevalRemarks="
				+ q8RevalRemarks + ", q9RevalRemarks=" + q9RevalRemarks + ", q10RevalRemarks=" + q10RevalRemarks
				+ ", evaluationDate=" + evaluationDate + ", faculty2Score=" + faculty2Score + ", faculty2Remarks="
				+ faculty2Remarks + ", faculty2Reason=" + faculty2Reason + ", faculty2EvaluationCount="
				+ faculty2EvaluationCount + ", faculty2EvaluationDate=" + faculty2EvaluationDate
				+ ", faculty2Evaluated=" + faculty2Evaluated + ", faculty3Score=" + faculty3Score + ", faculty3Remarks="
				+ faculty3Remarks + ", faculty3Reason=" + faculty3Reason + ", faculty3EvaluationCount="
				+ faculty3EvaluationCount + ", faculty3EvaluationDate=" + faculty3EvaluationDate
				+ ", faculty3Evaluated=" + faculty3Evaluated + ", minMatchPercent=" + minMatchPercent + ", finalScore="
				+ finalScore + ", finalReason=" + finalReason + ", finalRemarks=" + finalRemarks + ", toBeEvaluated="
				+ toBeEvaluated + ", sapIdList=" + sapIdList + ", percentDifference=" + percentDifference + ", mean="
				+ mean + ", stddev=" + stddev + ", normalizedScore=" + normalizedScore + ", roundedNormalizedScore="
				+ roundedNormalizedScore + ", populationCount=" + populationCount + ", weightedMean=" + weightedMean
				+ ", weightedstddev=" + weightedstddev + ", offlineAssignmentLive=" + offlineAssignmentLive
				+ ", trackId=" + trackId + ", amount=" + amount + ", tranDateTime=" + tranDateTime
				+ ", bookingCompleteTime=" + bookingCompleteTime + ", tranStatus=" + tranStatus + ", booked=" + booked
				...
				+ ", respTranDateTime=" + respTranDateTime + ", paymentApplicable=" + paymentApplicable
				+ ", paymentDone=" + paymentDone + ", assignmentscore=" + assignmentscore + ", submissionAllowed="
				+ submissionAllowed + ", submissionAllow=" + submissionAllow + ", evaluatedFaculty=" + evaluatedFaculty
				+ ", acadYear=" + acadYear + ", acadMonth=" + acadMonth + ", threshold2=" + threshold2
				+ ", copyResultList2=" + copyResultList2 + ", studentName=" + studentName + ", faculty1Evaluated="
				+ faculty1Evaluated + ", faculty1Score=" + faculty1Score + ", faculty1Remarks=" + faculty1Remarks
				+ ", faculty1Reason=" + faculty1Reason + ", OptedForReval=" + OptedForReval + ", facultyName="
				+ facultyName + ", currentSemSubject=" + currentSemSubject + ", submissionDate=" + submissionDate
				+ ", ids=" + ids + ", subjectList=" + subjectList + ", plagiarismType=" + plagiarismType + ", title="
