...
//spring security related changes rename BaseBean to BaseExamBean
public class BaseExamBean  implements Serializable {
	...
	public String toString() {
		return "BaseExamBean [sapid=" + sapid + ", year=" + year + ", month=" + month + ", createdBy=" + createdBy
				+ ", createdDate=" + createdDate + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedDate="
				+ lastModifiedDate + ", tranDateTime=" + tranDateTime + ", date=" + date + "]";
	}
