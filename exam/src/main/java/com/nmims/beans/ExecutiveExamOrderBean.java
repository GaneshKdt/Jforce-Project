...
public class ExecutiveExamOrderBean extends BaseExamBean  implements Serializable  {
...
public String toString() {
	return "ExecutiveExamOrderBean [order=" + order + ", live=" + live + ", declareDate=" + declareDate
