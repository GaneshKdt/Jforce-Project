...
@Service("mbaxAuditTrailsService")
public class MBAXAuditTrailsService {
	...
	public LostFocusLogExamBean getStudentDetailsForUnfairMeans( LostFocusLogExamBean bean) {
		...
		studentDetails = mbaxAuditTrailsDAO.getStudentDetailsForUnfairMeans(bean);
	...
	public ArrayList<LostFocusLogExamBean> getTestForLostFocus() throws Exception{
		...
		testList = mbaxAuditTrailsDAO.getTestForLostFocus();
	...
	public ArrayList<LostFocusLogExamBean> getSubjectList()  throws Exception{
		...
		subjectList = mbaxIADao.getSubjectList();
	...
	public LostFocusLogExamBean getReasonForLostFocus( LostFocusLogExamBean bean ) throws Exception{
		...
		reasonForLostFocus = mbaxAuditTrailsDAO.getReasonForLostFocus(bean);
	...
	public TestExamBean getTestById ( Long testId ) throws Exception{
		...
		test = mbaxIADao.getTestById(testId);
	...
	public ArrayList<LostFocusLogExamBean> getRecentTest() throws Exception{
		...
		recentTest = mbaxAuditTrailsDAO.getRecentTest();
	...
	public ArrayList<LostFocusLogExamBean> getTestForSubjectAndDuration(LostFocusLogExamBean bean) throws Exception{
		...
		recentTest = mbaxAuditTrailsDAO.getTestForSubjectAndDuration( bean );
	...
	public ArrayList<AuditTrailExamBean> getTestForIABatchJob( ) throws Exception{
		...
		recentTest = mbaxAuditTrailsDAO.getTestForIABatchJob();
	...
	public ArrayList<AuditTrailExamBean> getDateForErrorAnalytics( ) throws Exception{
		...
		dateList = mbaxAuditTrailsDAO.getDateForErrorAnalytics();
	...
	public List<ErrorAnalyticsBean> getErrorAnalyticsBySapidCreatedDate( String date ) throws Exception{
		...
		recentTest = mbaxAuditTrailsDAO.getErrorAnalyticsBySapidCreatedDate( date );
	...
	public ArrayList<String> getStudentLogFileDetails( LogFileAnalysisBean bean ) {
		...
		ArrayList<LogFileAnalysisBean> questionIdList = mbaxIADao.getQuestionId( bean.getTestId() );
	...
	public TestExamBean updateStartDateTime(TestExamBean bean) throws Exception{
		...
		mbaxAuditTrailsDAO.updateDate(bean);
		mbaxAuditTrailsDAO.updateRefreshCount(bean);
		mbaxAuditTrailsDAO.saveSupportForOtherIssues(bean);
	...
	public TestExamBean updateTestTime(TestExamBean bean) throws Exception{
		...
		boolean status= mbaxAuditTrailsDAO.insertExtendedTestTime(bean);
	...
	public List<StudentExamBean> getAllStudentsForAuditTrails() {
		...
		List<StudentExamBean> mbax_old_studentList = mbaxIADao.getAllStudentsByMasterKey(119);
		List<StudentExamBean> mbax_studentList = mbaxIADao.getAllStudentsByMasterKey(126);
		List<StudentExamBean> mbax_structureSep2022_studentList = mbaxIADao.getAllStudentsByMasterKey(162);
		
		studentsList.addAll(mbax_old_studentList);
		studentsList.addAll(mbax_studentList);
		studentsList.addAll(mbax_structureSep2022_studentList);
	...
	public List<TestExamBean> getTestsBySapid( String sapid ) {
		...
		List<TestExamBean> tests = mbaxIADao.getTestsBySapid( sapid );
	...
	public String getTestJoinLink(String sapid, String testId) {
		...
		testJoinURL = SERVER_PATH+"exam/mbax/ia/s/assignmentGuidelinesForAllViews?testIdForUrl="+encryptedTestId+"&sapidForUrl="+encryptedSapid;
	...
	public StudentsTestDetailsExamBean getStudentsTestDetailsBySapidAndTestId( String sapid, Long testId ) {
		...
		studentTestDetails = mbaxAuditTrailsDAO.getStudentsTestDetailsBySapidAndTestId(sapid,testId);
	...
	public AccumulateAuditTrailsBean getLogDetailsForAttemptedStudents( AuditTrailExamBean bean ) {
		...
		studentTestDetails = mbaxIADao.getStudentsTestDetailsBySapidAndTestId(bean.getSapid(),bean.getTestId());
		data.setStudentTestDetails(studentTestDetails);
		
		answers = mbaxIADao.getAttemptAnswers(bean.getSapid(), bean.getTestId());
		answersAfterFetchingFromDbAndRedis = mbaxIADao.getAccumulatedAnswerFromDbAndRedis( studentTestDetails, answers );
		data.setAnswers(answersAfterFetchingFromDbAndRedis);
		
		errorAnalytics = mbaxAuditTrailsDAO.getErrorAnalyticsBySapidCreatedDate(bean.getSapid(), studentTestDetails.getTestStartedOn());
	...
	public AccumulateAuditTrailsBean getLogDetailsForNotAttemptedStudents( AuditTrailExamBean bean ) {
		...
		test = mbaxIADao.getTestById(bean.getTestId());

		errorAnalytics = mbaxAuditTrailsDAO.getErrorAnalyticsBySapidCreatedDate(bean.getSapid(), test.getStartDate());
		data.setErrorAnalytics(errorAnalytics);
