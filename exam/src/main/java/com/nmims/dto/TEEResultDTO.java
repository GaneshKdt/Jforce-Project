...
public class TEEResultDTO implements Serializable{
	...
	public String toString() {
		return "TEEResultBean [fileData=" + fileData + ", timebound_id=" + timebound_id + ", schedule_id=" + schedule_id
				...
				+ ", compXM_status=" + compXM_status + ", programId=" + programId + ", programStructureId="
				+ programStructureId + ", consumerTypeId=" + consumerTypeId + ", consumerProgramStructureId="
				+ consumerProgramStructureId + ", assessmentName=" + assessmentName + "]";
	}
