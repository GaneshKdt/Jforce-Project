 ...
 *
 */
@Component("downloadRemarksGradeCopyCaseReport")
public class DownloadRemarksGradeCopyCaseReport extends AbstractXlsxStreamingView implements ApplicationContextAware {
	...
	public static final String COL_ASSIGN_SCORE = "Assignment Score";
	...
	protected void buildExcelDocument(Map<String, Object> arg0, Workbook arg1, HttpServletRequest arg2,
		...
		List<RemarksGradeBean> list1 = (ArrayList<RemarksGradeBean>) arg0.get("rgCopyCaseList");
		Sheet sheet = arg1.createSheet("RemarksGradedCCReport");
