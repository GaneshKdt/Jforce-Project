...
public class UFMMarkRIAExcelView extends AbstractXlsxStreamingView  implements ApplicationContextAware{

	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		
		List<StudentMarksBean> list = (ArrayList<StudentMarksBean>) model.get("ufmMarkRIARecords");
		//create a wordsheet :- START
		Sheet sheet = workbook.createSheet("UFM Mark RIA Records");
