...
public class AbsentReportExcelViewMBAWX  extends AbstractXlsxStreamingView  implements ApplicationContextAware{
	
	@Override
	protected void buildExcelDocument(Map model, Workbook workbook,	HttpServletRequest request, HttpServletResponse response)
		throws Exception {
 
		List<TEEResultStudentDetailsBean> studentsList = (List<TEEResultStudentDetailsBean>) model.get("absentStudentList");
		//create a wordsheet
