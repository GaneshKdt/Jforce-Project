 ...
 *
 */
@Component("downloadRemarksGradeEligibleStudentsReport")
public class DownloadRemarksGradeEligibleStudentsReport extends AbstractXlsxStreamingView
	...
	public static final String COL_IASCORE = "IAScore";
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		List<RemarksGradeBean> list1 = (ArrayList<RemarksGradeBean>) model.get("rgEligibleStudentsList");
		Sheet sheet = workbook.createSheet("RemarksGradedEligibleStudentsReport");
		...
		header.createCell(index++).setCellValue(COL_IASCORE);
