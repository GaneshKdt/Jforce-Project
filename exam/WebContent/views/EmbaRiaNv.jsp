...
<body>
	...
	<section class="content-container">
		<div class="container-fluid customTheme">
			...
			<div class="row">
				<legend> EMBA Mark RIA/NV/Score </legend>
			</div>
							...
							<div class="col-md-6 ">
								...
								<div class="form-group">
									<button id="submit" name="submit"
										...
										formaction="embaSearchScoresForRIANV">Search Student
										Scores</button>
								</div>
							</div>
											...
											<tr>
												...
												<td><c:choose>
														<c:when test="${studentMarks.status eq 'RIA'}">
																...
																class="markEMBASingleSubjectRIANV" style="width:10px; height:10px" />
															<br>
														</c:when>
														<c:otherwise>
															       RIA <input
													...
													<c:choose>
														<c:when test="${studentMarks.status ne 'RIA' && studentMarks.status ne 'NV'}">
															     Score <input checked
															data-timebound_id="${studentMarks.timebound_id}"
															data-sapid="${studentMarks.sapid}"
															data-subject="${studentMarks.subject}"
	...
	<script type="text/javascript">
        ...
        $('.markEMBASingleSubjectRIANV').click(function(){
        	...
        	if(conf == true){
                ...
                $.ajax({
                    type: "POST",
                    url: '/exam/admin/updateEmbaSubjectAsRIANV',
                    data: {
