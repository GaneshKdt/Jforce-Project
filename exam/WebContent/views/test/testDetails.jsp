												...
												<div class="col-md-4 col-sm-6 col-xs-12 column">
													<div class="form-group">
														...
														<div class="config_list">
															<c:forEach var="section" items="${qnsConfigured}"	varStatus="status">    
																<b style="font-size:14px;"><c:out value="${section.sectionName}" /></b>:
																     
																<c:forEach var="config" items="${section.sectionQnTypeConfigbean}"	varStatus="s">  
																	<br> <c:out value="${config.sectionQnType}" /> ${config.sectionQnCount} (${config.questionMarks} Marks)
													...
													<div class="form-group">
														...
														<div class="config_list">
															   <c:forEach var="qn" items="${qnsUpoaded}"	varStatus="s">  
																	<b style="font-size:14px;"><c:out value="${qn.sectionName}" /></b>:
																    
																    <c:forEach var="config" items="${qn.sectionQnTypeConfigbean}"	varStatus="s">  
																		<br> <c:out value="${config.sectionQnType}" />: ${config.sectionQnCount}
...
<%-- 																	href="/exam/viewTestDetailsForStudentsForAllViews?userId=${testStudentId}&id=${test.id}&message=''">Preview Test As Student  (Test student : ${testStudentId})</a> --%>
																	...
																	<a target="_blank" class="btn btn-large btn-primary"
																	href="/exam/startStudentTestForAllViewsForFacultyPreview?testId=${test.id}&sapId=${testStudentId}&consumerProgramStructureId=111"
																	>Preview All Questions of Test  (Test student : ${testStudentId})</a> 
																	
																	<a  class="btn btn-large btn-primary"
																	href="/exam/deleteTestAttemptDataBySapidAndTestIdAndAttempt?testId=${test.id}&sapid=${testStudentId}&attempt=1"
																...
																<c:if test="${ifTestlive}">
																	<a target="_blank" class="btn btn-large btn-primary"
																	href="/exam/studentsTestPreviewForAllViews?id=${test.id}&userId=77777777777&message=%27%27&consumerProgramStructureId=111"
																	>Preview Test As Shown To Student  </a> 
																	
																	<a  class="btn btn-large btn-primary"
																	href="/exam/deleteTestAttemptDataBySapidAndTestIdAndAttempt?testId=${test.id}&sapid=77777777777&attempt=1"
																...
																<a class="btn btn-large btn-primary"
																	href="/exam/admin/lostFocusDetails?testId=${test.id}">Lost Focus Details</a>
																 
																<br>
                                                                
																<a class="btn btn-large btn-primary"
                                                                    	href="/exam/grantFacultyEditRights?testId=${test.id}">Grant Faculty Edit Rights</a>
                                                                <br>
                                                                
                                                                <a class="btn btn-large btn-primary"
                                                                	href="/exam/admin/iaBenefitOfDoubt?testId=${test.id}">Benefit Of Doubt</a>
