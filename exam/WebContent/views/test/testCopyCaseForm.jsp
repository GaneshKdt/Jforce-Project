        ...
        <!-- Custom breadcrumbs as requirement is diff. Start -->
            ...
            <div class="sz-main-content menu-closed">
                    <div class="sz-main-content-inner">
							...
							<% try{ %>
																<a href="/exam/downloadCopyCasesByTestId?testId=${test.id}"
																					    ...
																					    <div class="container" >
																					    		...
																					    		<div class="col-xs-6"  style="border-right:2px solid grey">
																					    			<div class="row" >
																							    		...
																							    		<div class="col-xs-12" >
																											...
																											<c:choose>
																											 <c:when test="${copyCase.sapid1AttemptStatus == 'CopyCase' }">
																												<a href="/exam/unMarkIATestsCopyCaseFromAdminView?testId=${test.id}&sapid=${copyCase.sapId1}&attempt=${copyCase.attempt}&questionId=${copyCase.questionId}&markedForCopyCase='${copyCase.sapId2} Marked For Copy Case. '"
																											...
																											Unmark From Copycase
																											 ...
																											 <c:otherwise>
																													<a href="/exam/markIATestsCopyCaseFromAdminView?testId=${test.id}&sapid=${copyCase.sapId1}&attempt=${copyCase.attempt}&questionId=${copyCase.questionId}&markedForCopyCase='${copyCase.sapId1} Marked For Copy Case. '"
																							    		...
																							    		<div class="col-xs-12" >
																							    			Answer : <br>
																							    			<c:choose>
																												<c:when test="${fn:startsWith(copyCase.firstTestDescriptiveAnswer, 'https://')}">
																													<div class="row">
																														<span class="fullscreen-toggle" onClick="openAnswerPdf('${copyCase.firstTestDescriptiveAnswer}')"
																															title="Toggle Fullscreen"><i class="fa-solid fa-maximize"></i></span>
																													</div>
																							        		 		<iframe class="copyCaseIFrame" src="${copyCase.firstTestDescriptiveAnswer}#zoom=100&toolbar=0"
																														webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
																												</c:when>
																												<c:otherwise>
																													<b style="white-space: pre-wrap;" >${copyCase.firstTestDescriptiveAnswer}</b>
																												</c:otherwise>
																											</c:choose>
																							    		</div>
																					    		...
																					    		<div class="col-xs-6" >
																					    			<div class="row" >
																							    		...
																							    		<div class="col-xs-12" >
																											...
																											<c:choose>
																											 <c:when test="${copyCase.sapid2AttemptStatus == 'CopyCase' }">
																												<a href="/exam/unMarkIATestsCopyCaseFromAdminView?testId=${test.id}&sapid=${copyCase.sapId2}&attempt=${copyCase.attempt}&questionId=${copyCase.questionId}&markedForCopyCase='${copyCase.sapId1} Marked For Copy Case. '"
																											...
																											>
																											 ...
																											 <c:otherwise>
																													<a href="/exam/markIATestsCopyCaseFromAdminView?testId=${test.id}&sapid=${copyCase.sapId2}&attempt=${copyCase.attempt}&questionId=${copyCase.questionId}&markedForCopyCase='${copyCase.sapId2} Marked For Copy Case. '"
																							    		...
																							    		<div class="col-xs-12" >
																							    			Answer : <br>
																							    			<c:choose>
																												<c:when test="${fn:startsWith(copyCase.secondTestDescriptiveAnswer, 'https://')}">
																													<div class="row">
																														<span class="fullscreen-toggle" onClick="openAnswerPdf('${copyCase.secondTestDescriptiveAnswer}')"
																															title="Toggle Fullscreen"><i class="fa-solid fa-maximize"></i></span>
																													</div>
																							        		 		<iframe class="copyCaseIFrame" src="${copyCase.secondTestDescriptiveAnswer}#zoom=100&toolbar=0"
																														webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
																												</c:when>
																												<c:otherwise>
																													<b style="white-space: pre-wrap;" >${copyCase.secondTestDescriptiveAnswer}</b>
																												</c:otherwise>
																											</c:choose>
																							    		</div>
																					    	...
																					    	<div class="row" >
																								<div class="col-xs-12" style="text-align: center;" >
																									<a href="/exam/markBothStudentsForIATestsCopyCaseFromAdminView?testId=${test.id}&sapids=${copyCase.sapId1}~${copyCase.sapId2}&attempt=${copyCase.attempt}&questionId=${copyCase.questionId}&markedForCopyCase='${copyCase.sapId2} Marked For Copy Case. '"
