...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
	...
	<jsp:param value="Allocate Faulty To Test Answers" name="title"/>
    </jsp:include>
			...
			<div class="sz-breadcrumb-wrapper">
			    <div class="container-fluid">
			        <ul class="sz-breadcrumbs">
			        		...
			        		<li><a href="#">Allocate Faulty To Test Answers</a></li>
                    ...
                    <div class="sz-main-content-inner">
              				...
              				<div class="sz-content-wrapper examsPage">
              						...
              						<div class="sz-content">
											...
											<h2 class="red text-capitalize">Allocate Faulty To Test Answers </h2>
							...
							<div class="row">
									...
									<h5>Add Faculty For Allocation</h5>
									 <div class="form-group">
								      <div class="col-sm-6">
																				 <div class="col-sm-4">
																				 <input type="hidden" id="facultyid" value="${test.facultyId}" />
																				...
																				<button
																					...
																					style="margin-top: 0px !important; ">Add &amp; Faculty </button>
							...
							<div class="row">
								...
								<div class="well col-sm-12">
								<div class="jumbotron">
									<h2> Answers Left To Allocate : <b id="noOfAllocationsLeft">${noOfAllocationsLeft}</b> </h2>
								</div>
													...
													<table id="fTable" class="table table-hover table-striped" style="font-size: 12px">
														...
														<tbody>
															...
															<c:forEach var="faculty" items="${facultyNAllocatedAnswers}"	varStatus="status">
																<tr id="row-${typeId}" >
																	...
																	<td> <input type="number" min="1" id="i-${faculty.facultyId}" value="0"/></td>
																	<td> 
																	<a 
																		href="#" 
																	...
																	<td> 
																	<a 
																		href="#" onclick="deleteTestAnswerAllocation('${faculty.facultyId}')" class= "btn btn-warning"
																	>Delete</a> 
																	</td>
																</tr>
															</c:forEach>
	 ...
	 $(document).ready(function(){
		...
		function getRowId(facultyId){
		 ...
		 function saveTestFacultyAnswersAllocationAjax(facultyId, allocatedAnswers){
   		...
   		$.ajax({
   			type : 'POST',
   			url : '/exam/m/saveTestFacultyAnswersAllocation',
		...
		//deleteTestFacultyAnswersAllocationAjax start
		 function deleteTestFacultyAnswersAllocationAjax(facultyId, allocatedAnswers){
   		...
   		$.ajax({
   			type : 'POST',
   			url : '/exam/m/deleteTestFacultyAnswersAllocation',
   			data: JSON.stringify(body),
               contentType: "application/json",
               dataType : "json",
