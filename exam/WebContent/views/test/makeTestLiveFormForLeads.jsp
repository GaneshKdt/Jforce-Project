...
<%--													<form:option value="module">Session Plan Module</form:option>
					...
					<div class="form-group">
						...
						formaction="saveTestLiveConfigForLeads">Make Tests Live</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button id="deleteTestLiveConfig" name="deleteTestLiveConfig" class="btn btn-large btn-danger"
						formaction="deleteTestLiveConfigForLeads"> Disable Tests Live Config </button>
						<button onclick="window.location.href = 'testNotLiveForLeads';" class="btn btn-large btn-primary" >view tests to make live</button></a> 
