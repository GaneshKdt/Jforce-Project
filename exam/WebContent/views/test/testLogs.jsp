...
<body>
	...
	function handleTestChange(){
		...
		$.ajax({
			type : "POST",
			contentType : "application/json",
			url : "/exam/m/getStudentTestDetails",   
	...
	<script>
		...
		function getLogDetailsForAttemptedStudents(){
			...
			$.ajax({
				type : "POST",
				contentType : "application/json",
				url : "/exam/m/getLogDetailsForAttemptedStudents",   
				data : JSON.stringify(details),
				success : function(data) {
		...
		function getLogDetailsForNotAttemptedStudents(){
			...
			$.ajax({
				type : "POST",
				contentType : "application/json",
				url : "/exam/m/getLogDetailsForNotAttemptedStudents",   
				data : JSON.stringify(details),
				success : function(data) {
				...
				try {
					...
					for(let i=0;i < testLogs.length;i++){
						...
						if( !Date.parse(testLogs[i].visitedDate) ){
							...
							if(test_duration < 120){
								testLogsDiv = testLogsDiv + "<td><i class='fa-solid fa-plus' aria-hidden='true' style='"+expand+"'></i>"+
		...
		function extendTestDuration(sapid, testId, attempt){
			...
			$.ajax({
				type: 'POST',
				url: '/exam/m/updateStartDateTime',
				data : JSON.stringify(data),
				contentType: "application/json;", 
				dataType: "json",
		...
		function populateLogFileDetails(){
			...
			$.ajax({
				type : "POST",
				contentType : "application/json",
				url : "/exam/m/getStudentLogFileDetails",   
		...
		function saveOtherIssues(sapid, testId, attempt){
			...
			$.ajax({
				type: 'POST',
				url: '/exam/m/saveSupportForOtherIssues',
				data : JSON.stringify(data),
				contentType: "application/json;", 
				dataType: "json",
				success: function(data, textStatus ){
