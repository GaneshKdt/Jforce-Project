		...
		<div class="sz-breadcrumb-wrapper">
			...
			<div class="container-fluid">
				<ul class="sz-breadcrumbs">
					...
					<li><a href="/exam/viewTestDetailsForLeads?id=${test.id}">Test
							Details</a></li>
										...
										<div class="row">
											<div class="col-md-6 column">
												<button id="submit" name="submit"
													...
													formaction="uploadTestQuestionForLeads">Upload</button>
											</div>
										...
										<tbody>
											...
											<c:forEach var="question" items="${testQuestions}" varStatus="status">
												<tr>
													...
													<td>
													<!-- 
													<a href="/exam/viewTestQuestionDetailsForLeads?id=${question.id}">
															<i class="fa fa-edit" style="font-size: 24px"></i>
													 -->
													</a> &nbsp; <a href="/exam/deleteTestQuestionForLeads?id=${question.id}&testId=${test.id}"
														onclick="return confirm('Delete Test question. Are you sure?')">
