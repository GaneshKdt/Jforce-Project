...
<jsp:include page="../jscss.jsp">
	<jsp:param value="Consolidated Students Wise Reports" name="title" />
</jsp:include>
...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Consolidated Students Wise Reports</legend></div>
			<%@ include file="../messages.jsp"%>
				
				<form:form modelAttribute="searchBean" method="post" action="consolidatedStudentsWiseReports">
					<div class="row">
					<div class="col-md-16 column">
						...
						<div class="form-group">
							...
							<form:select id="examYear" path="examYear"  type="text"	 placeholder="Exam Year" class="form-control" required="required" >
							
						
								<form:option selected="selected" value="2019">2019</form:option>
						...
						<div class="form-group">
							...
							<form:select id="examMonth" path="examMonth" type="text"  placeholder="Exam Month" class="form-control" required="required" >
				
																<form:option  selected="selected" value="Oct">Oct</form:option>
						...
						<div class="form-group">
							...
							<form:select id="acadYear" path="acadYear" type="text"	placeholder="Acads Year" class="form-control" required="required"  >
						...
						<div class="form-group">
							...
							<form:select id="acadMonth" path="acadMonth" type="text" placeholder="Acads Month" class="form-control" required="required" >
							
																<form:option  selected="selected" value="Jul">Jul</form:option>
					...
					<!-- ///////////////////////////////////////////////////////////////// -->
						...
						<option selected="selected" value="6">  Retail   </option>
							</select>
							</div>
						</div>
						...
						<div class="col-md-4 column">
							...
							<select data-id="programStructureDataId" id="programStructureId" path="programStructureId" name="programStructureId" class="selectProgramStructure" required="required">
								
								<option value="8"> Jul2019 </option>
						...
						<div class="col-md-4 column">
							...
							<select data-id="programDataId" path="programId" id="programId" name="programId" class="selectProgram">
								<option selected="selected" value="52"> MBA - WX </option>
						...
						<div class="form-group">
							...
							<form:select id="liveType" path="liveType" type="text" class="form-control" required="required" >
								
								<form:option selected="selected" value="Regular">Regular</form:option>
					...
					<div class="form-group">
						...
						formaction="consolidatedStudentsWiseReports">Generate</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
