        ...
        <!-- Custom breadcrumbs as requirement is diff. Start -->
            ...
            <div class="sz-main-content menu-closed">
                    <div class="sz-main-content-inner">
							...
							<%}catch(Exception e){} %>              				
              				...
              				<div class="sz-content-wrapper examsPage">
              						...
              						<div class="sz-content">
											...
											<h2 class="red text-capitalize">Search Tests</h2>
							...
							<!-- Code for Search Form Start --><%-- 
							
							 <div class="">
     <div class="clearfix"></div>
      <div class="panel-content-wrapper" style="min-height:450px;">
       <%@ include file="../adminCommon/messages.jsp" %>
        <form:form  action="searchTests" method="post" modelAttribute="searchBean">
         <fieldset>
          <div class="col-md-4">
    ...
    <div class="form-group">	
											<form:select id="applicableType" path="applicableType" type="text"	
												...
												class="form-control" required="required" 
													 itemValue="${test.applicableType}" disabled="disabled" readonly="readonly"> 
           ...
           <div class="form-group">
            <label class="control-label" for="submit"></label>
             <button id="submit" name="submit" class="btn btn-large btn-primary" formaction="searchTests">Search</button>
             ...
             <button id="cancel" name="cancel" class="btn btn-danger" formaction="home" formnovalidate="formnovalidate">Cancel</button>
							...
							<%try{ %>
																<div class="table-responsive">
																		...
																		<tbody>
																			...
																			<c:forEach var="test" items="${allTests}"
																				...
																				<tr>
																					...
																					<c:choose>
																			         <c:when test="${test.countOfProgramsApplicableTo > 1}">
																			         	...
																			         	<a href="javascript:void(0)"
																			         	   ...
																			         	   class="commonLinkbtn">
																			         	   Common file for 
																			         	   <c:out value="${ test.countOfProgramsApplicableTo }" /> 
																			         	   programs 
																			         	</a>
																			         	</td>
																			         	<td></td>
																					...
																					<c:if test="${test.showResultsToStudents == 'N'}">
																					<a href="/exam/showResultsForTest?id=${test.id}"
																					...
																					<a href="/exam/hideResultsForTest?id=${test.id}"
																					...
																					<td>
																						...
																						&nbsp;
																						<a href="/exam/deleteTest?id=${test.id}"
																	...
																	<a href="viewAllTests?loadAllTest=true" class="btn btn-primary" style="float: right;">Load all test</a>
