...
<jsp:param value="Check Project Copy Case" name="title" />
</jsp:include>
<style>
.assessments-style{
...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Project Copy Case Check</legend></div>
        <%@ include file="../messages.jsp"%>
		<div class="panel-body clearfix">
		<%-- <form:form  action="projectCopyCaseCheck" method="post" modelAttribute="searchBean" id="check_copyCase_form">
			<fieldset>
			<div class="col-md-6 column">
					...
					<div class="form-group">
							<form:select id="subject" path="subject" type="text"	placeholder="Subject" class="form-control" required="required"  itemValue="${searchBean.subject}">
								...
								<form:option value="Project" item="Project" />
					...
					<div class="form-group">
						...
						<div class="controls">
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="projectCopyCaseCheck">Check Copy Cases</button>
		...
		<form id="check_copyCase_form">
			...
			<div class="col-md-6 column">
					<div class="form-group">
						<select id="year" name="year" path="year" type="text"	placeholder="Year" class="form-control" required="required"  itemValue="${searchBean.year}">
					...
					<div class="form-group">
						<select id="month" name="month" path="month" type="text" placeholder="Month" class="form-control" required="required" itemValue="${searchBean.month}">
...
function copyCaseCheck(e)
{
	...
	hideSubmitBtn();
	$.ajax({
		 url : '/exam/m/admin/projectCopyCaseCheck',
	     type : 'POST',
