...
<jsp:param value="Project Detailed Threshold CC" name="title" />
</jsp:include>
<head>
...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Project Detailed Threshold Copy Cases</legend></div>
        <%@ include file="../messages.jsp"%>
		<div class="panel-body clearfix">
			<form:form id='projectDetailedThresholdCCForm' action="searchProjectDetailedThresholdCC" method="post" modelAttribute="searchBean">
				<fieldset>
				...
				<div class="col-md-6 column">
					<div class="form-group">
						<div class="controls">
							<button id="submit" name="submit" class="btn btn-sm btn-primary" formaction="searchProjectDetailedThresholdCC">Search</button>
