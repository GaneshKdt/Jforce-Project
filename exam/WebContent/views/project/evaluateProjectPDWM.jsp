...
<%@ include file="../header.jsp"%>
			...
			<div class="panel-body">
				...
				<div id="evaluation">
					...
					<h4 align="left" style="color: #c72127;">Enter Marks per Marking Criteria</h4>
						...
						<div class="form-group">
								<form:label for="q1Marks" path="q1Marks">Industry Perspective & Trends, Gap analysis (Literature review)</form:label>
								<form:select id="q1Marks" path="q1Marks" itemValue="${assignmentFile.q1Marks}" class="form-control" onchange="setTotal(this);"  required="required">
									...
									<form:options items="${common10MarksOptionsList}"/>
								</form:select>
						</div>
						...
						<div class="form-group">
							<form:label for="q2Marks" path="q2Marks">Concepts and application usage</form:label>
						...
						<div class="form-group">
							<form:label for="q3Marks" path="q3Marks">Research Methodology and Data interpretation</form:label>
						...
						<div class="form-group">
							<form:label for="q4Marks" path="q4Marks">Project Outcomes with its implications and recommendations</form:label>
						...
						<div class="form-group">
							<form:label for="q5Marks" path="q5Marks">Quality of Report- compliance to format and guidelines</form:label>
	...
	<script src="${pageContext.request.contextPath}/resources_2015/js/vendor/screentime.js?id=1"></script>
	<script>
