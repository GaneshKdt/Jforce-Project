			...
			<form:form modelAttribute="projectTitle" method="post">
				...
				<div class="row">
					<div class="col-md-6 column">
						<a class="btn btn-large btn-danger" href="addProjectTitlesConfigForm">
							Cancel
						</a>
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="updateProjectTitleConfig">
							Update
						</button>
					</div>
				</div>
