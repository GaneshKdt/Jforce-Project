...
<jsp:include page="../jscss.jsp">
	<jsp:param value="Transfer Sify Results To Marks Table" name="title" />
</jsp:include>
...
<body class="inside">
	...
	<div class="row"><legend>Transfer Sify Results To Marks Table</legend></div>
		
			<%@ include file="../messages.jsp"%>
	<div class="panel-body clearfix">
	
	<form:form  action="transferSifyResultsToOnlineMarks" method="post" modelAttribute="sifyMarksBean">
			<fieldset>
				...
				formaction="transferSifyResultsToOnlineMarks">Transfer Sify Data</button>
