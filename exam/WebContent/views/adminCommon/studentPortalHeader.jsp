...
<li class="has-sub-menu">
             	<a href="#" title="addSubjectDateForm">MDM</a>
                	<ul class="sz-sub-menu">
		                ...
		                <li><a href="/exam/addTimeBoundStudentMappingForm">Add Student Mapping</a>
		                <li><a href="/exam/moveStagingToTimeBoundTableForm">Move TimeBound Staging</a>
		                <li><a href="/exam/admin/currencyDetailsForm">Add Currency Details</a></li>
		                <li><a href="/exam/admin/exitSrCertificateMappingForm">Exit Certificate Entries</a>
...
<li class="has-sub-menu">
	...
	<%} %>
	<script>
	//comment by sagar getting error at assignment ANS $ not defined.
