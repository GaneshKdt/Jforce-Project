...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
		...
		<form  action="queryTransactionStatus_MBAX" method="post" >
			<fieldset>
			<div class="col-md-6 column">
				...
				<div class="form-group">
					...
					<div class="controls">
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="queryTransactionStatus_MBAX">Get Transactions</button>
					...
					<table class="table table-striped" style="font-size:12px">
						...
						<tbody>
								...
								<tr>
						            ...
						            <td> 
						            <c:url value="approveTransactionsForTrackId_MBA_X" var="approveTransactions">
