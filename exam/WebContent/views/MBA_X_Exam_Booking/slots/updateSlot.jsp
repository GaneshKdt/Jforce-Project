...
<jsp:include page="../../jscss.jsp">
	<jsp:param value="Upload MBA-X Slot" name="title" />
</jsp:include>
<head>
...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			<fieldset class="row">
				<legend>Update MBA-X Slot</legend>
			</fieldset>
			...
			<form:form modelAttribute="slotBean" method="post">
				...
				<div class="row">
					<div class="col-md-6 column">
						<a class="btn btn-large btn-danger" href="slotsList_MBAX">
							Cancel
						</a>
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="updateSlot_MBAX">
							Update
						</button>
					</div>
				</div>
