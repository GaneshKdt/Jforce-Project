		...
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Upload Online Exam Marks</legend></div>
				...
				<form:form modelAttribute="fileBean" method="post" 	enctype="multipart/form-data" action="uploadOnlineExamMarks">
					...
					Student ID	| Name | Total Score | Section 1 Score | Section 2 Score | Section 3 Score | Section 4 score | Student Type<br>
					<a href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_EXAM_STATIC_RESOURCES')" />resources_2015/templates/Online_Marks_Template_New.xlsx" target="_blank">Download a Sample Template</a>
					</div>
			...
			<div class="row">
				<div class="col-md-6 column">
					<button id="submit" name="submit" class="btn btn-large btn-primary"
						formaction="uploadOnlineExamMarks">Upload</button>
				</div>
