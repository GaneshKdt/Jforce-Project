...
<%@ include file="header.jsp"%>
	...
	<%
	List<ExamCenterBean> examCentersList = (List<ExamCenterBean>)request.getAttribute("examCentersList");
	%>
	
	<c:choose>
	<c:when test="${rowCount > 0}">

	<h2>&nbsp;Exam Centers<font size="2px"> (${rowCount} Records Found) &nbsp; </font></h2>
	<div class="panel-body">
		...
		<table class="table table-striped" style="font-size:12px">
							...
							for(int i = 0; i < examCentersList.size(); i++){
								ExamCenterBean bean = (ExamCenterBean)examCentersList.get(i);
						...
						<div class="form-group">
							...
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="updateExamCenterCapacity">Update Capacity</button>
							<button id="reset" type="reset" class="btn btn-danger" type="reset">Reset</button>
							<button id="cancel" name="cancel" class="btn btn-danger" formaction="searchExamCenterForm" formnovalidate="formnovalidate">Back to Exam Center Search</button>
						</div>
