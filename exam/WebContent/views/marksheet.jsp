...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
		...
		<form:form  action="getMarksheet" method="post" modelAttribute="studentMarks">
			<fieldset>
		...
		<div class="col-md-6 column">
					...
					<div class="form-group">
						...
						<!-- <div class="controls"> -->
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="getMarksheet">Generate</button>
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="getMarksheetSignatureExcel">Generate Signature Excel</button>
