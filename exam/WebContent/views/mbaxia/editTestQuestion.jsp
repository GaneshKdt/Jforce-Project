		...
		<div class="sz-breadcrumb-wrapper">
			<div class="container-fluid">
				<ul class="sz-breadcrumbs">
					...
					<li><a href="/exam/mbax/ia/a/viewTestsForFaculty">Internal Assessments</a></li>
					<li><a
						href="/exam/mbax/ia/a/addTestQuestionsForFacultyForm?id=${test.id}">Manage
							Questions</a></li>
																...
																<div class="row well"
																	...
																	<div class="col-xs-1">
																		...
																		href="/exam/deleteTestQuestionOptionById?id=${tempOption.id}&testId=${test.id}&questionId=${testQuestion.id}&questionId=${testQuestion.id}">
																			<i class="fa fa-trash" title="delete option"></i>
																		</a>
																	</div>
																</div>
																<br>
	...
	$(document).ready(function() {
		...
		//saveAnswerAjax start
		 function saveAnswerAjax(questionDetails){
    		...
    		$.ajax({
    			type : 'POST',
    			url : '/exam/mbax/ia/am/m/updateTestQusetion',
