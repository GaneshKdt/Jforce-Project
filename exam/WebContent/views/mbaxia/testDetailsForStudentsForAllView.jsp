				...
				.ready(
						function() {
							...
							function launchAssignment(){
								...
								window.open('/exam/mbax/ia/s/assignmentGuidelinesForAllViews?testIdForUrl=${testIdForUrl}&sapidForUrl=${sapidForUrl}&consumerProgramStructureIdForUrl=${consumerProgramStructureIdForUrl}', '', 'resizable=yes,status=no,location=no,toolbar=no,menubar=no,fullscreen=yes,scrollbars=yes,dependent=no,left=0,top=0,width='+w+',height='+h+''); 
							...
							function launchAssignmentForMobile(){
								...
								window.location.href = "/exam/mbax/ia/s/assignmentGuidelinesForAllViews?testIdForUrl=${testIdForUrl}&sapidForUrl=${sapidForUrl}&consumerProgramStructureIdForUrl=${consumerProgramStructureIdForUrl}";
								goToGuidelinesPageButtonClicked();
							}
							...
							function showTestAlreadyOpenPopup(){
						  	...
						  	function logPageLoadedEvent(){
					        	...
					        	try{
					        		let apiUrl = window.location.origin+"/exam/mbax/ia/s/viewTestDetailsForStudentsForAllViews_pageLoaded";
						  	...
						  	function goToGuidelinesPageButtonClicked(){
					        	...
					        	try{
					        		let apiUrl = window.location.origin+"/exam/mbax/ia/s/assignmentGuidelines_goToLinkClicked";
									response_time = new Date().getTime();
					    			response_payload_size =  0 ;
					      			asyncApiLogAjaxCall(sapid,apiUrl,resquest_time,response_time,"Success","",response_payload_size)
