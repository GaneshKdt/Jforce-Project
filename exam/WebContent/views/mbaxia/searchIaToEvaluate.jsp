...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			<div class="row">
				<legend>MBAX - Search IA for Evaluation</legend>
			</div>
				...
				<c:when test="${rowCount > 0}">
					...
					<h2>
						&nbsp;IA Evaluates Details <font size="2px"> (${rowCount}
							Records Found)&nbsp; &nbsp; <%if(roles.indexOf("Assignment Admin") != -1 || roles.indexOf("Exam Admin") != -1){ %>
							<a class="btn btn-sm btn-primary"
							href="/exam/mbax/ia/a/downloadIaToEvaluate">Download IA Evaluates Excel</a>
							<%} %>
						</font>
					</h2>
