...
<jsp:include page="../adminCommon/jscss.jsp">
	<jsp:param value="Configure Online Internal Assessment Questions"
		name="title" />
</jsp:include>
		...
		<div class="sz-breadcrumb-wrapper">
			<div class="container-fluid">
				<ul class="sz-breadcrumbs">
					...
					<li><a href="#">Configure Internal Assessment Questions </a></li>
							...
							<div class="table-responsive">
								<table class="table table-hover table-striped"
									...
									<tbody>
										...
										<c:forEach var="typeId" items="${applicableTypes}"
											varStatus="status">
											<tr id="row-${typeId}" class="redLeftBorder">
												...
												<td><c:choose>
														...
														<c:otherwise>
															<select class="form-control" id="maxQuestions-${typeId}">
																<option
																	value="${testIdNConfigMap[typeId].maxNoOfQuestions}">${testIdNConfigMap[typeId].maxNoOfQuestions}</option>
																<c:forEach var="i" begin="0"
																	end="${testIdNConfigMap[typeId].noOfQuestions}">
												...
												<td>
													<button class="btn btn-primary"
														onclick="saveConfig(${typeId})">Save</button>
												</td>
