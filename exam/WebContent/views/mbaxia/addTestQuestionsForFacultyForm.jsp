			...
			<div class="sz-breadcrumb-wrapper">
				<div class="container-fluid">
					<ul class="sz-breadcrumbs">
						...
						<li><a href="/exam/mbax/ia/a/viewTestsForFaculty">Internal Assessment</a></li>
			        	<li><a href="/exam/mbax/ia/a/addTestQuestionsForFacultyForm?id=${test.id}">Manage Questions</a></li>
										...
										<tbody>
											<c:forEach var="question" items="${testQuestions}" varStatus="status">
												<tr id="question-row-id-value-${question.id}">
													...
													<td>
													<a href="/exam/mbax/ia/a/editTestQuestion?id=${question.id}"
    ...
    function saveMedia(myFile) {
		try{
			...
			formData.append('image', myFileInput); 
			 ...
			 $.ajax({
				url : '/exam/mbax/ia/am/m/uploadTestQuestionImage?testId=',
				data : formData,
				processData : false,
				contentType : false,
				type : 'POST',
    ...
    function saveFile(myFile) {
		try{
			...
			formData.append('image', myFileInput); 
			 ...
			 $.ajax({
				url : '/exam/mbax/ia/am/m/uploadTestAssignmentQuestionFile?testId=${test.id}',
				data : formData,
				processData : false,
				contentType : false,
				type : 'POST',
	...
	*/
			...
			if ($(this).is(':selected')) {
				...
				questionsTextEditorObj =  CKEDITOR.replace(
						textareaId,
						{
							...
							uploadUrl : '/exam/mbax/ia/a/ckeditorFileUpload',

						      // Configure your file manager integration. This example uses CKFinder 3 for PHP.
						      filebrowserBrowseUrl: '/exam/mbax/ia/a/ckeditorFileUpload',
						      filebrowserImageBrowseUrl: '/exam/mbax/ia/a/ckeditorFileUpload',
						      filebrowserUploadUrl: '/exam/mbax/ia/a/ckeditorFileUpload',
						      filebrowserImageUploadUrl: '/exam/mbax/ia/a/ckeditorFileUpload',
	...
	function saveQuestionAjax(questionDetails) {
		...
		console.group("saveQuestionAjax");
			...
			$.ajax({
				type: 'POST',
				url: '/exam/mbax/ia/am/m/saveSingleTestQuestion',
				...
				var editIcon = "<a href='/exam/mbax/ia/a/editTestQuestion?id="+mainQuestionId+"'><i class='fa-solid fa-pen-to-square' title='edit'></i></a>";
	...
	function deleteTestQuestionsAjax(id){
		var promiseObj = new Promise(function (resolve, reject) {
			...
			$.ajax({
				type: 'POST',
				url: '/exam/mbax/ia/am/m/deleteTestQusetion',
				data: JSON.stringify(body),
				contentType: "application/json",
				dataType: "json",
