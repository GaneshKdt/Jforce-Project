			...
			<div class="sz-breadcrumb-wrapper">
			    <div class="container-fluid">
			        <ul class="sz-breadcrumbs">
			        		<li><a href="/exam/">Exam</a></li>
			        		<li><a href="/exam/admin/viewAllTestsForLeads">Tests</a></li>
			        		<li><a href="/exam/viewTestDetailsForLeads?id=${test.id}">Test Details</a></li>
		...
		<div class="sz-main-content menu-closed">
                    <div class="sz-main-content-inner">
							...
							<div  style="min-height:450px;">
								<jsp:include page="../adminCommon/messages.jsp" />
							...
							<div class="panel-content-wrapper" style="display:none;">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-4 column" style="display:none;">
										...
										<div class="form-group">
											...
											<form:select id="consumerTypeId" path="consumerTypeId" type="text"	placeholder="consumerType" class="form-control selectConsumerType" required="required" 
									                ...
									                <c:choose>
													  <c:when test='${test.consumerTypeIdFormValue eq consumerType.id}'>
						...
						<div class="col-md-4 column">
							...
							<div class="form-group">
											...
											<form:select id="programStructureId" path="programStructureId" type="text"
													...
													<form:option value="10">Jul2020</form:option>
										...
										<div class="form-group">	
											...
											<form:select id="applicableType" path="applicableType" type="text"	
												...
												class="form-control" required="required" 
													...
													<form:option value="old">Test For Leads</form:option>
											</form:select>
										</div>
									</div>
								</div>
						...
						<%-- 
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column" style="display:none">
											<div class="slider round">
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											...
											<form:option value="${test.proctoringEnabled}" selected="selected" ><c:if test="${test.proctoringEnabled eq 'Y'}">Yes</c:if><c:if test="${test.proctoringEnabled eq 'N'}">No</c:if>
											</form:option> 
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
											<form:select value="${test.showCalculator}"  class="form-control" path="showCalculator" required="required" >     
											<form:option value="${test.showCalculator}" selected="selected" >
												<c:if test="${test.showCalculator eq 'Y'}">Yes</c:if>
												<c:if test="${test.showCalculator eq 'N'}">No</c:if>
											</form:option> 
												 ...
												 <c:choose>
									               <c:when test="${testConfigIds eq null}">
													...
													<button id="submit" class="btn btn-large btn-primary"
														...
														formaction="addTestForLeads">Save</button>
...
<script>
	$(function() {
		...
		// Start added by Abhay For randomQuestionCheck for onPageloadValidation
		var randomQuestionCheck = $("input[name='randomQuestion']:checked"). val();

		if(randomQuestionCheck == 'N'){
			$('#maxQuestions').hide();
		...
		// End added by Abhay For randomQuestionCheck for onPageloadValidation
		 ...
		 $("span.toggle-handle.btn.btn-default.btn-xs").remove(); //remove Yes No toggle span elements By Abhay
...
//										"<option value='"+ allOption +"' selected >All</option>" + options
										"<option value='' selected >Select Program</option>" + options

								);
							}else{
								$('#programId').html(
//										"<option value='"+ allOption +"'>All</option>" + options
										"<option value=''  >Select Program</option>" + options
					...
					console.log("==========> options\n" + options);
							if(programStructureIdFromDB.split(',').length > 1){
								$('#programStructureId').html(
									//	"<option value='"+ allOption +"' selected >All</option>" + options
										"<option value='' selected >Select Program Structure</option>" + options
								);
							} else{
								$('#programStructureId').html(
									//	"<option value='"+ allOption +"'>All</option>" + options
										"<option value=''  >Select Program Structure</option>" + options
								);
							}
					//End
