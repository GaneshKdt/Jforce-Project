																		...
																		<tbody>
																			...
																			<c:forEach var="test" items="${allTests}"
																				...
																				<tr>
																					...
																					<td>
																						<a href="/exam/mbax/ia/a/evaluateTestAnswersForm?id=${test.id}"
																					...
																					<td>
																						<a href="/exam/mbax/ia/a/addTestQuestionsForFacultyForm?id=${test.id}"
																						...
																						<a href="/exam/mbax/ia/a/IAPreviewQuestionsForFacultyView?id=${test.id}"
