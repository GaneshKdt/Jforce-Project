...
<jsp:include page="../adminCommon/jscss.jsp">
	<jsp:param value="Edit Internal Assessment" name="title" />
</jsp:include>
...
<body>
	...
	<div class="sz-main-content-wrapper">
		...
		<c:if test="${test.id eq null}">
			<c:set var="duration" value="30" />
			<!-- duration by default 30 on addtest -->
			<c:set var="testName"
				value="${module.subjectCode}-IA${module.sessionModuleNo }-${module.topic}-${module.batchName}" />
			...
			<c:set var="consumerTypeIdFormValue"
				value="${module.consumerTypeIdFormValue}" />
			<c:set var="programStructureIdFormValue"
				value="${module.programStructureIdFormValue}" />
			...
			<div class="sz-breadcrumb-wrapper">
				<div class="container-fluid">
					<ul class="sz-breadcrumbs">
						...
						<li><a href="/exam/viewAllTests">Internal Assessment</a></li>
						<li><a href="#">Add Internal Assessment</a></li>
		...
		<c:if test="${test.id ne null}">
			...
			<c:set var="consumerTypeIdFormValue"
				value="${test.consumerTypeIdFormValue}" />
			<c:set var="programStructureIdFormValue"
				value="${test.programStructureIdFormValue}" />
				...
				<div class="container-fluid">
					<ul class="sz-breadcrumbs">
						...
						<li><a href="/exam/mbax/ia/a/viewTestDetails?id=${test.id}">Internal Assessment
								Details</a></li>
						<li><a href="#">Edit Internal Assessment</a></li>
			...
			<div class="sz-main-content-inner">
				...
				<div class="sz-content-wrapper examsPage">
					...
					<div class="sz-content">
						...
						<c:if test="${test.id eq null}">
							<h2 class="red text-capitalize">Add Online Internal Assessment</h2>
						</c:if>

						<c:if test="${test.id ne null}">
							<h2 class="red text-capitalize">
								Edit Online Internal Assessment : ${test.testName} &nbsp;&nbsp; <a
								...
								<div class="panel-content-wrapper">
									...
									<c:if test="${test.id eq null}">
										<form:input type="hidden" path="referenceId"
											value="${moduleId}" id="referenceId" />
										<form:input type="hidden" path="sessionPlanId"
											value="${sessionPlanId}" id="sessionPlanId" />
									</c:if>
									<div class="row">
										<div class="col-md-3 col-sm-3 col-xs-4 column">
										...
										<div class="col-md-6 col-sm-8 col-xs-12 column">
											...
											<form:hidden path="consumerTypeIdFormValue"
												value="${consumerTypeIdFormValue }" />
											<form:hidden path="programStructureIdFormValue"
												value="${programStructureIdFormValue }" />
											<form:hidden path="programIdFormValue"
												value="${programIdFormValue }" />
									...
									<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<c:forEach var="config"
															items="${test.testQuestionConfigBean}">
										...
										<c:if test="${test.id ne null}">
											...
											<div class="col-md-3 col-sm-6 col-xs-6 column">
												<div class="form-group">
													<form:select id="questionTemplate" path="templateId"
														class="form-control">
														<form:option value="">Select</form:option>
														<c:forEach var="templateType" items="${templateTypes}">

															<form:option marks="${templateType.questionMarks }"
																qns="${templateType.minNoOfQuestions }"
																type="${ templateType.testType}"
																dur="${ templateType.duration}"
																value="${ templateType.templateId}">${ templateType.name}</form:option>
										...
										<c:if test="${test.id eq null}">
											<div class="col-md-3 col-sm-6 col-xs-6 column">
												<div class="form-group">
													<form:select required="required" id="questionTemplate"
														path="templateId" class="form-control template">
														<c:forEach var="templateType" items="${templateTypes}">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												...
												<div class='input-group date' id=''>
													...
													<form:input path="startDate" id="addtest_startDate"
														class="sDate" type="datetime-local" style="color:black;"
														required="required" />
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												...
												<div class='input-group date' id='   '>
													<form:input path="endDate" id="addtest_endDate"
														class="enDate" type="datetime-local" style="color:black;"
														required="required" />
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												<form:select class="form-control testType" path="testType"
													required="required">
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												<form:select class="form-control maxScore"
													placeholder="Score Out of" path="maxScore"
													required="required">
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												<form:select class="form-control" path="proctoringEnabled"
													required="required">
													<form:option value="${proctoringEnabled}"
														selected="selected">
														<c:if test="${proctoringEnabled eq 'Y'}">Yes</c:if>
														<c:if test="${proctoringEnabled eq 'N'}">No</c:if>
													</form:option>
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6 col-xs-12 column">
											<div class="form-group">
												<form:select value="${showCalculator}" class="form-control"
													path="showCalculator" required="required">
											...
											<div class="form-group">
												...
												<c:choose>
													...
													<c:otherwise>
														...
														<button id="submit"
															class="btn btn-large btn-primary submitbtn"
...
$(document).ready (function(){
	...
	<c:if test="${test.id ne null}">
		...
		function updateProgramNProgram(){
			...
			var data = {
					id:${test.consumerTypeIdFormValue}
			}
			...
			$.ajax({
				...
				error : function(e) {
					...
					alert("Please Refresh The Page. 1")
...
alert("Please Refresh The Page. 3")
...
alert("Please Refresh The Page. 4")
...
alert("Please Refresh The Page. 5")
...
alert("Please Refresh The Page. 6")
...
alert("Please Refresh The Page. 7")
...
alert("Please Refresh The Page. 8")
