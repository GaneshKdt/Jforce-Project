...
<jsp:param value="Generate Evaluation Sheet" name="title" />
</jsp:include>
...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Generate Evaluation Sheet</legend></div>
        <%@ include file="messages.jsp"%>
		<div class="panel-body">
		<form:form  action="getEvaluationSheet" method="post" modelAttribute="bean" >
			<fieldset>
			<div class="col-md-6 column">
				
					<div class="form-group">
						<form:select id="year" path="year" type="text" required="required"	 class="form-control"   itemValue="${bean.year}">
					...
					<div class="form-group">
						<form:select id="month" path="month" type="text" required="required"  class="form-control"  itemValue="${bean.month}">
					...
					<div class="form-group">
						<form:select id="mode" path="examMode"  required="required" class="form-control"  itemValue="${bean.examMode}" 
					...
					<div class="form-group">
						<form:select id="offlineCenters" path="offlineCenterId"  class="form-control"   itemValue="${bean.offlineCenterId}">
					...
					<div class="form-group">
						<form:select id="onlineCenters" path="onlineCenterId" type="text" 	 class="form-control"   itemValue="${bean.onlineCenterId}">
					...
					<div class="form-group">
						...
						<!-- <div class="controls"> -->
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="getEvaluationSheet" 
		...
		<a href="/exam/admin/downloadEvaluationSheet">Download Evaluation Sheet</a>
		<%} %>
		</div>
	</div>
