...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Report for Exam Bookings</legend></div>
			
			<%@ include file="../messages.jsp"%>

			<div class="panel-body clearfix">
			<form:form  action="/exam/admin/examBookingReport" method="post" modelAttribute="studentMarks">
			<fieldset>
			<div class="col-md-6 column">
					...
					<button id="submit" name="submit" class="btn btn-large btn-primary"
						formaction="/exam/admin/examBookingReport">Generate</button>
		...
		<c:if test="${rowCount > 0}">
			<div class="panel-body">
				<h2>&nbsp;Exam Bookings Report<font size="2px"> (${rowCount} Records Found) &nbsp; <a href="/exam/admin/downloadExamBookingReport">Download to Excel</a></font></h2>
			</div>
		</c:if>
		</div>
	</section>
...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> 
    ...
    <body>
        ...
        <div class="sz-main-content-wrapper">
			...
			<jsp:param value="Exam;Report for Exam Bookings" name="breadcrumItems"/>
			</jsp:include>
              						...
              						<div class="sz-content">
										...
										<c:if test="${rowCount > 0}">
											...
											<font size="2px">(${rowCount} Records Found) &nbsp; 
												<a href="/exam/admin/downloadExamBookingReport" style="color:blue;">Download to Excel</a>
											</font></h2>
											<div class="clearfix"></div>
										</c:if>
									</div>
