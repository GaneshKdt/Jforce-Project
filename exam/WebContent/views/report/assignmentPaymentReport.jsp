...
<jsp:include page="../jscss.jsp">
	<jsp:param value="Report for Assignment Payments" name="title" />
</jsp:include>
...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Report for Assignment Payments</legend></div>
			...
			<div class="col-md-6 column">
					...
					<button id="submit" name="submit" class="btn btn-large btn-primary"
						formaction="/exam/admin/assignmentPaymentReport">Generate</button>
		...
		<c:if test="${rowCount > 0}">
			<div class="panel-body">
				<h2>&nbsp;Assignment Payment Report<font size="2px"> (${rowCount} Records Found) &nbsp; <a href="/exam/admin/downloadAssignmentPaymentReport">Download to Excel</a></font></h2>
			</div>
		</c:if>
		</div>
	</section>
...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> 
    ...
    <body>
        ...
        <div class="sz-main-content-wrapper">
			...
			<jsp:param value="Exam;Report for Assignment Payments" name="breadcrumItems"/>
			</jsp:include>
                    ...
                    <div class="sz-main-content-inner">
              				...
              				<div class="sz-content-wrapper examsPage">
              						...
              						<div class="sz-content">
											...
											<h2 class="red text-capitalize">Report for Assignment Payments</h2>
										...
										<c:if test="${rowCount > 0}">
											<h2>&nbsp;Assignment Payment Report 
											<font size="2px">(${rowCount} Records Found) &nbsp; 
												<a href="/exam/admin/downloadAssignmentPaymentReport" style="color:blue;">Download to Excel</a>
											</font></h2>
											<div class="clearfix"></div>
										</c:if>
									</div>
