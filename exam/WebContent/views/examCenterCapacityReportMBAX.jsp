                    ...
                    <div class="sz-main-content-inner">
              				...
              				<div class="sz-content-wrapper examsPage">
              						...
              						<div class="sz-content">
										...
										<form:form  action="examCenterCapacityReportMBAX" method="post" modelAttribute="examCenterSlotBean">
											<fieldset>
												<div class="col-md-4">
													<div class="form-group">
															<form:select id="writtenYear" path="year" type="text"	placeholder="Written Year" class="form-control"   itemValue="${examCenterSlotBean.year}">
																<form:option value="">Select Written Year</form:option>
																<form:options items="${yearList}" />
															</form:select>
													</div>
													<div class="form-group">
														<form:select id="writtenMonth" path="month" type="text" required="required" placeholder="Written Month" class="form-control"  itemValue="${examCenterSlotBean.month}">
															<form:option value="">Select Exam Month</form:option>
															<form:option value="Apr">Apr</form:option>
															<form:option value="Jun">Jun</form:option>
															<form:option value="Sep">Sep</form:option>
													...
													<div class="form-group">
													<button id="submit" name="submit" class="btn btn-large btn-primary"
														formaction="examCenterCapacityReportMBAX">Generate</button>
														<button id="cancel" name="cancel" class="btn btn-danger" formaction="home" formnovalidate="formnovalidate">Cancel</button>
													</div>
												</div>
											</fieldset>
										...
										<c:if test="${rowCount > 0}">
											...
											<font size="2px">(${rowCount} Records Found) &nbsp; 
												<a href="downloadExamCenterCapacityReportMBAX" style="color:blue;">Download to Excel</a>
											</font></h2>
											<div class="clearfix"></div>
										</c:if>
									</div>
