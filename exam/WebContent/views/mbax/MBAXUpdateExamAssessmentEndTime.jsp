<html class="no-js">
	...
	<jsp:param value="Extend Assessment End Time" name="title" />
	</jsp:include>
	<head>
	...
	<%@ include file="../header.jsp"%>
		<section class="content-container login">
			...
			<div class="row"><legend>Exam Assessment Panel</legend></div>
				...
				<div class="column">
				<h4 style="text-align: right;"><a href="https://docs.google.com/document/d/11HoXToM5zpwMNXIdbsF3zp7fjfWrlwANNqllxo_H_d4/edit" target="_blank">View steps to extent exam end time.</a></h4>
	    ...
	    $('.dataTables').Tabledit({
	    	columns: {
				...
				onAjax: function(action, serialize) {
					...
					$.ajax({
						type : "POST",
						url  : "updateExamAssessmentDateTime",
