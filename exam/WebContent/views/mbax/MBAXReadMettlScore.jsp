...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
	<jsp:include page="../jscss.jsp">
		<jsp:param value="MBAX Pull and Insert Mettl Scores" name="title"/>
	</jsp:include>
	<body>
		...
		<section class="content-container">
			<div class="container-fluid customTheme">
				...
				<div class="row">
					<legend> MBAX Pull and Insert Mettl Scores</legend>
				</div>
				...
				<form:form method="post" modelAttribute="mettlResponseBean">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-4 ">
								<div class="form-group">
									<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="readMettlMarksFromAPIMBAX">Retrive Mettl Scores</button>
								</div>		
							</div>
						</div>
					</div>
