...
<jsp:param value="Generate Attendance Sheet" name="title" />
</jsp:include>
...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Generate Attendance Sheet</legend></div>
        <%@ include file="messages.jsp"%>
		<div class="row clearfix">
		<form:form  action="getAttendanceSheet" method="post" modelAttribute="bean" >
			<fieldset>
			<div class="col-md-6 column">
					...
					<div class="form-group">
						...
						<!-- <div class="controls"> -->
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="getAttendanceSheet" 
		...
		<a href="/exam/admin/downloadAttendanceSheet">Download Attendance Sheet</a>
		<%} %>
		</div>
	</div>
