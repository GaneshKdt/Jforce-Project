...
<jsp:param value="Assignment CC Report" name="title" />
</jsp:include>
...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Download Assignment Copy Case Report</legend></div>
		...
		<form:form id='getAssignmentCopyCaseReportForm' action="downloadAssignmentCopyCaseReport" method="post" modelAttribute="searchBean">
			<fieldset>
				...
				<div class="col-md-6 column">
					...
					<div class="form-group">
						<div class="controls">
							<button id="submit" name="submit" class="btn btn-sm btn-primary" formaction="downloadAssignmentCopyCaseReport">Download Copy Case Report</button>
