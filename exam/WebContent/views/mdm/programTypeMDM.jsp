...
<jsp:include page="../adminCommon/jscss.jsp">
	<jsp:param value="Program Type" name="title" />
</jsp:include>
<body>
	...
	<div class="sz-main-content-wrapper">
		...
		<jsp:include page="../adminCommon/breadcrum.jsp">
			<jsp:param value="Exam;Program Type Entries"
				name="breadcrumItems" />
		</jsp:include>
			...
			<div class="sz-main-content-inner">
				...
				<div class="sz-content-wrapper examsPage">
					...
					<div class="sz-content">
						<h2 class="red text-capitalize">Add Program Type Entries</h2>
									...
									<div class="panel-body">
										<div class="column">
											...
											<div class="col-sm-3 column">
												...
												<form:input id="subject" path="programType"
													type="text" placeholder="Program Type"
													class="form-control" required="required"
													value="${programBean.programType}" />
											</div>
											<div class="clearfix"></div>
											...
											<button id="submit" name="submit"
													...
													formaction="insertProgramType">Add Entry</button> 
								...
								<div class="table-responsive">
									<table class="table table-striped table-hover tables"
										...
										<tbody>
											...
											<c:forEach var="programType"
												items="${programTypeList}">
												<tr
													value="${programType.id}~${programType.programType}">
													<td><c:out value="${programType.id}" /></td>
													<td><c:out
															value="${programType.programType}" /></td>
												</tr>
											</c:forEach>
