...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Generate Gradesheet from Service Request Numbers(For MBA - X)</legend></div>
			...
			<div class="col-md-6 column">
				...
				<div class="form-group">
					<label class="control-label" for="submit"></label>
						...
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="generateMarksheetFromSRForMBAX">Generate</button>
