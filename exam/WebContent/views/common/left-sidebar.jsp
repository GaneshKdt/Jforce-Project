...
<%@page import="com.nmims.beans.LeadExamBean"%>
...
StudentExamBean studentInSideBar = (StudentExamBean)session.getAttribute("studentExam");
...
<style>
 ...
 <jsp:include page="toolTipCss.jsp"></jsp:include>
<script>
	function notifyLead() {
	  alert("Please enroll for the complete course...");
	}
</script>
<div class="sz-main-navigation">
        ...
        <ul class="sz-nav">
         <%if("No".equals(validityExpired)  && !programWithdrawal) {%>
          <li id="toggle-nav"><a href="#"><span class="icon-arrow-right"></span></a></li>
          	...
          	<%if("true".equals(isLead)){%>          
				<li id="ListwithToltip" tooltip="Dashboard" flow="right" class="<%=dashboardMenuClass%>">
	          		<a href="/studentportal/leadHome"><span class="icon-dashboard"></span>
           	...
           	<% }else {%>
	          	 ...
	          	 <li id="ListwithToltip" tooltip="Dashboard" flow="right" class="<%=dashboardMenuClass%>">
	          	 	<a href="/studentportal/home"><span class="icon-dashboard"></span>
	            			<p class="toggle-name" style="display: none;">Dashboard</p>
	           		</a>
	          	</li>
          ...
          <li id="ListwithToltip" tooltip="Academic Calendar" flow="right" class="<%=academicCalendarMenuClass%>"> <a href="/acads/student/viewStudentTimeTable"><span class="fa-regular fa-calendar-days"></span>
            <p class="toggle-name" style="display: none;">Academic Calendar</p>
            </a></li>
          <li id="ListwithToltip" tooltip="My Courses" flow="right" class="<%=myCoursesMenuClass%>"> <a href="/studentportal/student/viewCourseHomePage"><span class="fa-solid fa-book-bookmark"></span>
         ...
         <li id="ListwithToltip" tooltip="Session Videos" flow="right"  class=""> 
          	<a href="/acads/student/videosHome?pageNo=1&academicCycle=All">
          		<span>
          ...
          <li class="has-sub-menu <%=examMenuClass%>"> 
			...
			<ul class="sz-sub-menu">
			 ...
			 <%} %>
			  ...
			  <%
						if ("BBA".equals(studentInSideBar.getProgram())
											|| "B.Com".equals(studentInSideBar.getProgram())
											|| "BBA-BA".equals(studentInSideBar.getProgram())
											|| "CBA".equals(studentInSideBar.getProgram())
											|| "CGM".equals(studentInSideBar.getProgram())) {
					%>
