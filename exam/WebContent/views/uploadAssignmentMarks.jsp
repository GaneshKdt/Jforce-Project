...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Upload Student Assignment Marks</legend></div>
			
				<%@ include file="messages.jsp"%>
				<%@ include file="uploadExcelErrorMessages.jsp"%>
				<form:form modelAttribute="fileBean" method="post"
					enctype="multipart/form-data" action="uploadAssignmentMarks">
					<div class="row">
					...
					<div class="form-group">
						...
						formaction="uploadAssignmentMarks">Upload</button>
					</div>
					</div>
					
					<div class="col-md-12 column">
						<b>Format of Upload: </b><br>
						Student No | Student Name | Program | Subject | Assignment Score
						<br>
					</div>
			</div>
