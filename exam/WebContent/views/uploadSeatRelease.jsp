...
<jsp:include page="jscss.jsp">
	<jsp:param value="Upload Seat Release Excel" name="title" />
</jsp:include>
...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			...
			<div class="row"><legend>Upload Seat Release Excel</legend></div>
			
				<%@ include file="messages.jsp"%>
				<%@ include file="uploadExcelErrorMessages.jsp"%>
				<form:form modelAttribute="fileBean" method="post"
					enctype="multipart/form-data" action="uploadSeatRelease">
					...
					<div class="form-group">
						...
						formaction="uploadSeatRelease">Upload to Release</button>
					</div>
					</div>
					
					<div class="col-md-12 column">
						<b>Format of Upload: </b><br>
						<br>Student No | Subject (First Row should contain Header)
					</div>
			</div>
