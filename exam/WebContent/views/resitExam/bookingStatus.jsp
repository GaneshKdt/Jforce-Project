				...
				<div class="row">
					...
					<div class="form-group">
						...
						<div class="controls">
							...
							<button id="cancel" name="cancel" class="btn btn-danger" formaction="/studentportal/home" formnovalidate="formnovalidate">Back to Home</button>
...
<html lang="en">
	...
	<jsp:param value="Exam Booking Summary" name="title"/>
    </jsp:include>
                    ...
                    <div class="sz-main-content-inner">
              				...
              				<div class="sz-content-wrapper examsPage">
              						...
              						<div class="sz-content">
										...
										<h2 class="red text-capitalize">Exam Booking Summary</h2>
