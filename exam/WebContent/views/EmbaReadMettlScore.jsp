...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
	...
	<jsp:param value="Emba Pull and Insert Mettl Scores" name="title"/>
    </jsp:include>
   ...
   <%@ include file="header.jsp"%>
	<section class="content-container">
		<div class="container-fluid customTheme">
			...
			<div class="row">
				<legend> Emba Pull and Insert Mettl Scores</legend>
			</div>
			...
			<%@ include file="messages.jsp"%>
											...
											<form:form  method="post" modelAttribute="mettlResponseBean">
													<div class="panel-body">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="sel1">Select Batch:</label>
																 	<select name="batchId" id="batches" class="form-control" itemValue="${resultBean.batchId}" required>
														...
														<div class="checkbox">
														    <label>
														      <input type="checkbox" name="resultProcessed" style=" width: auto; height: auto; "> Pull Mettl Scores For Result Process
														    </label>
														</div>
															...
															<div class="col-md-4 ">
																...
																<div class="form-group">
																	<button id="submit" name="submit" class="btn btn-large btn-primary"
																			formaction="readMettlMarksFromAPI">Retrive Mettl Scores</button>
																</div>		
															</div>
