...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <div class="row"><legend>Allocate Assignment Evaluation: Level 3</legend></div>
		...
		<h2>&nbsp;Level 3 Allocation : (${numberOfSubjects } submissions eligible for Level 3 Evaluation)
		<br/>
		<font size="2px">
			<a href="downloadLevel3EligibleEvaluations">Download Report of Level 3 Eligible Evaluations</a>
		</font>
