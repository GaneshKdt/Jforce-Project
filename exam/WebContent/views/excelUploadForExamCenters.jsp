	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
				...
				<form:form modelAttribute="fileBean" method="post" 	enctype="multipart/form-data" action="mapping">
					...
					<div class="form-group">
						<button id="submit" name="submit" class="btn btn-large btn-primary"
							formaction="excelUploadForExamCenters">Upload</button>
					</div>
			...
			<b>Format of Exam Center Upload: </b><br>
			  Exam Center Name |  City | State | Capacity |  Address | Mode | Locality | Google Map URL<br>
			<a href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_EXAM_STATIC_RESOURCES')" />resources_2015/templates/exam_center_upload_template.xlsx" target="_blank">Download a Sample Template for Exam Centers</a>
