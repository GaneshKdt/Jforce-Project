...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
	...
	<jsp:param value="Pass Fail Process" name="title"/>
    </jsp:include>
    <head>
	...
	<section class="content-container">
		<div class="container-fluid customTheme">
			...
			<div class="row">
				<legend>Transfer To Pass Fail </legend>
			</div>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<button class="btn btn-large btn-primary"
							formaction="transferDissertationToPassFail" id="submit"
							name="submit">Run Pass Fail</button>
						<a class="btn btn-large btn-primary"  href= "dissertationQ7ExamResultCheckList" type="button">Cancel</a>
					</div>
					<c:if test="${transferPassFailCount > 0 }">
