...
<jsp:param value="Initiate Refund" name="title" />
</jsp:include>
...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
		...
		<form  action="queryFeesPaid" method="post" >
			<fieldset>
			<div class="col-md-6 column">
				...
				<div class="form-group">
					...
					<div class="controls">
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="queryFeesPaid">Get Transactions</button>
		...
		<div class="row">
			...
			<div class="table-responsive">
				...
				<tr>
		            ...
		            <td> 
		            <c:url value="refundExamFees" var="refundExamFees">
					  <c:param name="trackId" value="<%=trakId %>" />
					</c:url>
					
					<%//if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("TEE Admin") != -1){
						if("Authorized".equalsIgnoreCase(transactionType) && "Processed".equalsIgnoreCase(status)){%>
					<a class="glyphicon glyphicon-info-sign" href="${refundExamFees}" title="Initiate Refund" onClick="return confirm('Are you sure you want to refund this amount?')"></a>
					<%} %>
