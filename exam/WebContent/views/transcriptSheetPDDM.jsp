...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container login">
		...
		<form:form  action="getPDDMTranscript" method="post" modelAttribute="student">
			<fieldset>
		...
		<div class="col-md-6 column">
					...
					<div class="form-group">
						<label class="control-label" for="submit"></label>
							<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="getPDDMTranscript">Generate</button>
