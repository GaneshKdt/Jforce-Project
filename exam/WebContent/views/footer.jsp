...
<div class="container-fluid footerWrapper" style="padding-bottom:10px;">
        <footer>
...
<script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_EXAM_STATIC_RESOURCES')" />resources_2015/js/datatable.js"></script>
