...
<%@ include file="header.jsp"%>
    ...
    <section class="content-container">
       ...
       <div class="row"> <legend>Download Normalized Scores</legend></div>
		...
		<form:form  action="downloadNormalizedScore" method="post" modelAttribute="searchBean">
			...
			<div class="col-md-9 column">
					...
					<div class="form-group">
						...
						<button id="submit" name="submit" class="btn btn-sm btn-primary" formaction="downloadNormalizedScore">Download Normalized Score</button>
