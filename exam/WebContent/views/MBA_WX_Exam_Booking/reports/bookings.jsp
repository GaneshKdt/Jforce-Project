...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			<fieldset class="row"><legend>MBA-WX Exam Bookings Report</legend></fieldset>
			...
			<form:form modelAttribute="searchBean" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-6 column">
						<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="examBookingReport_MBAWX">
							Search
						</button>
					</div>
				</div>
			...
			<c:if test = "${ showDownloadButton }">
				<a href = "downloadExamBookingReport_MBAWX" id="download" name="download" class="btn btn-large btn-primary">
