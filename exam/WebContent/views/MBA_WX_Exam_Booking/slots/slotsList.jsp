...
<jsp:include page="../../jscss.jsp">
	<jsp:param value="Upload MBA-WX Slot list" name="title" />
</jsp:include>
<head>
...
<body class="inside">
	...
	<section class="content-container login">
		<div class="container-fluid customTheme">
			<fieldset class="row"><legend>Upload MBA-WX Slots list </legend></fieldset>
										...
										<c:forEach var="slot" items="${slotsList}">
											<tr>
												...
												<td>
													...
													<a href="updateSlotForm_MBAWX?slotId=${slot.slotId}" style="color:#c72127;" >
														Update
													</a>
												</td>
											</tr>
	...
	<script>
		...
		$(document).ready( function () {
			...
			$(document).on('click',".deleteSlotFromList",function(){
				...
				$.ajax({
					url:"deleteSlot_MBAWX?slotId=" + slotId,
					method:"POST",
					success:function(response){
						if(response.status == "success"){
							alert(response.message);
							window.location.href = "slotsList_MBAWX";
						}else{
							alert(response.message);
						}
					},
			...
			$(document).on('click',".toggleSlotActive",function(){
				...
				$.ajax({
					url:"toggleSlotActive_MBAWX?slotId=" + slotId + "&active=" + active,
					method:"POST",
					success:function(response){
						if(response.status == "success"){
							alert(response.message);
