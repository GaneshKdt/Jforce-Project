    ...
    $.fn.Tabledit = function(options) {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;margin-left:-120px;">\n\
        ...
        function ajax(action)
        {
            ...
            for (var i = 0; i < serialize.length; i++){
                returnArray[serialize[i]['name']] = serialize[i]['value'];
              }
            serialize = returnArray
