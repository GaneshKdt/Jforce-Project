							...
							<div class="col-md-18 column">
								...
								<div id="reScheduleSession" style="display:none;">
									   ...
									   <div class="form-group">
										...
										<button id="submit" name="submit" class="btn btn-large btn-primary" formaction="reScheduleSession">Re-Schedule Session</button>
								...
								<div class="form-group" id="reScheduleSessions" style="display:block;">
									...
									<button id="reSheduleSession" name="reSheduleSession" type="button" class="btn btn-large btn-primary">Re-Schedule Session</button>
