...
<%@page import="java.util.Map"%>
 ...
 <%
 	...
 	if(session.getAttribute("student_careerservices") != null){
 		csActiveInSidebar = ((StudentCareerservicesBean) session.getAttribute("student_careerservices")).isPurchasedOtherPackages();
 	}
 ...
 %>
	<li id="csSidebarIcon" class="has-sub-menu"> 
		<a href="/careerservices/home?resetSessions=true"><span
				class="fa fa-briefcase icon"></span>
			<p>Career Services</p>
		</a>
		<ul class="sz-sub-menu">
			...
			<li>
				<% if(careerCounsellingAccess){ %> 
					<a href="/careerservices/careerCounselling">
			...
			<li>
				<% if(practiceInterviewAccess){ %>
					<a href="/careerservices/practiceInterview">
						<p>Practice Interview</p>
					</a>
				<% }else{ %>
					<a>
						<p style="color: #b9b9b9;">Practice Interview</p>
					</a> 
				<% } %>
			</li>
			<li>
