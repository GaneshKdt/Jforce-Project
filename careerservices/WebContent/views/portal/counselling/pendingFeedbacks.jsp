						...
						<table id="pendingFeedbacksTable" class="table table-hover center">
							<thead class="">
								<tr class="border">
									...
									<th class="border " scope="col" style="text-align: center;">Counselling
										Date</th>
								...
								<c:forEach items="${pendingFeedbacks}" var="pendingFeedback">
									<tr>
										...
										<td style="text-align: center;"><a
											...
											href="counsellingFeedbackForm?facultyId=${ userId }&counsellingId=${ pendingFeedback.counsellingId }"
