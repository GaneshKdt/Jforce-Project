				...
				<div class="sz-content-wrapper">
					...
					<div class="sz-content" id="page-content">
						<div class="sz-content pt-3">
							...
							<h2 class="header pt-3 pl-3">Counselling Feedback</h2>
							<div class="clearfix"></div>
							<div class="row">
								<div class="col-xl-9 col-md-12 col-sm-12 my-3">
									<div class="p-2">
										<p style="font-size: 1rem;" id="pageDescription">Feedback for the counselling held on ${ counselling.date } is provided below.</p>
									</div>
											...
											<div class="row">
												<div class="col-3 text-center border-right">
													...
													<p style="font-size: 1.0rem;">
														<span id="totalActivations">${ counsellingDetails.totalActivations }</span>
													</p>
												</div>
												<div class="col-3 text-center border-right">
													<h4>Remaining</h4>
													<p style="font-size: 1.0rem;">
														<span id="activationsLeft">${ counsellingDetails.activationsLeft }</span>
													</p>
												</div>
												<div class="col-3 text-center border-right">
													<h4>Available</h4>
													<p style="font-size: 1.0rem;">
														<span id="activationsPossible">${ counsellingDetails.activationsLeft }</span>
													</p>
												</div>
