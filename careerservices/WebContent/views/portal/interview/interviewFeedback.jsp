...
<jsp:include page="/views/common/header.jsp" />
    ...
    <section class="content-container login">
		...
		<form:form  action="interviewFeedback" method="post" modelAttribute="interviewFeeds">
				...
				<div class="row" > 
					<div class="col-lg-6 column">
						<button id="submit" name="submit" class="btn btn-large btn-primary"
							formaction="interviewFeedback?facultyId=${ userId }&interviewId=${ param.interviewId }" style="margin: 10px;">Submit</button>
					</div>
				</div>
			</div> 
		</form:form>
