...
<li class="has-sub-menu"><a href="#">Career Services</a>
	<ul class="sz-sub-menu subMenu">
		...
		%>
		<li><a href="/careerservices/autoScheduleForm">Generate
				Schedule/Zoom</a></li>
		<%
			}
		%>
	...
	<li class="has-sub-menu"><a href="#">Career Counselling</a>
		<ul class="sz-sub-menu subMenu">
			<%
			...
			<li><a href="/careerservices/uploadCounsellingDetailsForm">Upload
					Counselling Details </a></li>
			<li><a href="/careerservices/counsellingFeedback">Counselling Feedback </a></li>
			<%
				}
			%>
		</ul>
	...
	<ul class="sz-sub-menu subMenu">
		...
		<li><a href="/careerservices/interviewFeedback">Interview Feedback </a></li>
		<%
			}
		%>
	</ul></li>
