    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="">
        ...
        <ul class="topRightLinks list-inline">
          <li><a class="panel-toggler collapsed"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="true"></a></li>
        </ul>
        <div class="clearfix"></div>
      </div>
      <div id="collapseSeven" class="panel-collapse collapse in courses-panel-collapse" role="tabpanel" aria-labelledby="headingSeven">
        <div class="panel-body">
          
          <div class="p-closed">
              <div class="no-data-wrapper">
              <p class="no-data"><span class="icon-quick-links"></span>4 Quick Links</p> 
              </div>
          </div>
          <ul>
            <li><a href="/exam/selectSubjectsForm">Register for Exam</a></li>
            <%-- <%if("Online".equalsIgnoreCase((StudentBean)session.getAttribute("student_careerservices").)){ %>
