...
public abstract class BaseDAO {
	...
	private List<ExamOrderStudentPortalBean> liveFlagList = null;
	...
	public List<ExamOrderStudentPortalBean> getLiveFlagDetails( boolean refresh){
		...
		if(this.liveFlagList == null || this.liveFlagList.size() == 0 || refresh == true){
			...
			this.liveFlagList = (ArrayList<ExamOrderStudentPortalBean>)jdbcTemplate.query(sql,new BeanPropertyRowMapper<ExamOrderStudentPortalBean>(ExamOrderStudentPortalBean.class));
