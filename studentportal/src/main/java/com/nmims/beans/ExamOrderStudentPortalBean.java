...
/**
 * old name - ExamOrderBean
 * @author
 *
 */
public class ExamOrderStudentPortalBean implements Serializable {
	...
	public String toString() {
		return "ExamOrderStudentPortalBean [acadMonth=" + acadMonth + ", month=" + month
				+ ", year=" + year + ", order=" + order + ", acadContentLive="
				+ acadContentLive + "]";
	}
