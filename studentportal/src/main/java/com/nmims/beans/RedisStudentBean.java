...
public class RedisStudentBean extends BaseStudentPortalBean implements Serializable, Comparable<RedisStudentBean> {
...
public String getLeadId() {
	...
	public String toString() {
		return "StudentStudentPortalBean [sapid=" + sapid + ", sem=" + sem + ", lastName="
