...
/**
 * old name - AnnouncementBean
 * @author
 *
 */
public class AnnouncementStudentPortalBean extends BaseStudentPortalBean implements Serializable{
	
	public AnnouncementStudentPortalBean() {
		super();
	}
	private String id;
	...
	//Added for mention notification
