...
/**
 * old name - ExamBookingTransactionBean
 * @author
 *
 */
public class ExamBookingTransactionStudentPortalBean extends BaseStudentPortalBean implements Serializable{
    ...
    private String examReportingTime;
	...
	public String getExamReportingTime() {
		return examReportingTime;
	}
	public void setExamReportingTime(String examReportingTime) {
		this.examReportingTime = examReportingTime;
	}
