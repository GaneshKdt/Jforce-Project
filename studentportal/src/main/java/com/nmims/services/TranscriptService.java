...
public class TranscriptService implements TranscriptServiceInterface{
	...
	public ServiceRequestStudentPortal createServiceRequest(ServiceRequestStudentPortal sr) {
		...
		int numberOfMarkEntries = serviceRequestDao.getNumberOfMarkEntriesMBAWX(student.getSapid());
