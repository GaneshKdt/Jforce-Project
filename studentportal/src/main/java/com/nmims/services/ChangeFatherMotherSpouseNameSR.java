...
@Service
public class ChangeFatherMotherSpouseNameSR extends ServiceRequestAbstract {
	private static final ServiceRequestTypeEnum SERVICE_REQUEST_TYPE = ServiceRequestTypeEnum.CHANGE_FATHER_MOTHER_SPOUSE_NAME;
	...
	@Autowired
	public ChangeFatherMotherSpouseNameSR(ServiceRequestRepository serviceRequestRepository, MailSender mailSender, AWSHelper awsHelper) {
...
//			ex.printStackTrace();
	...
	public void sendSuccessfulSrRequestMail(ServiceRequestStudentPortal serviceRequest, String studentSapid,
		...
		mailSender.sendSRConfirmationEmail(serviceRequest.getId(), serviceRequest.getServiceRequestType(), serviceRequest.getDescription(), 
											Integer.valueOf(serviceRequest.getAmount()), additionalConfirmationContent, 
											Long.valueOf(studentSapid), studentFirstName, studentLastName, studentEmailId);
	}
