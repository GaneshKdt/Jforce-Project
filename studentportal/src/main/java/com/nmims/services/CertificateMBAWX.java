...
@Service("certificateMBAWX")
public class CertificateMBAWX implements CertificateInterface {
	...
	@Autowired 
	private CheckFinalCertificateEligibilityMBAWX checkFinalCertificateEligibility;
