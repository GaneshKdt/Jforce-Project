...
@Service("transcriptServiceMBAX")
public class TranscriptServiceMBAX implements TranscriptServiceInterface{
	...
	public ServiceRequestStudentPortal checkEligibility(ServiceRequestStudentPortal sr) {
		...
		int numberOfMarkEntries = serviceRequestDao.getNumberOfMarkEntriesMBAX(student.getSapid());
