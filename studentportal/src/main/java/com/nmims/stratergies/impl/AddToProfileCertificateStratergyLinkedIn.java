...
@Service("addToProfileCertificateStratergyLinkedIn")
public class AddToProfileCertificateStratergyLinkedIn implements AddToProfileCertificateStratergyInterface {
	...
	public ServiceRequestStudentPortal shareCertificate(ServiceRequestStudentPortal sr) {
		...
		headers.add("Accept", "application/json");
			...
			LinkedInAddCertToProfileBean linkedInBean = restTemplate.postForObject( SERVER_PATH + "exam/m/getSingleStudentCertificateMBAWX", entity ,LinkedInAddCertToProfileBean.class);
