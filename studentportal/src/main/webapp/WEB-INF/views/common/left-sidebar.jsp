...
String diableLink = "", color = "", notify="", lastCycleContentLink = "/studentportal/lastCycleContent";
...
<style>
 ...
 <jsp:include page="../common/toolTipCss.jsp"></jsp:include>
<script>
	function notifyLead() {
...
<div class="sz-main-navigation">
        <div class="mobile-logo visible-xs"><a href="#"><img src="assets/images/logo.png" class="img-responsive" alt=""/></a></div>
        <ul class="sz-nav">
         <%if("No".equals(validityExpired)) {%>
          <li id="toggle-nav"><a href="#"><span class="icon-arrow-right"></span></a></li>
          <li id="ListwithToltip" tooltip="Dashboard" flow="right" class="<%=dashboardMenuClass%>"><a href="/studentportal/home"><span class="icon-dashboard"></span>
            <p class="toggle-name" style="display: none;">Dashboard</p>
            </a></li>
			            
            <%if(isLead.equals("true")){%>
           	<li id="ListwithToltip" tooltip="Get Certified" flow="right"  class="<%=myGetCertifiedMenuClass%>"> 
          ...
          <li id="ListwithToltip" tooltip="Academic Calendar" flow="right" class="<%=academicCalendarMenuClass%>"> <a href="/acads/viewStudentTimeTable"><span class="icon-academic-calendar"></span>
            <p class="toggle-name" style="display: none;">Academic Calendar</p>
            </a></li>
          <li id="ListwithToltip" tooltip="My Courses" flow="right" class="<%=myCoursesMenuClass%>"> <a href="/studentportal/viewCourseHomePage"><span class="icon-my-courses"></span>
...
<%--            <% }%> --%>
           ...
           if("PD - DM".equals(studentInSideBar.getProgram())){%>
              ...
              <li id="ListwithToltip" tooltip="E-Learn" flow="right" class=""> 
            ...
            <p class="toggle-name" style="display: none;">E-Learn</p>
          	...
          	<%}%>
         <li id="ListwithToltip" tooltip="Session Videos" flow="right" class=""> 
          	<a href="/acads/videosHomeNew?pageNo=1&academicCycle=${currentSessionCycle}">
          		<span>
          			<i class="fa fa-play-circle-o" aria-hidden="true"></i>
          		</span>
		...
		<li id="ListwithToltip" tooltip="Bookmarks" flow="right" class="<%=bookmarksMenuClass%>"><a
			href="/studentportal/bookmarks"> <span> <i
		...
		%>
          ...
          <li class="has-sub-menu <%=examMenuClass%>"> 
			...
			<%} else {%>
			  	...
			  	<a class="<%= diableLink %>" href="/exam/previewHallTicket">
					<p style="<%= color %>">Hall Ticket</p>
				</a>
			<%} %>
			</li>
			...
			<%if(!"MPDV".equals(studentInSideBar.getProgram()) || "EPBM".equals(studentInSideBar.getProgram())){%>
				<li  class="<%=examTranscriptMenuClass%>">
					<a class="<%= diableLink %>" href="/exam/generateStudentSelfTranscriptForm">
		...
		<%if(!("MPDV".equals(studentInSideBar.getProgram()) || "EPBM".equals(studentInSideBar.getProgram()))){%>
			...
			<%if((studentInSideBar.getProgram().startsWith("PG") || studentInSideBar.getConsumerType().equalsIgnoreCase("Diageo"))){ %>
				<li class="<%=examProjetSubmissionMenuClass%>">
				  	<a class="<%= diableLink %>" href="/exam/viewProject?subject=Project">
			...
			<%} else if((studentInSideBar.getProgram().equalsIgnoreCase("PD - WM") && studentInSideBar.getConsumerType().equalsIgnoreCase("Retail"))) {%>
				...
				<li class="<%=examProjetSubmissionMenuClass%>">
				  	<a class="<%= diableLink %>" href="/exam/viewProject?subject=Module 4 - Project">
						<p style="<%= color %>">Project Submission</p>
					</a>
				</li>  
			<% } %>
		...
		<%} %>	
			...
			<%if(!lsCon.checkLead(request, response)){ %>
				<%@include file="/WEB-INF/views/common/CSStudentSidebar.jsp"%>
			<%} %>
            ...
            <ul class="sz-sub-menu">
             ...
             <%if(studentInSideBar.getAlmashinesId()!=null ){ %>
                <li id="ListwithToltip" tooltip="NGASCE Alumni Portal" flow="right" class="<%=almashinesClass%>"> <a href="welcomeToAlmashines"><span class="icon-quick-links"></span>
	            <pclass="toggle-name" style="display: none;" >NGASCE Alumni Portal</p>
	            </a>
                </li> 
            <%} %>
            <%if("Yes".equals(validityExpired)) {%>
	          <li class="has-sub-menu <%=examMenuClass%>"> 
               ...
               <ul class="sz-sub-menu">
               	<li class="<%=quickLinksMyDocuments%>"> <a class="<%= diableLink %>" href="/exam/myDocuments">
    ...
    <!--              My Badges Start -->
            <% if(!"MBA - WX".equals(studentInSideBar.getProgram()) && !"MBA - X".equals(studentInSideBar.getProgram()) 
            	...
            	<li id="ListwithToltip" tooltip="My Badges" flow="right" class="has-sub-menu">
		            <a href="/studentportal/myBadges" >
		          <span class="fa fa-trophy"></span>
	                <p class="toggle-name" style="display: none;">My Badges</p></a> 
                </li>
            <% } %>
<!--             My Badges End -->
           ...
           <li class="has-sub-menu <%=quickLinksMenuClass%>"> <a href="#"><span class="icon-quick-links"></span>
            <p id="ListwithToltip" tooltip="Dashboard" flow="right">Quick Links</p>
            </a>
            <ul class="sz-sub-menu">
              ...
              <li class="<%=quickLinksPCPRegistrationMenuClass%>"> 
              	<a class="<%= diableLink %>" href="/acads/selectPCPSubjectsForm">
            ...
            <li class="<%=quickLinksUFMDashboardMenuClass%>"> 
              	<a class="<%= diableLink %>" href="/exam/ufmStatus">
           ...
           <%if("MPDV".equals(studentInSideBar.getProgram()) || "EPBM".equals(studentInSideBar.getProgram())){%>
			...
			<%}else{%>
				<a class="<%= diableLink %>" href="/exam/printBookingStatus">
					<p style="<%= color %>">Exam Fee Receipt</p>
				</a>
			<%} %>
                </li>
              ...
              <li class="<%=quickLinksPCPFeeReceiptMenuClass%>"> 
              	<a class="<%= diableLink %>" href="/acads/downloadPCPRegistrationReceipt">
             ...
             <%} %>
               <li class="<%=quickLinksRegistrationFeeReceipt%>"> <a class="<%= diableLink %>" href="/studentportal/viewFeeReceipt">
                ...
                <p style="<%= color %>">My Documents</p>
                  ...
                  <li class="<%=quickLinkAnnouncementArchival%>"> <a class="<%= diableLink %>" href="/studentportal/getAllStudentAnnouncements">
              ...
              <li class="<%=quickLinksChangePasswordMenuClass%>"> 
              	<a class="<%= diableLink %>" href="/acads/keyEvents">
