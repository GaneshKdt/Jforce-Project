...
<jsp:include page="common/jscss.jsp">
	<jsp:param value="Adhoc Online Payment" name="title" />
</jsp:include>
<body>
			...
			<div class="sz-main-content-inner">
				...
				<div class="sz-content-wrapper examsPage">
					...
					<div class="sz-content">
						...
						<h2 class="red text-capitalize">Adhoc Payment Summary</h2>
									...
									<div class="panel-body">
										<div class="col-md-12 column">
											...
											<div class="form-group">
												...
												<p>${adhocPaymentBean.paymentType}created successfully.
												</p>
											</div>
											...
											<div class="form-group">
												...
												<div class="controls">
													...
													class="btn btn-large btn-primary" formaction="adhocPaymentForm">OK</button>-->
