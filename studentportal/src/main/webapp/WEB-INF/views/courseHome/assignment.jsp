...
%>
<c:url value="viewSingleAssignment" var="assignmentSubmissionUrl">
	...
	<div class=" panel-courses-page">
		...
		<h2> Assignments &nbsp;&nbsp; <span class="pull-right red">
			<%if(!"BBA".equalsIgnoreCase(student.getProgram()) && !"B.Com".equalsIgnoreCase(student.getProgram())){ %>
				...
				href="https://studentzone-ngasce.nmims.edu/acads/watchVideos?id=4588">Streaming Link</a>)
			<% } %>
		</span>
		</h2>
			<!---TOP TABS-->
		...
		<div id="collapseTwo"
			...
			<div id="collapseTwo"
				...
				<div class="panel-body">
					...
					<div class="no-data-wrapper">
						<p class="no-data">
							<span class="icon-my-courses"></span>No Assignments Scheduled for
							<%=assignmentSubject %></p>
					</div>
					<%}else{ 
								...
								<div class="col-lg-7">
									<div class="row">
										<ul class="extra-assignment-action ">
											<li><a href="/exam/modelAnswers" target="_blank" class="<%= disable %>"><span
													class="icon-icon-pdf"></span>Download Model Answers</a></li>
											<li><a class="<%= disable %>"
												href="/exam/resources_2015/InternalAssignmentPreparationGuidelines.pdf"
												target="_blank"><span class="icon-icon-pdf" class="<%= disable %>"></span>Download
											...
											<li><a class="<%= disable %>" href="/exam/viewPreviousAssignments"><span
													class="icon-icon-pdf"></span>View all Session Submission</a></li>
											<div class="clearfix"></div>
										</ul>
									</div>
								</div>
											...
											<div class="row full-height">
												<div class="assignment-action borderRight">
													...
													<a target="_blank" class="<%= disable %>"
														href="/exam/downloadStudentAssignmentFile?filePath=<%=assignment.getFilePath()%>&subject=<%=assignmentSubject%>"><span
														class="icon-icon-download-file"></span>Download Question
														File</a>
											...
											<div class="row full-height">
												<div class="assignment-action">
													<a href="/exam/${assignmentSubmissionUrl }" class="<%= disable %>"><span
														class="icon-icon-upload-file"></span>Upload Assignment</a>
												</div>
											</div>
										</div>
									</div>
