				 ...
				 --%>
							...
							<div class="no-data-wrapper">
								...
								<h6 class="no-data nodata">
									<span class="icon-academic-calendar"></span>No queries raised
									by you
								</h6>
							</div>
...
<div class="menu pmd-floating-action" role="navigation"
	...
	<a href="javascript:void(0);" data-toggle="modal"
		...
		onMouseOver="this.style.color='white';" data-title="Ask Faculty">
...
<div id="askFaculty" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Ask Faculty</h4>
			</div>
			<div class="modal-body">
						...
						<fieldset>
							...
							<div class="form-group">
								<form:textarea path="query" id="query" maxlength="500"
									...
									placeholder="Please note that only Course Content and/or Session related queries have to be posted in Post Query section which will be replied within 48 working hours. Enter query here..."
									cols="50" rows="3" />
							</div>
