...
<html lang="en">
	...
	<link href="assets/css/resource-card.css" rel="stylesheet">  
    <style>
	   .whitebg {
												         ...
												         %> 
																<div class="mt-3 col-xl-4 col-lg-3 col-md-6 col-sm-6 col-12 "> 
																	<div class="sessionplan-resourcecard card">
																		<a data-subject="<%=subject%>" class="encodedHref">     
																		...
																		<div class="text-dark pt-0 pb-0 sessionplan-card-body card-body">
																			<div class="pt-3 row">
																				<div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 " >  
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="session">
																						<i class="material-icons sessionplan-icon">play_circle_outline</i></br>      
																						<span> Session</span>
																					</a> 
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="assign">
																						<i class="material-icons sessionplan-icon">assessment</i></br>
																						<span>Assessment</span>
																					</a>
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="qna">
																						<i class="material-icons sessionplan-icon">help</i></br>
																						<span> Q&amp;A</span> 
																					</a>
																				</div> 
																				<div class="col-xl-5 col-lg-5 col-md-6 col-sm-6 ">  
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="resource">
																						<i class="material-icons sessionplan-icon">library_books</i> </br>
																						<span>Resources</span> 
																					</a>
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="result">
																						<i class="material-icons sessionplan-icon">assignment</i></br>   
																						<span>Results</span> 
																					</a>
																					
																					<a class="btnn font12 hoverblue encodedHref" data-subject="<%=subject%>" data-param="forum">
