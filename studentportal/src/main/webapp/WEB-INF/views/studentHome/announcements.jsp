...
ArrayList<AnnouncementStudentPortalBean> announcements = (ArrayList<AnnouncementStudentPortalBean>)session.getAttribute("announcements");
		...
		<div class="panel-heading" role="tab" id="">
			...
			<ul class="topRightLinks list-inline">
				<li><a href="#" data-toggle="modal"
					data-target="#announcementModalAll">SEE ALL</a></li>
				<!-- <li><a href="/studentportal/getAllAnnouncementDetails" >SEE ALL</a></li> -->

				<li><a class="panel-toggler collapsed" role="button"
					data-toggle="collapse" data-parent="#accordion"
					href="#collapseFive" aria-expanded="true"></a></li>
			</ul>
			<div class="clearfix"></div>
		</div>
		<div id="collapseFive"
			class="panel-collapse collapse <%=collapseAnnouncementsSection %> courses-panel-collapse"
			...
			<div class="panel-body">
				...
				<div class="no-data-wrapper no-border">
					<p class="no-data">
						</span>There are No Active Announcements
					</p>
				</div>
				<%}else{ %>
				...
				<section class="col-md-12 p-closed announcement-collapse">
					<div class="no-data-wrapper no-border">
						<p class="no-data">
							</span>Expand section to see Announcements
						</p>
					</div>
				</section>
          ...
          %>
				<a href="#" data-toggle="modal" data-dismiss="modal"
					data-target="#announcementModal<%=anouncemntCount%>"><section
						class="col-md-4">
						<h6><%=announcement.getSubject() %></h6>
						<p><%=announcemntBrief %></p>
						<h4 class="small"><%=formattedDateString%>
							<span>by</span> <a href="#" onclick="return false;"
								style="cursor: default;"><%=announcement.getCategory() %></a>
						</h4>
					</section></a>
...
<div class="modal fade announcement"
	id="announcementModal<%=countInModal%>" tabindex="-1" role="dialog">
