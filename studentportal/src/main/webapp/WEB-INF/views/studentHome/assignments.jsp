...
<%
	...
	ArrayList<AssignmentStudentPortalFileBean> allAssignmentFilesList = (ArrayList<AssignmentStudentPortalFileBean>)session.getAttribute("allAssignmentFilesList_studentportal");
...
<!-- 					<span class="icon-my-courses"></span>No Assignment Found! -->
						<span class="icon-my-courses"></span>
						<a href="/exam/viewAssignmentsForm">View Assignments</a>
					</p>
				</div>
		...
		%>
				...
				<section class="<%=assignmentStatusClass%>" style="<%= leadAssignment %>">
					<h4>
						<a href="<spring:eval expression="@propertyConfigurer.getProperty('SERVER_PATH')" />exam/viewAssignmentsForm"><%=assignment.getSubject() %>
	...
	<div class="modal-dialog" role="document">
		...
		%>
				...
				<section class="<%=assignmentStatusClass%>">
					<a
						href="<spring:eval expression="@propertyConfigurer.getProperty('SERVER_PATH')" />exam/viewAssignmentsForm"><h4><%=assignment.getSubject() %>
							<span>semester <%=assignment.getSem() %></span>
						</h4></a>
					<h5><%=status %></h5>
