...
<body class="inside">
	<%
	ArrayList<ModuleContentStudentPortalBean> moduleList = (ArrayList<ModuleContentStudentPortalBean>)request.getAttribute("moduleContentsList");
		...
		<div class="container-fluid customTheme">
			...
			<div class="panel-body">
				...
				<div class="sz-content">
					<h2 class="red text-capitalize">Edit Module Content</h2>
					...
					<div class="container-fluid "
						...
						<div class="row">
							<div class=" col-md-5">
								<form:form action="saveModuleContents" method="post"
									modelAttribute="moduleContent">
									<fieldset>
										<form:hidden path="id" value="${moduleContent.id}" />
										<div class="clearfix"></div>
										<div class="form-group">
											<label for="subject">Subject </label>
											<form:input path="subject" value="${moduleContent.subject}"
										...
										<div class="form-group">
											...
											<form:input path="moduleName"
												value="${moduleContent.moduleName}" required="required"
										...
										<div class="form-group">
											...
											<form:textarea path="description" id="description"
												...
												placeholder="Add description for the Module Content..."
												cols="50" />
										</div>
										<div class="form-group">
											<form:select id="active" path="active" type="text"
												placeholder="Month" class="form-control"
												itemValue="${moduleContent.active}">
										...
										<div class=" form-group controls">
											<button id="submit" name="submit"
												...
												formaction="saveModuleContents">Save</button>
										</div>
								...
								<div class="well">
									<a
										href="/studentportal/editModuleVideoContents?moduleId=${moduleContent.id}"
										class="btn btn-default"> Module to Video Topic Mapping </a>
								</div>
							</div>
							...
							<div class=" col-md-7">
								...
								<div class="well">
									...
									<form:form modelAttribute="fileBean" method="post"
										enctype="multipart/form-data" action="uploadModulesPdf">
										...
										<div class="panel-body">
											<div class="col-md-6 column">
												...
												<div class="form-group">
													...
													<form:input path="fileName" required="required"
											...
											<c:forEach var="document" items="${moduleDocumnentList}">
												<div class="panel panel-default">
															...
															<div class="col-sm-11" style="">
																<h4 class="panel-title">
																	<a data-toggle="collapse" data-parent="#accordion"
																		href="#collapse${document.id}"> > &nbsp;
																		${document.documentName} </a>
																</h4>
															</div>
															<div class="col-sm-1" style="">
																<a
																	href="/studentportal/deleteModuleDocument?id=${document.id}"
													...
													<div id="collapse${document.id}"
														...
														<div class="panel-body">
															<form:form action="sMD" method="post"
																modelAttribute="moduleDocument">
																<fieldset>
																	<form:hidden path="id" value="${document.id }" />
																	<div class="clearfix"></div>
																	<div class="form-group">
																		<label for="moduleId">Module ID </label>
																		<form:input path="moduleId"
																			value="${document.moduleId}" required="required"
																	...
																	<div class="form-group">
																		...
																		<form:input path="documentName"
																			value="${document.documentName}" required="required"
																			placeholder="Document Title"
																			style="color:black; padding:6px 12px; width:100%;" />
																	</div>

																	<div class="form-group">
																		<label for="folderPath"> Document Folder Path
																		</label>
																		<form:input path="folderPath"
																			value="${document.folderPath}" required="required"
																	...
																	<div class="form-group">
																		...
																		<form:input path="type" value="${document.type}"
																			required="required" placeholder="Document Type"
																			style="color:black; padding:6px 12px; width:100%;" />
																	</div>
																	<div class="form-group">
																		<label for="noOfPages"> No Of Pages </label>
																		<form:input path="noOfPages"
																			value="${document.noOfPages}" required="required"
																			placeholder="Add noOfPages"
																			style="color:black; padding:6px 12px; width:100%;" />
																	</div>
																	<div class=" form-group controls">
																		<button id="submit" name="submit"
																			class="btn btn-large btn-primary" formaction="sMD">Save</button>
																	</div>
