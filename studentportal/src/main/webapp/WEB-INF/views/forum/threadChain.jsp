									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="post-sub" data-toggle="modal"
												...
												<div class="col-sm-9">
												<div class="flex">
												<div class=""><img src="assets/images/admin.png" width="35px" style="border-radius: 50%;">&nbsp&nbsp
												</div >
												<div class="">
											...
											<c:forEach items="${forumBean.threadReplies}" var="reply"
												...
												<div class="post-sub" id="demo">
													...
													<div class="pull-right">
														<a href="#"
															onClick="window.open('/studentportal/postLevel2ReplyForm?parentReplyId=${reply.id }', 'Post Reply', 'width=800px,height=300px');"><i class="fa fa-reply" aria-hidden="true"></i> Reply</a>
														<%if(roles.indexOf("Acads Admin") != -1 || roles.indexOf("Faculty") != -1){%>
														| <a
															href="/studentportal/deleteForumReply?replyId=${reply.id}&parentPostId=${reply.parentPostId}">Delete</a>
														<%}%>
														<c:if test="${reply.createdBy == userId}">
												   		| <a href="#"
																onClick="window.open('/studentportal/editReplyForm?id=${reply.id}', 'Edit Reply', 'width=800px,height=300px');">Edit</a>
														</c:if>
														| <a href="#"
																onClick="window.open('/studentportal/FlagForumReply?id=${reply.id}', 'Edit Reply', 'width=800px,height=300px');">
													  		<i class="fa fa-flag"  aria-hidden="true"></i>
														  </a>
														
														| <a href="/studentportal/reportAbuse?id=${reply.id}"
														...
														<div style="margin-left: 60px; margin-top: 7px;"
															...
															<div class="collapse" id="collapseExample${reply.id}">
															  	<c:forEach items="${reply.threadReplies}"
																	...
																	<div class="pull-right">
																		<a href="#"
																			onClick="window.open('/studentportal/postLevel2ReplyForm?parentReplyId=${level2Reply.parentReplyId }', 'Post Reply', 'width=800px,height=300px');"><i class="fa fa-reply" aria-hidden="true"></i> Reply</a>
																		<%if(roles.indexOf("Acads Admin") != -1 ){%>
																		| <a
																			href="/studentportal/deleteForumReply?replyId=${level2Reply.id}">Delete</a>
																		<%}%>
																		<c:if test="${level2Reply.createdBy == userId}">
																		| <a href="#"
																				onClick="window.open('/studentportal/editReplyForm?id=${level2Reply.id }', 'Edit Reply', 'width=800px,height=300px');">Edit</a>
																		</c:if>
																		| <a href="#"
																			onClick="window.open('/studentportal/FlagForumReply?id=${reply.id}', 'Edit Reply', 'width=800px,height=300px');">
																			<i class="fa fa-flag" aria-hidden="true"></i>
																		...
																		<a
																			href="/studentportal/reportAbuse?id=${level2Reply.id}&isLevel2Reply=true"
																			onClick="return confirm('Are you sure you want to report this reply as Abuse?')">Report
																			Abuse</a>
																	</div>
																	<%}%>
