		              					...
		              					<div class="row">
											<div class="col-lg-4 no-padding-right">
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<h4 class="panel-title">
															<h5 data-toggle="collapse" href="#collapse1">Level 1: Acad Coordinator at the University Regional Office </h5>
														</h4>
													</div>
													<div id="collapse1" class="panel-collapse collapse">
														<div class="panel-body">
															<p>You can contact our Acad Coordinator along with the SR&nbsp;Number (the unique number you get when you register your service request with NGASCE)</p>
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<h4 class="panel-title">
															<h5 data-toggle="collapse" href="#collapse2">Level 2: Regional Head at the University Regional Office</h5>
														</h4>
													</div>
													<div id="collapse2" class="panel-collapse collapse">
														<div class="panel-body">
															<p>To escalate further, you can contact the Regional Head along with the SR Number (the unique number you get when you register your service request with NGASCE)</p>
															...
															<table class="table table-bordered table-hover escalationtwo">
																<tbody>
																	...
																	<tr style="display: none;">
																		<td>Bangalore</td>
																		<td>Dipak Mohanty</td>
																		<td><a href="mailto:DipakKumar.Mohanty@nmims.edu">DipakKumar.Mohanty@nmims.edu</a></td>
																		<td>+91 80 4085 5537</td>
																	</tr>
											...
											<div class="col-lg-4">
													...
													<div class="panel-content-wrapper">
														<form role="form">
															...
															<div class="form-group">
																<label for="email" class="text-uppercase">Local Contact Details</label>
											...
											<div class="col-lg-4 no-padding-left">
												...
												<div class="panel-content-wrapper">
													<form role="form">
														...
														<div class="form-group">
															<label for="email" class="text-uppercase">Locate Local Centre</label>
															...
															<div class="address-list-container">
																<label for="question" class="text-uppercase">LOCAL OFFICE ADDRESS</label>
