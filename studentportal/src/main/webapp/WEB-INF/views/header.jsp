		...
		<div id="navbar" class="navbar-collapse collapse">
			<div class="col-md-18 no-padding">
				...
				<ul class="headerLinks">
					...
					<li><a href="#">Exam</a>
						<ul class="subMenu">
							...
							<li><a href="/exam/viewProject?subject=Project">Project
									Submission</a> <%} %>
						</ul></li>
					...
					<li><a href="#">Academics</a>
						<ul class="subMenu">
							...
							<li><a href="/acads/viewApplicableSubjectsForm">Learning
									Resources</a></li>
							<li><a href="/studentportal/gotoEZProxy" target="_blank">Digital
									Library</a></li>
							<li><a href="/acads/selectPCPSubjectsForm">PCP/VC
									Registration</a></li>
							<li><a href="/acads/downloadPCPRegistrationReceipt">PCP/VC
					...
					<li><a href="#">General</a>
						<ul class="subMenu">
							...
							<li><a href="http://ngasce.desk.com">Student Support
									System</a></li>
						</ul></li>

					<li><a href="/studentportal/changePassword">Change
							Password</a></li>
				...
				<ul class="headerLinks">
					...
					<jsp:include page="/WEB-INF/views/studentPortalHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>

					<jsp:include page="/WEB-INF/views/examHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>

					<jsp:include page="/WEB-INF/views/acadsHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>
					<li><a href="/studentportal/changeUserPassword"
						title="Change Password"><i class="fa fa-key fa-lg"></i></a></li>
					<li><a href="/studentportal/updateProfile"
						title="Update Profile"><i class="fa fa-user fa-lg"></i></a></li>
					<li><a href="/studentportal/logout" title="Logout"><i
	...
	<div class="rightHeadWrapper">
		...
		<div class="userContainer">
			<div class="userImg">
				...
				<%}else{ %>
				<img src="resources_2015/images/userImg.jpg" alt="Student Photo"
			...
			<div class="detailWrapper">
				...
				<p>
					...
					<%=program %></p>
				<p>
					<a href="/studentportal/updateProfile" style="color: white"><%=userEmail%>/<%=userMobile %></a>
				</p>
			</div>
		</div>
