								...
								<fieldset>
									...
									<div class="row">
										<div class="col-md-8 column">
											...
											<div class="form-group">
												<label>Please Upload Photo</label> <input type="file"
													name="changeInPhotographDoc" required="required"
													class="form-control">
											</div>


											<div class="form-group">
												<label>Please Upload Photo ID for verification</label> <input
													type="file" name="changeInPhotographProofDoc"
