                    ...
                    <div class="sz-main-content-inner">
						...
						<div class="clearfix"></div>
							...
							<div style="width: 60%">
								...
								<img src="assets/images/linkedInAddToProfile.png" height=35px
								...
								<img src="assets/images/linkedin-share-button.png" height=35px
						    ...
						    <div class="preview" >
								<a id="preveiwCert" class="btn btn-large btn-danger"  data-toggle="modal" data-target="#previewCertificate"  >Preview Final Certificate</a>
							</div>
							...
							<div class="form-group col-md-6">
									...
									<a id="backToSR" name="BacktoNewServiceRequest" class="btn btn-danger"
...
$('#saveForFreeButton').click(function(){
	...
	$.ajax({
		url : '/studentportal/CheckFinalCertificateCount?sapId=${ usersapId }&requestType=Issuance of Final Certificate&isFreeRequest=true',
		type:'POST',
		success:function(response){
			console.log('success response : ' + response.status);
			if(response.status == "500"){
...
<script>
	function callShareCertificate(){		
		...
		console.log(body);
		$.ajax({
			url : '/studentportal/m/addCredentialLinkedIn',
			type : 'POST',
			data : JSON.stringify(body),
			contentType: "application/json",
	        dataType : "json",
	...
	function shareCertificate(){		
		...
		console.log(body);
		$.ajax({
			url : '/studentportal/m/shareCertificateLinkedIn',
			type : 'POST',
			data : JSON.stringify(body),
			contentType: "application/json",
	        dataType : "json",
