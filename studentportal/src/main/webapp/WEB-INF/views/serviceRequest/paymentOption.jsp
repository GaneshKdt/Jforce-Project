		  ...
		  success: function(response){
			  try{
				  ...
				  for(var i=0;i < response.length;i++){
					  htmlData = htmlData + '<div class="col-xs-3"> <img style="height:120px;" class="img-responsive" src="assets/images/' + response[i].image +'" /> <center> <a data-paymentGateway="'+ response[i].name +'" class="btn btn-large btn-primary submitButton selectPaymentGateway"> '+ response[i].name +' </a> </center> </div>';
				  }
