...
color:black!important;
    ...
    <body>
											...
											<tr><td><label>Semester Cleared Marksheets: </label> </td> </tr>    
												    ...
												    <tr>
														...
														<td>
															...
															<div class="form-group" id='loader' style='display: none;'>
															  <img src='resources_2015/gifs/loading.gif' width='90px' height='90px'>
															</div>
															<!-- Image loader -->
														</td>
													</tr>
											  ...
											  <div id="dialog" class = "modal hide" style="display:none;"></div>
												...
												<div class="form-group">
													...
													style="width:15px;height:15px;margin:5px;"/><span> &nbsp;I want my Marksheet at my address (Shipping Charges INR. 100/-)</span>
													</label>
												</div>
												<div class="form-group">
													<label>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-exclamation-triangle fa-lg"></i> Alert: You are issuing a marksheet for the same semester,year and month</h4>
		      </div>
		 ...
		 <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabe2">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-exclamation-triangle fa-lg"></i> Marksheet Marks Preview</h4> 
		      </div>
		      <div class="modal-body">
		...
		$("document").ready(function() {
			...
			document.getElementById("addressConfirmation").value="NO";
			var semesters = new Array("1", "2", "3","4");//Assign array of semester//
		...
		function generateMarksheetPreview(thisElement){
			...
			var examMonth = $(thisElement).closest("tr").find(".month").val();
				...
				$.ajax({
	                type: "POST",
	                url: '/exam/generateMarksheetPreviewFromSR',
