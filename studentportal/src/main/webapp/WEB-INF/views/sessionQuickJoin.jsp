			...
			<div class="container">
				...
				<div class="panel-content-wrapper">
					<%@ include file="common/messages.jsp"%>
									...
									<tbody>
										<c:forEach items="${sessionList }" var="session">
											<tr>
												...
												<td><c:out value="${session.startTime }"></c:out></td>
												<td><button type="button" id="sessionId" class="btn btn-primary" 
														onClick = "viewSession(${session.id});">Join Session</button></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
						...
						<a class="btn btn-primary" title="goHome" onClick="goToPortal();" >Go To Home</a>
				</div>
				</div>
...
// 				alert('sessionIds '+sessionIds)
				document.getElementById("sessionFrame").src="/acads/viewScheduledSession?id="+sessionId
			}
