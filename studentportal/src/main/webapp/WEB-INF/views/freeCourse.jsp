											...
											<div class="panel-content-wrapper course-list">
												<div class="row">
													...
													<div class="col-md-3 col-lg-2">
														<a class="btn btn-link card-button" href="student/getProgramSubjectList?id=${program.consumerProgramStructureId }">
															Continue
														</a>
													...
													<span class="d-md">
														<c:choose>
															<c:when test="${ program.certificate.certificateType == 'participation' }">
																<img class="certified-stamp" src="assets/images/participated.png" />
															</c:when>
															<c:otherwise>
																<img class="certified-stamp" src="assets/images/certified.png"/>
															</c:otherwise>
														</c:choose>
													</span>
													<div class="col-md-9 col-lg-10">
