			...
			<div class="demo-wrapper">
				...
				<div class="dashboard clearfix">
					...
					<ul class="tiles">
						...
						<div class="clearfix col-md-6 col-sm-9 padding-small">
							<!--col1-->
							<a href="/acads/viewApplicableSubjectsForm">
                                    ...
                                    %>
											<tr>
												...
												<td><p style="line-height: 20px;">
														<a
															href="/exam/viewSingleAssignment?year=<%=currentExamYear%>&month=<%=currentExamMonth%>&subject=<%=URLEncoder.encode(assignment.getSubject(), "UTF-8")%>">Submit</a>
													</p></td>
											</tr>
											<%} %>
										...
										<p class="viewAllBtn">
											<a href="/exam/viewAssignmentsForm">VIEW ALL</a>
										</p>
									</div>
							</li>
							</a>
