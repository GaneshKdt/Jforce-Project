		...
		<div class="sz-breadcrumb-wrapper">
			<div class="container-fluid">
				<ul class="sz-breadcrumbs">
					...
					<li><a href="/studentportal/viewCourseHomePage">My Courses</a></li>
					<li><a
						href="/studentportal/viewCourseHomePage?subject=${moduleContentBean.subject}">${moduleContentBean.subject}</a></li>
												...
												<c:forEach var="document" items="${moduleDocumnentList}"
													...
													<li class="moduleLi" style="height: 35px;"><a
														...
														style="margin: 0px; padding: 0px; width: 21px; bottom: 50px; left: 90%;"><i
															class="fa fa-download large" style="font-size: 20px;"></i></a>
