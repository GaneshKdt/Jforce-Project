...
<li class="has-sub-menu"><a href="#">Career Services</a>
	<ul class="sz-sub-menu subMenu">
		...
		<li><a href="/jobsearch/hiringCompanies" style="font-weight: 700; font-size: 16px; text-align: start;">Hiring Companies</a></li>
		<li><a href="/jobsearch/jobs" style="font-weight: 700; font-size: 16px; text-align: start;">Jobs</a></li>
