...
<div class="student-info-bar">
	<div class="mobile-menu visible-xs">
		<div class="row">
			...
			<div class="col-xs-8 text-right">
				<a href="/studentportal/student/updateProfile"><span
					class="icon-my-profile"></span></a> <a href="/logout"><span
	...
	<%-- <span class="student-image"
		style="background-image:url(<%=studentPhotoUrl%>);"></span> --%>	<!-- Commented to avoid twice page reload, if studentPhotoUrl value null/empty -->
