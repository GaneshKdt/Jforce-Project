...
%>
			...
			<%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1){ %>
                <li class="has-sub-menu">
                      ...
                      <ul class="sz-sub-menu">
	                    ...
	                    <!-- <li><a href="/exam/assignmentQpCreation">Allocate Faculty for QP</a></li> -->
	                    ...
	                    <li><a href="/exam/admin/webCopyCaseCheckForm">Originality Check</a></li>
	                    <li><a href="/exam/admin/getWebCopyCaseReportForm">Originality Analysis</a></li>
 ...
 -->
           ...
           <%if(roles.indexOf("Faculty") != -1 || roles.indexOf("Insofe") != -1 ){ %>
                 <li class="has-sub-menu">
                      ...
                      <ul class="sz-sub-menu">
                      	...
                      	<li><a href="/acads/admin/viewVivaSlots">View Viva</a></li>
                      </ul>
				</li>
				<li><a href="/exam/admin/facultyAssignmentUpload">Upload Assignment QP</a></li>
               	<li>
					  	<a href="#">Queries for Me</a>
					  	<ul class="sz-sub-menu">

                      	<li><a href="/acads/admin/assignedCourseQueries">Course Queries</a></li>

                      	<li><a href="/acads/admin/gotoFacultySessionList">Live Zoom session Queries</a></li>
                      </ul>
                </li>
               <%} %>
                ...
                <%if( roles.indexOf("Faculty") != -1 || roles.indexOf("Insofe") != -1 ){ %>
                <li class="menu">
                  	<a href="/acads/admin/updateFacultyProfileForm"  title="My Profile"><i class="fa-solid fa-user fa-lg" ></i></a>
           </li>
               <%}%>
			...
			<%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("TEE Admin") != -1){ %>
                 <li class="has-sub-menu">
					...
					<li class="has-sub-menu">
                  		<a href="/exam/admin/ufmCheckListForm">UFM</a>
                 	</li>
               <%} %>
         <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("TEE Admin") != -1 || roles.indexOf("Assignment Admin") != -1){ %>
                 <li class="has-sub-menu">
         ...
         <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("TEE Admin") != -1){ %>
                 <li class="has-sub-menu">
                      ...
                      <ul class="sz-sub-menu">
						...
						<li><a href="/exam/admin/getGraceEligibleForm">Grace</a></li>
						<li><a href="/exam/admin/makeResultsLiveForm">Make Results Live</a></li>
						<li><a href="/exam/admin/marksheetForm">Marksheet</a></li>
						<li><a href="/exam/admin/singleStudentMarksheetForm">Single Marksheet</a></li>
						<li><a href="/exam/admin/marksheetFromSRForm">Marksheet from SR</a></li>
						<li><a href="/exam/admin/generateNonGradedMarksheetFromSRForm">Non-Graded Marksheet from SR</a></li>
						<li><a href="/exam/admin/marksheetFromSRFormForMBAWX">Gradesheet from SR For MBA-WX</a></li>
						<li><a href="/exam/admin/marksheetFromSRFormForMBAX">Gradesheet from SR For MBA-X</a></li>
						<li><a href="/exam/admin/certificateFromSRForm">Certificate From SR</a></li>
						<li><a href="/exam/admin/mbawxCertificateFromSRForm">Mbawx Certificate From SR</a></li>
						<li><a href="/exam/admin/singleStudentCertificateForm">Single Certificate</a></li>
						<li><a href="/exam/admin/downloadExecutiveMarksheetForm">Executive Bulk Marksheet</a></li>
                     	<li><a href="/exam/admin/executiveCertificatesForBatchForm">Executive Bulk Certificates </a></li>
						<li><a href="/exam/admin/certificateFromSapIdForm">Certificate From SapId</a></li>
						<li><a href="/exam/admin/bulkTranscriptForm">Bulk Transcript Generation</a></li>
						<li><a href="/exam/admin/transcriptForm">Transcript</a></li>
						<li><a href="/exam/admin/transcriptFormMBAWX">Transcript - MBA WX</a></li>
						<li><a href="/exam/admin/transcriptFormMBAX">Transcript - MBA X</a></li>
                      </ul>
				</li>
               ...
               <%} %>
				...
				<li class="has-sub-menu">
					...
					<ul class="sz-sub-menu">
						...
						%>
								<%if(!"academic.admin".equalsIgnoreCase((String)session.getAttribute("userId"))){ %>
							<li><a href="/exam/admin/uploadCentersForm_MBAWX">Upload Centers</a></li>
							  <%} %>
		                    <li><a href="/exam/admin/uploadTimeTableForm_MBAWX">Upload TimeTable</a></li>
		                    <li><a href="/exam/admin/slotsList_MBAWX">View Slots</a></li>
		                    	<%if(!"academic.admin".equalsIgnoreCase((String)session.getAttribute("userId"))){ %>
							<li><a href="/exam/admin/examCenterCapacityReportForm_MBAWX">Center Capacity Report</a></li>
							  <%} %>
							<li><a href="/exam/admin/uploadLiveSettingsForm_MBAWX">Live Settings</a></li>
							<li><a href="/exam/admin/getExtendExamForTimeboundStudentForm">Extend Exam Registration DateTime</a></li>
						<% 
							}
							if(isAdmin || isFinance) {
						%>
							<li><a href="/exam/admin/examBookingReportForm_MBAWX">Exam Booking Report</a></li>
							<li><a href="/exam/admin/reExamEligibilityReportForm">Re-Exam Eligible Students Report</a></li>
							<li><a href="/exam/admin/queryTransactionStatusFormMBAWX">Query Transaction</a></li>
						<% 
							}
						%>
					</ul>
                   ...
                   <a href="#">Exam Reg MBA-X</a>
                      <ul class="sz-sub-menu">
	                      ...
	                      <li><a href="/exam/admin/uploadCentersForm_MBAX">Upload Centers</a></li>
	                        <%} %>
	                      <li><a href="/exam/admin/uploadTimeTableForm_MBAX">Upload TimeTable</a></li>
	                      ...
	                      <li><a href="/exam/admin/uploadLiveSettingsForm_MBAX">Live Settings</a></li>
	                      <li><a href="/exam/admin/examBookingReportForm_MBAX">Download Exam Bookings</a></li> 
	                       <%if(!"academic.admin".equalsIgnoreCase((String)session.getAttribute("userId"))){%>
	                      <li><a href="/exam/admin/examCenterCapacityReportForm_MBAX">Exam Center Available Capacity</a></li> 
	                      <%} %>  
						  <li><a href="/exam/admin/reExamEligibilityReportForm">Re-Exam Eligible Students Report</a></li>
         			  </ul>
      			 </li>
                ...
                <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1 || roles.indexOf("TEE Admin") != -1 || roles.indexOf("Read Admin") != -1){ %>
                 <li class="has-sub-menu">
                   ...
                   <ul class="sz-sub-menu">
	                      ...
	                      <li><a href="/exam/admin/liveSettingMBAX">Search Test</a>
         			  </ul>
                  	...
                  	<a href="#" title="Search"><i class="fa-solid fa-magnifying-glass" ></i></a>
	                    <ul class="sz-sub-menu">
							...
							<li><a href="/exam/admin/searchStudentBatchMappingForm">Search Student Batch Mapping</a>
	           				...
	           				<li><a href="/studentportal/admin/getWaivedInSubjectsReportForm">Search WaivedIn Subjects </a> 
						</ul>
					</li>
		...
		<%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1 || roles.indexOf("Acads Admin") != -1){ %>
         ...
         || roles.indexOf("Consultant") != -1 || roles.indexOf("Finance") != -1 || roles.indexOf("Student Support") != -1  ){ %>
                <li class="has-sub-menu"> 
                      ...
                      <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1 || roles.indexOf("TEE Admin") != -1 || roles.indexOf("Read Admin") != -1
                     	 ...
                     	 <li><a href="/studentportal/admin/syncPassedSemList">Salesforce Exam Report</a></li>
                     	 <li><a href="/studentportal/admin/schedulerApisDashboard">Scheduler Apis Dashboard</a></li>
                     	 <li><a href="/exam/admin/demoExamDashBoard">Demo Exam Dashboard</a></li>
						 <li><a href="/exam/admin/downloadDemoExamReport">Download Demo Exam Report</a></li>
                     	 <li><a href="/exam/admin/getFinalCertificateABCreportForm">ABC Report For Final Certificate </a></li>
                     <%}else if(roles.indexOf("Student Support") != -1) { %>
                       	 <li><a href="/exam/admin/reportHome">Exam Reports</a></li>
					 <% } %>  
<!-- ======= -->
...
<!--                      	 <li><a href="/exam/admin/demoExamDashBoard">Demo Exam Dashboard</a></li> -->
<!-- 						 <li><a href="/exam/admin/demoExamDashBoard">Demo Exam Dashboard</a></li> -->
<!-- >>>>>>> 503278f060b66043fff03e14934a4f7a6eb6e786 -->
                      </ul>
				</li>
               <%} %>  
           ...
           <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1 || roles.indexOf("TEE Admin") != -1 || roles.indexOf("Read Admin") != -1){ %>
             ...
             <%if(roles.indexOf("Exam Admin") != -1 || roles.indexOf("Assignment Admin") != -1 || roles.indexOf("TEE Admin") != -1 || roles.indexOf("Read Admin") != -1){ %>
             <li class="has-sub-menu">
                  	<a href="#" title="MBA-X Internal Assessment">MBA-X IA <i class="fa-solid fa-flask fa-lg" aria-hidden="true"></i></a>
                      <ul class="sz-sub-menu">
                      	 <li><a href="/exam/mbax/ia/a/makeTestLiveForm">Make Tests Live</a></li>
                     	 <li><a href="/exam/mbax/ia/a/viewAllTests">Search Tests</a></li>
                     	 <li><a href="/exam/mbax/ia/a/searchIaToEvaluateForm">IA Evaluates Reports</a></li>
                     	 <li><a href="/exam/mbax/ia/admin/studentTestAuditTrailAnalysisForm">Student Test Audit Trail</a></li>
                     	 <li><a href="/exam/mbax/ia/admin/unfairMeansDetials">Lost Focus Details</a></li>
                      </ul>
				</li>
               <%} %>
               
               <!-- Block Center Sidebar Link -->
