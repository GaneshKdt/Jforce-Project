...
%>
	...
	<div class="container-fluid bg-white rounded">
			...
			<%if(!earlyAccess.equalsIgnoreCase("Yes")) { %>
			    <br>
						<select class=" form-select form-select-sm col-auto switchContent float-end">
			...
			<% } %>
							...
							<%if(noOfLearningResources == 0 && noOfVideoContents==0 && noOfContents==0 && noOflastCycleContent==0){ %>
								<div class="no-data-wrapper">
									<h6 class="no-data nodata fw-bold"> <span class="fa-solid fa-clone"></span>No new Learning Resources</h6>
								</div>
							<%}else{ %>
	...
	$(".bookmark").click(function() {
		...
		if ($(ref).data("selected") == "no") {
			...
			$.ajax({
				...
				url : "/studentportal/student/setBookmark", 
				data : JSON.stringify(data),
				success : function(data) {
					$(ref).find("i").removeClass("fa-regular fa-bookmark");
					$(ref).find("i").addClass("fa-solid fa-bookmark");
			...
			$.ajax({
				...
				data : JSON.stringify(data),
				success : function(data) {
					$(ref).find("i").addClass("fa-regular fa-bookmark");
					$(ref).find("i").removeClass("fa-solid fa-bookmar");
