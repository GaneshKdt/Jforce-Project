...
<body>
				...
				<div class="sz-content-wrapper dashBoard myCoursesPage">
					...
					<div class="sz-content">
						...
						<%}else{ 
							    				...
							    				selectedPSSId = (String)request.getAttribute("programSemSubjectId");
              									selectedSubject = (String)request.getAttribute("subject");
              									...
              									if(courseAssignmentsMap1!=null){
              										assignment1 = courseAssignmentsMap1.get(selectedPSSId);
              									}
							...
							<div class="select-wrapper custom">
								<select class="form-control" id="myCoursesList">
									...
									<c:forEach var="pssId" items="${programSemSubjectIdWithSubjects}">
										...
										<option value="${pssId.key }">${pssId.value }</option>
									</c:forEach> 
								</select>
							</div>
						</div>
	...
	<script>
				...
				$("#myCoursesList").val(decodeURIComponent("<%=selectedPSSId.trim()%>"));
				 ...
				 $(function(){
			      ...
			      $('#myCoursesList').on('change', function () {
			          //var subject = $(this).val(); // get selected value
			         // window.location = '/studentportal/viewCourseHomePage?subject='+encodeURIComponent(subject); // redirect
			          var programSemSubjectId = $(this).val(); // get selected value
			          console.log("programSemSubjectId -- in script"+programSemSubjectId);

			          window.location = '/studentportal/student/student/viewCourseHomePage?programSemSubjectId='+encodeURIComponent(programSemSubjectId); // redirect
