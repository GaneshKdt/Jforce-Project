			...
			<div class="panel-body" style="padding: 20px;"> 
				...
				<%if(numberOfForumThreads == 0){ %>
					<div class="no-data-wrapper">
						...
						<h6 class="no-data nodata"><span class="fa-solid fa-book-bookmark"></span>No Discussion Threads</h6> 
					</div>
							     ...
							     <span class="post-info"><h5><img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/images/admin.png" width="35px" style="border-radius: 50%;">&nbsp&nbsp&nbsp&nbsp<%=bean.getFacultyFullName() %></h5></span></td>
							      <td scope="row" >
							      	<span class="description" > 
								      	<a href="/studentportal/student/viewForumThreadChain?id=<%=bean.getId()%>&subject=<%=URLEncoder.encode(bean.getSubject(),"UTF-8")%>">
												<b><%=bean.getTitle()%></b>
										</a>
									</span>
								  </td>
