				...
				<table class="table table-striped " id="toollinks">
					...
					<tbody>
						<tr>
							...
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Steps to access Eminer_VLE.PDF"
						...
						<tr>
							...
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Accessing_SASEminer_software_AWS.pdf"
								target="_blank"> View/Download</a></td>
						</tr>
						<tr>
							<td>3</td>
					...
					<tbody>
						<tr>
							...
							<td>Step by step process to access visual analytics virtual
								learning environment</td>
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Steps to access Visual Analytics_VLE.PDF"
								target="_blank"> View/Download</a></td>
						</tr>
						<tr>
							<td>2</td>
							...
							<td>Step by step process to understand how a student can
								book slots on Amazon web services for working on data sets</td>
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Accessing_SAS_software_AWS.pdf"
								target="_blank"> View/Download</a></td>
						</tr>
						<tr>
							<td>3</td>
					...
					<tbody>
						<tr>
							...
							<td>Step by step process to access Enterprise Guide Server
								environment</td>
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Steps to access Eguide_Server.pdf"
								target="_blank"> View/Download</a></td>
						</tr>
						<tr>
							<td>2</td>
							...
							<td>Step by step Demo walk through before you start using
								your credentials</td>
							<td><a
								href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/sasPDF/Pre-Test for EGBS session.pdf"
								target="_blank"> View/Download</a></td>
						</tr>
