...
<html lang="en">
    ...
    <link href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/css/courses.css" rel="stylesheet"> 

        <!-- Custom CSS for fabButton -->
          <link type="text/css" href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/css/propellerButton.css" rel="stylesheet">
          <link type="text/css" href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/css/fabButton.css" rel="stylesheet">
				...
				$("#myCoursesList").val(decodeURIComponent("<%=selectedSubject.trim()%>"));
				 ...
				 $(function(){
			      ...
			      $('#myCoursesList').on('change', function () {
			          ...
			          window.location = '/studentportal/student/viewCourseHomePage?subject='+encodeURIComponent(subject); // redirect
			          return false;
			      });
			    });
			</script>
