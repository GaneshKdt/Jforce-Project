			...
			<div class="row">
				...
				<div class="col col-md-6">
					<div class="section-inner">
						...
						<h2 class="heading">
							<i class="fa-solid fa-pen-to-square"></i> My Assignments: <span
								style="font-size: 16px;">(Dec-2015)</span>
						</h2>

						<div class="info">
							<ul class="list-unstyled">
								<li><i class="fa-solid fa-pen-to-square"></i><a
									class="section-links" href="#">Management Theory and
										Practise</a></li>
								<li><i class="fa-solid fa-pen-to-square"></i><a
									class="section-links" href="#">Information System for
				...
				<div class="col col-md-6">
					<div class="section-inner">
						...
						<div class="info">
							<ul class="list-unstyled">
								<li><i class="fa-regular fa-envelope"></i><span class="sr-only">Email:</span><a
				...
				<div class="col col-md-6">
					<div class="section-inner">
						...
						<div class="info section-links">
							<ul class="list-unstyled">
								<li><i class="fa-regular fa-envelope"></i>2 Open Service Requests</li>
								<li><i class="fa-regular fa-envelope"></i>2 Closed Service
									Requests</li>
							</ul>
						</div>
