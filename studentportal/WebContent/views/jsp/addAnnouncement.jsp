...
<%@page import="com.nmims.beans.AnnouncementMasterBean"%>
					...
					<!-- div class="col-md-7 column form-group">
						...
						<%-- Commented by Riya as it was not needed
						   ...
						   <form:option value="All">Select Program</form:option>
							<form:option value="All">All</form:option>
							<form:options items = "${program}" />  --%>
							<form:input  id="program" path="program" readonly="true"
							type="text" placeholder="Program" class="form-control"
							required="required" itemValue="${announcement.program}"/>
...
<%
				 ...
				 <div class="form-group col-md-7 column">
						...
						<form:input id="programStructure" path="programStructure"
							type="text" placeholder="ProgramStructure" class="form-control" readonly="true"
							required="required" value="${announcement.programStructure}"/>
				...
				<div class="form-group">
					...
					<div class="controls">
						<%
							if ("true".equals((String) request.getAttribute("edit"))) {
								String announ_hist = (String)request.getAttribute("announ_hist");
							
						%>
						<input type='hidden' id='announ_hist' name='announ_hist' value='<%=announ_hist%>'/>
						
						<button id="submit" name="submit"
							class="btn btn-large btn-primary" formaction="updateAnnouncement">Update</button>
						<%
							}else if("true".equals((String) request.getAttribute("editAnnouncementProgram"))){
								String oldAnnouncementId = (String)request.getAttribute("announcementId");
					%>
							<input type='hidden' id='oldAnnouncementId' name='oldAnnouncementId' value='<%=oldAnnouncementId%>'/>
								<button id="submit" name="submit"
