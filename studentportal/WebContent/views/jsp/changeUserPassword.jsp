				...
				<div class="col-xs-18">
					<div class="panel-body">
						...
						<ul class="policy">
							...
							<li><i class="fa-solid fa-circle-right"></i> Passwords
								cannot contain the user's account name or parts of the user's
								full name that exceed two consecutive characters.</li>
							<li><i class="fa-solid fa-circle-right"></i> Passwords must
								be at least eight characters in length.</li>
							<li><i class="fa-solid fa-circle-right"></i> Passwords must
								contain characters from the following three
								categories:</li>
							<li><i class="fa-solid fa-circle-right"></i> English
								alphabet characters (A-Z/a-z)</li>
							<li><i class="fa-solid fa-circle-right"></i> Numbers (0-9)</li>
							<li><i class="fa-solid fa-circle-right"></i>
		...
		$(function() {
			$("#change-password").validate({
				rules: {
		  	    ...
		  	    messages: {
		  	    	password: {
		  	            pattern: "Entered Password does not match the Password policy."
		  	        }
		  	    }
		  	});
		});
