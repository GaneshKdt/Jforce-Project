...
<%
	String videos = (String)request.getSession().getAttribute("currentSessionCycle"); 
			...
			<div class="sz-breadcrumb-wrapper">
			    <div class="container-fluid">
			        <ul class="sz-breadcrumbs">
			        		...
			        		<li><a href="/acads/student/videosHome?pageNo=1&academicCycle=${videos}">Session Videos</a></li>
									...
									<div class="col-md-8">
										...
										<div class="panel-group" id="accordion" role="tablist"
											...
											<!-- 	<div class="panel-heading"
													...
													<c:choose>
													<c:when test="${faculty.isConsentForm eq 'Y'}"> 
												<!-- Card body -->
												<div id="101" class="panel-collapse">
													 <div class="form-group panel-body">
														<div class="col-md-4">
															<form:label for="imgUrl" path="imgUrl">Profile Picture : </form:label>
														</div>
														<div class="col-md-4">
															<img  src="https://studentzone-ngasce.nmims.edu/${faculty.imgUrl}"  width="250" height="250">
														</div>
													</div> 
													<%-- <div class="form-group panel-body">
														<div class="col-md-4">
													...
													<div class="form-group panel-body">
														...
														<div class="col-md-8">
															<form:label id="firstName" path="firstName">Prof. ${faculty.firstName}&nbsp;${faculty.lastName}</form:label> 
														</div>
													</div>
...
<!-- 													</div> -->
													...
													<div class="form-group panel-body">
														<div class="col-md-4">
															<form:label for="facultyDescription" path="facultyDescription">Faculty Description : </form:label>
														</div>
														<div class="col-md-8">
															<form:label id="facultyDescription" path="facultyDescription">${faculty.facultyDescription}</form:label>
														</div>
													</div> 
												...
												<c:otherwise>
													<div class="form-group panel-body">
														<div class="col-md-4">
															<form:label for="" path="">No Details to show </form:label>
														</div>
