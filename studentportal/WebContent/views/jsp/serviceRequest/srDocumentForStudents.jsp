											...
											<tbody>
												<c:forEach var="document" items="${documents}" varStatus="status">
													<tr>
														...
														<td>
															<c:choose>
																<c:when test = "${document.documentName eq 'Student medical proof for special need'}">
																...
																<a
																	href="<spring:eval expression="@propertyConfigurer.getProperty('SR_FILES_S3_PATH')" />${document.filePath}"><i
																...
																<c:otherwise>
																	<a href="downloadFile?filePath=${document.filePath}"><i
																		class="fa-solid fa-download fa-lg"></i></a>
																</c:otherwise>
															</c:choose>
														</td>
													</tr>
