			...
			<div class="sz-content-wrapper examsPage">
					...
					<div class="sz-content">
						...
						<div class="panel-content-wrapper">
							...
							<c:if test="${(sr.serviceRequestType == 'Issuance of Marksheet') || (sr.serviceRequestType == 'Issuance of Final Certificate') || (sr.serviceRequestType == 'Issuance of Transcript') }">
							<div class="alert alert-warning alert-dismissible">
								<button type="button" class="close" data-dismiss="alert"
									aria-hidden="true">&times;</button>
								In view of the recent restrictions imposed in the state of Maharashtra our team is working from home, this will impact TAT for the SR raised, as it requires someone to be physically present to print the documents.<br>We will try our best to close it on priority and make necessary provisions, for any concerns email <a href="mailto:ngasce@nmims.edu" target="_top">ngasce@nmims.edu</a>
							</div> 
							</c:if> 
											...
											<div class="form-group">
												...
												<div class="controls">
													<button id="submit" name="submit"
														...
														formaction="/studentportal/student/selectSRForm">OK</button>
													<!-- <button id="cancel" name="cancel" class="btn btn-danger"
													formaction="home" formnovalidate="formnovalidate">Cancel</button> -->
												</div>
											</div>
