									...
									<div class="row">
										<div class="col-md-12 column">
											...
											<div class="form-group mb-3">
												...
												class="fw-bold"	for="serviceRequestType">Service Request Type:</form:label>
											...
											<div class="md-2 mb-2 form-check">
												
													 <form:checkbox path="wantAtAddress"
													 class="form-check-input"
														value="Yes" id="addressConfirmation"
													 />
													 <form:label path="wantAtAddress" class="form-check-label fw-bold"
													for="addressConfirmation">I want Transcript at my address (Shipping Charges
														INR. 100/-)</form:label>
											</div>
											...
											<div class="form-group mb-2" id="shippingAddressDiv"
												style="display: none">
												...
												<div class="form-group">
													...
													<form:input type="text" class="form-control shippingFields"
														...
														onkeypress="return onlyAlphabets(event,this);" disabled="true"/>
											...
											<div class="form-group">
											<!-- data-bs-toggle="modal" data-bs-target="#paymentGatewayOptions" -->              
												<label class="control-label" for="submit"></label> 
												<a id="transcriptFeeAndShipping" name="submit" class="btn btn-large btn-danger" formaction="saveTranscriptRequest" style="display: none;">Save & Proceed to Payment</a>
												<a id="transcriptFee" name="submit" class="btn btn-large btn-danger" formaction="saveTranscriptRequest">Request Transcript</a> 
												<a id="backToSR" name="BacktoNewServiceRequest" class="btn btn-dark md-3" formaction="selectSRForm" formnovalidate="formnovalidate">Back to New Service Request</a>
												<br>
												...
												<br>
												<a class="btn  btn-danger" target="_blank" href="https://nmims.edu/application-for-e-transcript-delivery">Apply for WES</a>	
												<p><b>Note :- </b>Transcripts requested through the regular service request via the student zone will not be issued in stamped and sealed envelopes, as they are intended for personal use only.

If a student needs a transcript in a stamped and sealed envelope for reasons other than personal use, they must apply through the TrueCopy (WES) Service Request only.</p>	
...
$(document).ready(function(){
	...
	$("#transcriptFee").on('click',function(){
