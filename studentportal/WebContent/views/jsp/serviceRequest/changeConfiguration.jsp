...
<jsp:include page="../jscss.jsp">
	<jsp:param value="Set Dates for Various Service Request Configuration"
		name="title" />
</jsp:include>
...
<body class="inside">
	...
	<section class="content-container">
		...
		<div class="container-fluid customTheme">
			<div class="row">
				<legend>&nbsp;Set Dates for Service Request </legend>
			</div>
			<div class="panel-body">
				<%@ include file="../messages.jsp"%>
				<div class="col-md-6 column">
					<legend>&nbsp;Set Dates for Service Request </legend>
					<form:form action="makeResultsLive" method="post"
						modelAttribute="configuration">
						<fieldset>
							<div class="form-group">
								<form:select id="serviceRequestName" path="serviceRequestName"
									class="form-control"
									itemValue="${configuration.serviceRequestName}"
									required="required">
							...
							<div class="form-group">
								...
								<form:input path="startTime" id="startDate"
									type="datetime-local" />
							</div>
							...
							<div class="form-group">
								...
								<div class="controls">
									<button id="submit" name="submit"
										...
										formaction="changeConfiguration">Save Configuration</button>
				...
				<div class="col-md-11 column">
					...
					<table class="table table-striped" style="font-size: 12px">
						...
						<tbody>
							...
							<c:forEach var="conf" items="${currentConfList}"
								varStatus="status">
								<tr>
									<td><c:out value="${status.count}" /></td>
									<td nowrap="nowrap"><c:out
											value="${conf.serviceRequestName}" /></td>
