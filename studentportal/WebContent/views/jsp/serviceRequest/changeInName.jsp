...
<%@ include file="../header.jsp"%>
    ...
    <section class="content-container login">
        ...
        <form:form  action="saveChangeInName" method="post" modelAttribute="sr" enctype="multipart/form-data">
			<fieldset>
		...
		<div class="panel-body">
			...
			<div class="col-md-6 column">
				...
				<div class="form-group">
					...
					<input type="file" name="changeInNameDoc" required="required" class="form-control">
				</div>
				...
				<div class="form-group">
					...
					<div class="controls">
						<button id="submit" name="submit"
							class="btn btn-large btn-primary" formaction="saveChangeInName" onClick="return confirm('Are you sure you want to save this information?');">Save Service Request</button>
								...
								<fieldset>
									...
									<div class="row">
										<div class="col-md-8 column">
											...
											<div class="form-group">
												<label for="changeInNameDoc">Please Upload Photo Identity OR Marriage
													Certificate OR Affidavit</label> <input type="file" id="changeInNameDoc"
