		...
		<div class="sz-breadcrumb-wrapper">
   			<div class="container-fluid">
       			<ul class="sz-breadcrumbs">
	        		<li><a href="getFreeCoursesList">My Courses</a></li>
	        		<li><a href="getProgramSubjectList?id=${cpsId}">Subjects</a></li>
		        </ul>
          	</div>
        </div>
														...
														<div style="font-weight:bold;font-size:20px;float:right;color:rgba(0,0,0,0.5)">
															<c:choose>
																<c:when test="${ subjectBean.completed }">
																	<img src="${pageContext.request.contextPath}/assets/images/icons/certificate.PNG" style="max-width:25px;"/>
																</c:when>
																<c:when test="${ subjectBean.unlocked }">
											...
											<div class="panel-content-wrapper">
												...
												<div class="text-center">
													<div style="margin: auto;">
														<c:choose>
															<c:when test="${ subjectBean.completed }">
																<img src="${pageContext.request.contextPath}/assets/images/icons/certificate.PNG" style="max-width:30px;"/>
															</c:when>
															<c:otherwise>
																<img src="${pageContext.request.contextPath}/assets/images/certificate_black.PNG" style="max-width:30px;"/>
															</c:otherwise>
														</c:choose>
														<p>Program Certification Final Assessment</p>
														<c:if test="${ !subjectBean.unlocked }">
															<p>
																<img src="${pageContext.request.contextPath}/assets/images/lock_round.PNG" style="max-width:20px;" /> Complete all modules to give the final certification exam.
															</p>
														</c:if>
														<div class="col-md-12">
															<c:if test="${ subjectBean.quizAttemptsTaken > 0 }">
