...
<%
		...
		String announcementAppLogoutUrl = (String)pageContext.getAttribute("server_path") + "announcement/logoutforSSO";
	%>
...
<spring:eval expression="@propertyConfigurer.getProperty('SERVER_PATH')" var="server_path" />
<%-- <spring:eval expression="@propertyConfigurer.getProperty('WEB_RECAPTCHA_CLIENT_KEY')" var="web_recaptcha_client_key" /> --%>
				...
				<div class="container">
					<div class="contentMainWraper">
						...
						<div class="login-cont">
							...
							<form class="profileForm" id="loginSSOForm" action="${pageContext.request.contextPath}/login" method="post">
								<div class="form-group">
									<label for="name">USER NAME</label> 
									<input type="text" class="form-control" placeholder="Student Number" id="userId" name="userId">
								</div>
								...
								<!-- <div class="form-group cap-grp">
									<div class="g-recaptcha" data-sitekey="${web_recaptcha_client_key}"></div>
								</div> -->
								
								<button type="submit" id="loginBtn" class="btn btn-default logBtn">Login</button>
							</form>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel-content-wrapper latestNews">
									...
									<div class="clearfix"></div>
									<img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/images/overview.jpg" class="img-responsive" />
...
<!-- Added for SSO Login in acads app -->
	<script type="text/javascript">
	$('#loginSSOForm').submit(function() {
		$.ajax({
	         type: 'POST',
	         url: '/acads/login',
	         data: {
	...
	<script>
				...
				$( "#announcementApp" ).load( "<%=announcementAppLogoutUrl%>" );
			</script>
