		...
		<table class="table table-striped "  >
									...
									<tr>
										...
										<p style="line-height: 1.6" class="display_msg" ></p>
										 <br> 
										 <a class="view_details_button" style="display:none;">View Details<i class="fa-solid fa-angles-down" aria-hidden="true"></i></a>
										<a class="hide_details_button" style="display:none;">Hide Details<i class="fa-solid fa-angles-up" aria-hidden="true"></i></a>
...
<jsp:include page="footer.jsp" />
    ...
    <script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/js/vendor/dataTables.buttons.min.js"></script>
					...
					if(response.detailedMessage !=null && response.detailedMessage.length>0){
						...
						jQuery.each( response.detailedMessage, function( i, val ) {
							...
							if(typeof  arrayOfStrings[1]==="undefined" || val[val.length -1]=='0'){     
								display_detail_msg.append('<i class="fa-solid fa-angle-right" style="color: #c72127;"  aria-hidden="true"></i> '+val+'<br>'); 
							}else{
								display_detail_msg.append('<i class="fa-solid fa-angle-right" style="color: #c72127;"  aria-hidden="true"></i> '+arrayOfStrings[1]+' <a class="view_students" data="'+arrayOfStrings[0]+'"> view students</a><br>');	
							}    
						}); 
