	...
	<div class="panel panel-default">
		...
		<div id="collapseSeven"
			...
			<div class="panel-body">
				...
				<div class="p-closed">
					<div class="no-data-wrapper">
						<p class="no-data">
							<span class="fa-solid fa-link"></span>4 Quick Links
						</p>
					</div>
				</div>
				<ul>
            ...
            <%} %> --%>
					...
					<li><a href="/exam/student/previewHallTicket">Download Hall Ticket</a></li>
					<%}else{ %>
				...
				<!-- 	<li><a href="/exam/student/printBookingStatus">Exam Registration
							Receipt</a></li>
					<li><a href="/studentportal/student/viewFeeReceipt">Fee Receipt</a></li -->
					<li><a href="/studentportal/supportOverview">Support
							Overview</a></li>
					<li><a href="/exam/student/viewModelQuestionForm">Demo Exam</a></li>
					<li><a href="/studentportal/student/getDispatches">Dispatch Orders</a></li>
				</ul>
			</div>
		</div>
	</div>
