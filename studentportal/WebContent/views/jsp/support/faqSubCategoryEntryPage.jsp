...
<jsp:include page="../adminCommon/jscss.jsp">
	<jsp:param value="FAQ SubCategory Entry" name="title" />
</jsp:include>
...
<body>
	<%
	ArrayList<FaqSubCategoryBean> subcategorylist = (ArrayList<FaqSubCategoryBean>) request.getAttribute("subcategorylist");
	%>
	<%@ include file="../adminCommon/header.jsp"%>
	<div class="sz-main-content-wrapper">

		<jsp:include page="../adminCommon/breadcrum.jsp">
			<jsp:param value="Important Documents;FAQ SubCategory Entry"
				name="breadcrumItems" />
		</jsp:include>
						...
						<div class="common-content supportWrap">
							...
							<div class="row">
								<div class="col-lg-9 col-sm-6 col-xs-12">
									<h3 class="information-title red">Add SubCategory</h3>
								</div>
							...
							<div class="alert alert-danger" id="failalert">
								<strong>Failed!</strong> Please add New SubCategory In this Category.
							</div>
							<%
							}
							%>
							...
							<div class="panel-content-wrapper" style="min-height: 200px;">
								...
								<form action="addFaqSubCategoryEntry" method="post">
									...
									<div class="form-group">
										<label for="categoryname">Enter SubCategory</label> <input
											type="text" class="form-control is-invalid" id="subcategoryname"
							...
							<div class="panel-content-wrapper" style="min-height: 450px;">
								<div class="table-responsive">
									<table id="table_id"
										...
										<tbody>
											<%
											for (FaqSubCategoryBean subcategory : subcategorylist) {
											%>
											<tr id="<%=subcategory.getId()%>">
												<td style="text-align:center"><%=subcategory.getId()%></td>
							...
							onAjax : function(action, serialize) {
	                           ...
	                           console.log("action is "+action+" serialize is "+body)
								$.ajax({
									...
									success : function(response) {
										...
										if (response.status == "success") {
											...
											window.location.href = "faqSubCategoryEntryPage";
										} else {
								...
								if(action=='delete')
									...
									let prompt = confirm("Are you sure you want to delete? Once you deleted this SubCategory then all The FAQs related to this will get delete Automatically");
									if(!prompt){
										return false;
									}
									...
									setTimeout(()=>{
			                           ...
			                           console.log("action is "+action+" serialize is "+serialize.id)
										$.ajax({
											type : "POST",
											url : 'deletefaqsubcategory?id='+serialize.id,
											contentType : "application/json",
											dataType : "json",
											success : function(response) {
												console.log(response)
	    ...
	    function loadListOfCategories()
	    {
			...
			function validation() {
				...
				if (document.getElementById("category").value == ""
					...
					alert("Please select Category properly");
					return false;
				}
