				...
				<div class="col-md-18 column">
					<div id="tabs">
						<ul>
							...
							<li><a href="#tabs-3-1">Internal Assessment</a></li>
							...
							<div class="panel-group">
								<div class="panel panel-default">
									...
									<div id="collapseStudentReg" class="panel-collapse collapse">
										<c:if
											test="${fn:length(getAllRegistrationsFromSapIdForStudentDetailDashBoard) > 0}">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" href="#collapse1">Mark Records
												: <c:if test="${numberOfMarksSubjects gt 0 }">
						  				 	${numberOfMarksSubjects}
							  				 </c:if> <c:if test="${numberOfMarksSubjects eq 0}">
							  				 	 0
							  				 </c:if>
											</a>
										</h4>
											...
											<table class="table table-hover">
												...
												<tbody>
													<c:forEach var="marks" items="${markRecordsList}">
														<tr>
															<td><c:out value="${marks.examYear}" /></td>
															<td><c:out value="${marks.examMonth}" /></td>
															<td><c:out value="${marks.subject}" /></td>
															<td><c:out value="${marks.term}" /></td>
															<td><c:out value="${marks.teeScore}" /></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
												...
												<tbody>
													<c:forEach var="passFail" items="${passFailList}">
														<tr>
															...
															<td><c:out value="${passFail.term}" /></td>
															<td><c:out value="${passFail.teeScore}" /><sub>(${passFail.examMonth}-${passFail.examYear})</sub></td>
															<td><c:out value="${passFail.iaScore}" /><sub>(${passFail.examMonth}-${passFail.examYear})</sub></td>
												...
												<tbody>
													<c:forEach var="bookingBean" items="${examBookingsList}">
														<tr>
															...
															<td><c:out value="${bookingBean.term}" /></td>
						...
						<div id="tabs-3-1">
							...
							<div class="panel-group">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" href="#collapseIA">Internal Assessment Records
												: <c:if test="${allAttemptedIADetailsSize gt 0 }">
						  				 	${allAttemptedIADetailsSize}
							  				 </c:if> <c:if test="${allAttemptedIADetailsSize eq 0}">
							  				 	 0
							  				 </c:if>
											</a>
										</h4>
									</div>
									<div id="collapseIA" class="panel-collapse collapse">
										<div class="panel-body">
											<table class="table table-hover">
												<thead>
													<tr>
												...
												<tbody>
													<c:forEach var="marks" items="${allAttemptedIADetails}">
														<tr>
															<td><c:out value="${marks.acadsYear}" /></td>
															<td><c:out value="${marks.acadsMonth}" /></td>
															<td><c:out value="${marks.subject}" /></td>
															<td><c:out value="${marks.testName}" /></td>
															<td><c:out value="${marks.scoreInInteger}/${marks.maxScore}" /></td>
															<td><c:out value="${marks.startDate}" /></td>
															<td><c:out value="${marks.endDate}" /></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
