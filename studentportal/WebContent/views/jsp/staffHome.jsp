...
<body>
							...
							<div class="jumbotron">
								...
								<c:if test="${isfacultyRole == true && sessions.size() > 0 }">
									...
									<div class="row">
										<c:forEach items="${sessions}" var="session">
											<a href="/acads/admin/viewFacultyTimeTable?id=${ session.id }">
								...
								<c:if test="${UsersRole != null}">
									...
									<div class="row">
										...
										<a href="/exam/pendingUploadAndReviewList?tabindex=4"
											class="col-sm-3 WidgeBlock B-green">
											<center>
												<h4 style="font-size: 18px !important;">Qp Pending to Approve</h4>
												<hr />
												<div style="font-size: 35px; font-weight: bold">${ QpPendingToApprove }</div>
											</center>
 										</a>
									</div>
								...
								<c:if test="${isfacultyRole == true}">
									...
									<div class="row">
										<a href="/acads/admin/assignedCourseQueries"
											class="col-sm-3 WidgeBlock B-orange z-depth-3">
											<center>
												<h4 style="font-size: 18px !important;">Count of not
													answered query</h4>
										...
										</a> <a href="/exam/admin/searchAssignmentToEvaluateForm"
										...
										</a> <a href="/exam/admin/searchProjectToEvaluateForm"
										...
										</a> <a href="/exam/admin/searchAssignedCaseStudyFilesForm"
											class="col-sm-3 WidgeBlock B-orange z-depth-3">
											<center>
										...
										</a> <a href="/acads/admin/gotoFacultySessionList"
											class="col-sm-3 WidgeBlock B-orange z-depth-3">
											<center>
										 ...
										 <a href="/exam/facultyAssignmentUpload"
											class="col-sm-3 WidgeBlock B-green z-depth-3" style="padding-bottom:12px;">
											<center>
												<div class="row">
											<div class="col-md-6">
											<h4 style="font-size: 18px !important;">Count of   
													Assignment QP Not Uploaded</h4><hr style="    margin-bottom: 6px!important;" />
													<span class="qp-upload-count" style="font-size: 35px; font-weight: bold"></span>
											</div>
											<div class="col-md-6">  
											<h4 style="font-size: 18px !important;">Count of   
													Assignment QP Approved</h4> <hr style="    margin-bottom: 6px!important;" />
													<span class="qp-approve-count" style="font-size: 35px; font-weight: bold"></span>
											</div>  
											</div>  
											</center>
										</a>
										<a href="/exam/facultyAssignmentQpReview"
											class="col-sm-3 WidgeBlock B-blue z-depth-3">
											<center>
												<h4 style="font-size: 18px !important;">Count of 
													Pending Assignment QP to Review</h4>
												<hr /> 
												<div class="qp-review-count" style="font-size: 35px; font-weight: bold"></div>
 											</center>
 										</a>
 										<a href="/exam/facultyAssignmentUpload"  
											class="col-sm-3 WidgeBlock B-blue z-depth-3">
											<center>
											<h4 style="font-size: 18px !important;">Count of 
													Pending Assignment QP to Resolve</h4>
												<hr /> 
												<div class="qp-resolve-count" style="font-size: 35px; font-weight: bold"></div>
    ...
    <script>
		...
		$.ajax({
			type:'GET',
			url:'/exam/countOfQpNotUploaded?facultyId=<%=userId %>',
			dataType:'json',
			success:function(response){ 
				console.log("qp response:");
				console.log(response);
				$(".qp-upload-count").text(response.countOfUpload);
				$(".qp-review-count").text(response.countOfReview);
				$(".qp-resolve-count").text(response.countOfResolution);
				$(".qp-approve-count").text(response.countOfApprove);
			},
			error(){}
		});
	</script>
