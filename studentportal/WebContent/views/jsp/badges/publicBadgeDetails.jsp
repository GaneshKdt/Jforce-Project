...
<jsp:include page="../common/jscssNew.jsp">
	<jsp:param value="Public Badge Details" name="title" />
</jsp:include>
...
<body>
	...
	<c:when test="${badgesDetails.isRevoked eq 0}">
					...
					<div class="sz-content">
									...
									<div class="panel-body" style="padding: 20px;">
										<div class="row">
											...
											<div class="col-sm-6 col-md-6 col-lg-6">
												...
												<p>For <strong>${badgesDetails.awardedAt}</strong> 
												<c:if test = "${badgesDetails.criteriatype eq 1 }">
												Subject
												</c:if>
												</p>
						...
						<c:if test="${isLinkGeneratedFromFC == 'Y'}">
						<div>
							<a id="courseCompletionBadgeUrl" name="submit" class="btn btn-large btn-primary" href="<spring:eval expression="@propertyConfigurer.getProperty('S3_WATERMARK_CERTIFICATE_PATH')" />${filepath}">View Final Certificate</a>
						</div>
						
						<div class="panel-body" style="padding: 20px;">
						
						<h2 class="block-x-desc">Note : &nbsp;</h2>
						<div class="panel-body" style="padding: 24px;">
						<dd class="block-x-desc" style=color:red;> This verification being provisional in nature requires further authorization from NMIMS University. For credentials verification, please log on to 
						<a href="https://nmims.edu/education-verification">https://nmims.edu/education-verification </a>and send mail to edu.verification@nmims.edu
						</dd>
						</div>
						</div>
						</c:if>
