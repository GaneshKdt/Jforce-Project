...
<link rel="stylesheet" type="text/css" href="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/css/style.css?v=4"> 
...
<script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/js/jquery-3.5.1.js" crossorigin="anonymous"></script>

<script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>

<script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/js/dataTables.bootstrap5.min.js" crossorigin="anonymous"></script>
...
<script src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />assets/js/bootstrap5-2-3.bundle.min.js" crossorigin="anonymous"></script>
...
<!--  <script>
		  ...
		  ga('send', 'pageview'); commented by shailesh 
