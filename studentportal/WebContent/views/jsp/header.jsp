...
<nav class="navbar navbar-inverse navbar-fixed-top customNavbar"
	role="navigation" style="min-height: 40px;">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<div class="col-md-18 no-padding">
				...
				<ul class="headerLinks">
					...
					<li><a href="#">Exam</a>
						<ul class="subMenu">
							...
							<li><a href="/exam/student/getMostRecentAssignmentResults">Assignment
									Marks</a></li>
							...
							<li><a href="/exam/selectResitSubjectsForm">Re-sit Exam
									Registration</a> <%} %>
							<li><a href="/exam/student/printBookingStatus">Exam Registration
									Receipt</a></li>
							<%if(program.startsWith("PG")){ %>
							<li><a href="/exam/student/viewProject?subject=Project">Project
									Submission</a> <%} %>
						</ul></li>
				...
				<ul class="headerLinks">
					...
					<jsp:include page="/views/jsp/studentPortalHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>

					<jsp:include page="/views/jsp/examHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>

					<jsp:include page="/views/jsp/acadsHeader.jsp">
						<jsp:param value="<%=roles %>" name="roles" />
					</jsp:include>
					<li><a href="/studentportal/changeUserPassword"
						title="Change Password"><i class="fa-solid fa-key fa-lg"></i></a></li>
					<li><a href="/studentportal/student/updateProfile"
						title="Update Profile"><i class="fa-solid fa-user fa-lg"></i></a></li>
					<li><a href="/logout" title="Logout"><i
							class="fa-solid fa-power-off fa-lg"></i></a></li>
...
<header class="customHeader">
	<div class="logoWrapper">
		<img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/images/logo.jpg" width="100%" alt="Logo" />
	</div>
	...
	<div class="rightHeadWrapper">
		...
		<div class="userContainer">
			<div class="userImg">
				...
				<%}else{ %>
				<img src="<spring:eval expression="@propertyConfigurer.getProperty('BASE_URL_STUDENTPORTAL_STATIC_RESOURCES')" />resources_2015/images/userImg.jpg" alt="Student Photo"
			...
			<div class="detailWrapper">
				...
				<p>
					...
					<%=program %></p>
				<p>
					<a href="/studentportal/student/updateProfile" style="color: white"><%=userEmail%>/<%=userMobile %></a>
				</p>
			</div>
		</div>
