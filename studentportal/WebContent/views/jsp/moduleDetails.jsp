...
<head>
	...
	<link href="${pageContext.request.contextPath}/assets/css/courses.css" rel="stylesheet"> 
       	...
       	<div class="sz-breadcrumb-wrapper">
   			<div class="container-fluid">
       			<ul class="sz-breadcrumbs">
	        		...
	        		<li><a href="viewModuleDetails?pssId=${pssId}&activeMenu=session" class="encodedHref">${subject}</a></li>
		        </ul>
          	</div>
        </div>
	</div>
