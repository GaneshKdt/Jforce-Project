	...
	<div class="sz-main-content-wrapper">
		<div class="sz-breadcrumb-wrapper">
			<div class="container-fluid">
				<ul class="sz-breadcrumbs">
					...
					<li><a
						href="/studentportal/student/viewCourseHomePage?subject=${moduleContentBean.subject}">${moduleContentBean.subject}</a></li>
		...
		<div class="sz-main-content menu-closed">
			<div class="sz-main-content-inner">
				<jsp:include page="../views/jsp/common/left-sidebar.jsp">
					<jsp:param value="Learning Module" name="activeMenu" />
				</jsp:include>
				<div class="sz-content-wrapper examsPage">

					<%@ include file="../views/jsp/common/studentInfoBar.jsp"%>

					<div class="sz-content">

						<%@ include file="../views/jsp/common/messages.jsp"%>
						...
						<div class="row" style="background-color: white;">
							...
							<div class="panel-group col-md-3" id="accordion"
								...
								<a href="/studentportal/learningModule"
									style="padding-bottom: 10px;"> <i class="fa-solid fa-reply"><span
										style="margin-left: 5px;">Back</span></i></a>
										...
										<div class="panel-body animated zoomIn">
											<ul class="nav nav-pills nav-stacked ">
												<c:forEach var="document" items="${moduleDocumnentList}"
													varStatus="dStatus">
													<li class="moduleLi" style="height: 35px;"><a
														href="#tab_a${document.id}"
														onClick="goToDocumentDetail(${document.id})"
														data-toggle="pill">${document.documentName}</a> <a
														href="${SERVER_PATH}${document.previewPath}"
														target="_blank"
														style="margin: 0px; padding: 0px; width: 21px; bottom: 30px; left: 80%;"><i
															class="fa-solid fa-arrow-up-right-from-square" style="font-size: 18px;"></i></a>
														<a
														href="downloadDocument?filePath=${document.documentPath}"
														download
														style="margin: 0px; padding: 0px; width: 21px; bottom: 50px; left: 90%;"><i
															class="fa-solid fa-download large" style="font-size: 20px;"></i></a>
								...
								<div class="panel panel-custom">
									...
									<div id="collapseTwo" class="panel-collapse collapse in"
										...
										<div class="panel-body animated zoomIn">
											<ul class="nav nav-pills nav-stacked ">
												<li class="videoLi" style="height: 35px;"><a
													href="#tab_a${document.id}" id="videoClicked"
													data-toggle="pill">${videoToBePlayed.fileName}</a></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="panel panel-default">
										<div id="collapseTwo" class="panel-collapse collapse in">
											<div class="panel-body"
												...
												<div class="one"></div>
												<div class="row">
													<div class="col-md-8 well giveBorder"
														style="margin: 0rem 0 1.5rem 0; padding: 10px 10px;">
                                                 ...
                                                 <div class="row giveBorder" style=" padding:0px 0px; margin:5px 5px !important;  background-color:#dfdfdb;">
                                                     ...
                                                     <div class="col-xs-2 giveBorder" style="text-align:center; background-color:#dfdfdb; padding:10px 10px;">
                                                         <a class="" href="/studentportal/viewVideoModuleTopic?moduleId=${moduleContentBean.id}&videoSubtopicId=${relatedVideo.id}&type=${relatedVideo.type} " >
                                                     ...
                                                     <div class="col-xs-7 giveBorder" style="background-color:#dfdfdb; padding:10px 10px;">
                                                         <a class="" href="/studentportal/viewVideoModuleTopic?moduleId=${moduleContentBean.id}&videoSubtopicId=${relatedVideo.id}&type=${relatedVideo.type} " style="font-size:15px; color:black; padding-top:25px; margin:auto 0px !important;" aria-hidden="true"></i>
