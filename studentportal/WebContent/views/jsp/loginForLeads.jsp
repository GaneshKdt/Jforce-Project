					...
					<div class="contentMainWraper">
						...
						<div class="login-cont">
							...
							<form class="profileForm" id="leadLogin" action="loginForLeads" method="post">
								...
								<div class="form-group">
										<a href="registerForLeadsForm">Not Registered? Register Now!</a>
								</div>
								<button type="submit" id="loginBtn" class="btn  btn-default" disabled="disabled">Login</button>
							</form>
						</div>
	...
	<script>
		...
		$(document).ready(function(e) {
			...
			$('#loginBtn').click(function(event){
				...
				if ( loginType == "NA"){
					$('#triggerLogin').hide();
					$('#modal-heading').html( '<p style="text-align: center; font-size: 1em"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i> <b> Warning </b></p>' );
				...
				$('#modal-heading').html( '<p style="text-align: center; font-size: 1em"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i> <b> Error </b></p>' );
			...
			$.ajax({
				...
				complete: function (xhr, status) {
			        ...
			        if (status === 'error' || !xhr.responseText) {
						...
						$('#triggerLogin').show();
						$('#modal-heading').html( "<p style='text-align: center; font-size: 1em'><i class='fa-solid fa-key'></i> <b>Enter Code</b></p>" );
