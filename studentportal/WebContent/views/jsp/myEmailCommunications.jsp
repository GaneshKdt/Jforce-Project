...
<body>
	...
	<div class="sz-main-content-wrapper">
		...
		<div class="sz-main-content menu-closed">
			...
			<div id="sticky-sidebar">
						...
						<div>
							<div class="col-md-6">
								<h2 class="red text-capitalize">
									...
									<c:if test="${isArchived eq false }">
                                        <a href="/studentportal/student/viewArchivedCommunication"><b>View Archived Mails</b></a>
                                    </c:if>
								</h2>
							</div>
												...
												<table class="table table-striped table-hover tables"
													...
													<tbody>
														<c:forEach var="mailBean"
															items="${listOfCommunicationMadeToStudent_studentportal}"
															varStatus="status">
															...
															<tr>
																...
																<td><a onclick="load(${mailBean.id},'${mailBean.createdDate}' )" href="#"><c:out
				...
				<c:if test="${rowCount > 0 }">
					...
					<c:forEach var="mailBean"
						items="${listOfCommunicationMadeToStudent_studentportal}" varStatus="status">
		...
		<script>
		 ...
		 function load(id, createdDate){
			 var crDate= new Date(createdDate);
			 var curCycDate= new Date("2021-01-01 00:00:00");
			 if(crDate.getTime() < curCycDate.getTime()){
				 var x =  document.getElementById("iframe_a");
				 	document.getElementById("iframe_a").src = "/studentportal/singleArchiveEmailForm?id="+id;
