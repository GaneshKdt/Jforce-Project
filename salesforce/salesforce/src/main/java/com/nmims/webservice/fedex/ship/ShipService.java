 ...
 * 
 */
@WebServiceClient(name = "ShipService", targetNamespace = "http://fedex.com/ws/ship/v17", wsdlLocation = "file:/D:/Sanket/fedex/ShipService_v17.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SHIPSERVICE_QNAME = new QName("http://fedex.com/ws/ship/v17", "ShipService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Sanket/fedex/ShipService_v17.wsdl");
    ...
    public ShipPortType getShipServicePort() {
        return super.getPort(new QName("http://fedex.com/ws/ship/v17", "ShipServicePort"), ShipPortType.class);
    }
    ...
    public ShipPortType getShipServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://fedex.com/ws/ship/v17", "ShipServicePort"), ShipPortType.class, features);
    }
