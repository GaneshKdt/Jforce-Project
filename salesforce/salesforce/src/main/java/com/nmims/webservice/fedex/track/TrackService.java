 ...
 * 
 */
@WebServiceClient(name = "TrackService", targetNamespace = "http://fedex.com/ws/track/v10", wsdlLocation = "file:/C:/Users/718962/Desktop/FedEx/TrackService_v10.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRACKSERVICE_QNAME = new QName("http://fedex.com/ws/track/v10", "TrackService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/718962/Desktop/FedEx/TrackService_v10.wsdl");
    ...
    public TrackPortType getTrackServicePort() {
        return super.getPort(new QName("http://fedex.com/ws/track/v10", "TrackServicePort"), TrackPortType.class);
    }
    ...
    public TrackPortType getTrackServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://fedex.com/ws/track/v10", "TrackServicePort"), TrackPortType.class, features);
    }
