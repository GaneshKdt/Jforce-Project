...
public class TestAnswerServiceImpl implements TestAnswerService {
    ...
    private static final Logger logger = LogManager.getLogger(TestAnswerServiceImpl.class);
	...
	*/
	...
	public TestAnswerServiceImpl(StudentTestDetailsRepository studentTestDetailsRespository,
	...
	@Override
	public Map<String, String> saveDQAnswerInCache(StudentQuestionResponseBean answer) {
		...
		try {
			...
			StudentQuestionResponseBean answerFromRedis = new StudentQuestionResponseBean() ;
			try {
			...
			if(answerFromRedis == null || answerFromRedis.getSapid() == null) {
				...
				try {
						StudentsTestDetailsBean studentsTestDetails = studentTestDetailsRespository.findFirstBySapidAndTestIdOrderByIdDesc(answer.getSapid(),answer.getTestId());
	...
	private HashMap<String, String> saveAnswerToDB(StudentQuestionResponseBean answer,
	...
	private String updateAttemptsReaminingTime(String sapid, Long testId) {
		...
		StudentsTestDetailsBean studentsTestDetails =  studentTestDetailsRespository.findFirstBySapidAndTestIdOrderByIdDesc(sapid,testId);
		TestBean test = testRepository.findFirstById(testId);
	...
	private TestBean updateStartEndTimeIfExtended(TestBean test, String sapid) {

		TestExtendedSapids extendedTime = testExtendedSapidsRepository.findFirstBySapidAndTestId(sapid,test.getId());
	...
	@Override
	public GetAnswersFromRedisByStudentsTestDetailsResponseBean getAnswersFromRedisByStudentsTestDetails(
		...
		List<StudentQuestionResponseBean> answersFromReds = new ArrayList<>(); 
		String errorMessage ="";
		...
		try {
			...
			for(String questionId : questionIds){
				...
				try {
					StudentQuestionResponseBean tempBean =studentTestAnswersRepositoryForRedis
	...
	@Override
	public GetAnswersFromRedisByStudentsTestDetailsResponseBean getAnswersFromRedisBySapidAndTestIdAndAttempt(
			String sapid, Long testId, int attempt) {
		
		StudentsTestDetailsBean bean = studentTestDetailsRespository.findFirstBySapidAndTestIdAndAttemptOrderByIdDesc(sapid,testId,attempt);
