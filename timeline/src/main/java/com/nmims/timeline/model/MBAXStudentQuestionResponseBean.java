...
@Entity
@Table(name="exam.upgrad_test_students_answers", schema="exam")
public class MBAXStudentQuestionResponseBean  implements Serializable{
	...
	public MBAXStudentQuestionResponseBean() {
	}
