...
@Entity
@Table(name="exam.upgrad_test_student_testdetails", schema="exam")
public class MBAXStudentsTestDetailsBean {
	/*
	...
	*/
	...
	public String toString() {
		return "\nMBAXStudentsTestDetailsBean [id=" + id + " sapid ; "+ sapid +", testId=" + testId + ", attempt=" + attempt + ", active="
